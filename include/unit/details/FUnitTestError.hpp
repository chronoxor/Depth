/*!
 *  \file    FUnitTestError.hpp Helper function that invokes unit test error
 *           handler.
 *  \brief   Unit test error helper function.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Unit test error helper function.
...
*/
/*==========================================================================*/
#ifndef __FUNITTESTERROR_HPP__
#define __FUNITTESTERROR_HPP__
/*==========================================================================*/
...
/*==========================================================================*/
//! Unit test error helper function (ASCII version).
/*!
...
*/
UNITTEST_API void unitTestError(Tcsstr a_cpFunctionSignature, Tcstr a_cpFileName, const Tuint a_cLine, Tcsstr a_cpMessage, ...);
/*--------------------------------------------------------------------------*/
//! Unit test error helper function (Unicode version).
/*!
    Unit test error helper function shows unit  test  error  message  for  the
    given function signature, file name and line in file. This  function  uses
    common Depth argument formatting algorithm.
    ...
    \param a_cpMessage - Unit test error message to be shown.
*/
UNITTEST_API void unitTestError(Tcsstr a_cpFunctionSignature, Tcstr a_cpFileName, const Tuint a_cLine, Tcwstr a_cpMessage, ...);
/*==========================================================================*/
}
/*--------------------------------------------------------------------------*/
}
