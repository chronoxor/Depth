...
/*==========================================================================*/
/*
    FILE DESCRIPTION: ASCII string constant iterator class.
...
*/
/*==========================================================================*/
#ifndef __CSTRINGASCIIITERATORCONST_HPP__
#define __CSTRINGASCIIITERATORCONST_HPP__
/*==========================================================================*/
...
/* CLASS DECLARATIONS                                                       */
/*==========================================================================*/
//! ASCII string constant iterator class.
/*!
    ASCII string constant iterator represents ASCII string iterations  method.
    With this iterator you can perform random ASCII string moving and  looking
    into ASCII string characters. Note that you  cannot  modify  ASCII  string
    characters with constant iterator. In this case  use  non  constant  ASCII
    string iterator.

    Serialization: ASCII string constant iterator cannot be loaded.
*/
class BASE_API CStringASCIIIteratorConst :
  public NCommon::NIterators::IIteratorConst<CStringASCIIIteratorConst, Tschar, Tschar, CStringASCII>,
  public NCommon::NIterators::IIteratorMoveRandom<CStringASCIIIteratorConst, Tschar, Tschar, CStringASCII>,
  public NCommon::ISeekable
{
  ...
  typedef CStringASCIIIteratorConst TDepthCheckType;

  // Check CStringASCIIIteratorConst class constraint to be a real Depth type.
...
public:
  ...
  typedef const Tschar TReturn;
  //! Iterator container type.
  typedef const CStringASCII TContainer;
  //! Iterator base type.
  typedef CStringASCIIIteratorConst TIterator;

  //! Default class constructor.
  CStringASCIIIteratorConst();
  //! Initialize with non constant ASCII string iterator.
  /*!
      \param a_crInstance - Constant reference to the instance of the CStringASCIIIterator class.
  */
  CStringASCIIIteratorConst(const CStringASCIIIterator& a_crInstance);
  //! Class copy constructor.
  /*!
      \param a_crInstance - Constant reference to another instance of the CStringASCIIIteratorConst class.
  */
  CStringASCIIIteratorConst(const CStringASCIIIteratorConst& a_crInstance);
  //! Class virtual destructor.
  virtual ~CStringASCIIIteratorConst();
  ...
  */
  ...
  /*!
      ...
      \return true  - if class instances are equal. \n
              false - if class instances are not equal. \n
  */
  friend BASE_API Tbool operator == (const CStringASCIIIteratorConst& a_crInstance1, const CStringASCIIIteratorConst& a_crInstance2);
  ...
  */
  CStringASCIIIteratorConst& operator = (const CStringASCIIIterator& a_crInstance);
  ...
  /*!
      ...
      \return Reference to the current iterator class instance.
  */
  CStringASCIIIteratorConst& operator = (const CStringASCIIIteratorConst& a_crInstance);
  ...
  */
  CStringASCIIIteratorConst& operator += (const Tuint a_cStepCount);
  ...
  */
  ...
  /*!
      \return Reference to the current class instance.
  */
  CStringASCIIIteratorConst& operator ++ ();
  ...
  */
  CStringASCIIIteratorConst operator ++ (int);
  ...
  */
  ...
  /*!
      ...
      \return New class instance.
  */
  friend BASE_API CStringASCIIIteratorConst operator + (const CStringASCIIIteratorConst& a_crInstance, const Tuint a_cStepCount);
  //! Operator: Step backward by given steps.
  /*!
      \param a_crInstance - Current instance of the iterator class.
      \param a_cStepCount - Steps count to iteration.
  ...
  */
  ...
  //! Operator: Get new ASCII string constant iterator under the given index.
  /*!
      \param a_cIndex - Indexed ASCII string position to return.
      \return ASCII string constant iterator under the given index.
  */
  CStringASCIIIteratorConst operator [] (const Tsint a_cIndex) const;
  //! Operator: Get new ASCII string constant iterator under the given index.
  /*!
      \param a_cIndex - Indexed ASCII string position to return.
      \return ASCII string constant iterator under the given index.
  */
  CStringASCIIIteratorConst operator [] (const Tuint a_cIndex) const;

  //! Set CStringASCIIIterator class instance.
  /*!
      \param a_crInstance - Constant reference to instance of the CStringASCIIIterator class.
  */
  ...
  /*!
      \param a_crInstance - Constant reference to another instance of the CStringASCIIIteratorConst class.
  */
  void set(const CStringASCIIIteratorConst& a_crInstance);
  ...
  */
  CStringASCIIIteratorConst getForward() const;
  ...
  */
  CStringASCIIIteratorConst getBackward() const;
  ...
  */
  CStringASCIIIteratorConst getIndex(const Tuint a_cIndex) const;

  // IIteratorConst interface overriding methods.
  virtual Tbool isValid() const;
  virtual Tbool isValidContainer() const;
  virtual const CStringASCII& getContainerRef() const;
  virtual const CStringASCII* getContainerPtr() const;
  virtual const Tschar& getValueRef() const;
  virtual const Tschar* getValuePtr() const;
  ...
  //! Serialization load CStringASCIIIteratorConst class instance.
  /*!
  ...
  */
  ...
  //! Serialization save CStringASCIIIteratorConst class instance.
  /*!
      \param a_rArchive - Reference to the serialization archive.
      \return true  - if serialization has been successfully done. \n
              false - if serialization has not been successfully done. \n
  */
  ...
  //! Serialize CStringASCIIIteratorConst class instance.
  /*!
      \param a_rArchive - Reference to the serialization archive.
      \return true  - if serialization has been successfully done. \n
              false - if serialization has not been successfully done. \n
  */
  ...
  //! Swap two CStringASCIIIteratorConst class instances.
  /*!
      \param a_rInstance - Reference to another CStringASCIIIteratorConst class instance.
  */
  void swap(CStringASCIIIteratorConst& a_rInstance);

private:
  const CStringASCII* m_cpContainer;    //!< Constant pointer to the iterator container.
  ...
  */
  CStringASCIIIteratorConst(const CStringASCII* a_cpContainer);
};
/*==========================================================================*/
}
/*--------------------------------------------------------------------------*/
...
namespace NTraits {
/*--------------------------------------------------------------------------*/
//! Traits meta-class: ASCII string constant iterator's traits specialization.
template <>
class MTraitsIterator<NString::NIterators::CStringASCIIIteratorConst> :
  public MType<NString::NIterators::CStringASCIIIteratorConst>
{
public:
  //! Iterator value type.
  typedef NString::NIterators::CStringASCIIIteratorConst::TType value;
  //! Iterator return type.
  typedef NString::NIterators::CStringASCIIIteratorConst::TReturn result;
  //! Iterator container type.
  typedef NString::NIterators::CStringASCIIIteratorConst::TContainer container;
  //! Iterator base type.
  typedef NString::NIterators::CStringASCIIIteratorConst::TIterator iterator;
...
/*==========================================================================*/
#include <Depth/include/string/iterators/CStringASCIIIteratorConst.inl>
/*==========================================================================*/
#endif
