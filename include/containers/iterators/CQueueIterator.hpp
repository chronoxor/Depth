/*!
 *  \file    CQueueIterator.hpp Queue non constant iterator definitions. It
 *           gives ability to get and modify queue items and to do forward
 *           moving through the queue nodes.
 *  \brief   Queue non constant iterator class.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Queue non constant iterator class.
...
*/
/*==========================================================================*/
#ifndef __CQUEUEITERATOR_HPP__
#define __CQUEUEITERATOR_HPP__
/*==========================================================================*/
...
/* CLASS DECLARATIONS                                                       */
/*==========================================================================*/
//! Queue non constant iterator class.
/*!
    Queue non constant iterator represents queue iterations method. With  this
    iterator you can perform forward queue moving and modifying queue items.
*/
template <typename T_Type, class T_Allocator>
class CQueueIterator :
  public NCommon::NIterators::IIterator<CQueueIterator<T_Type, T_Allocator>, T_Type, T_Type, CQueue<T_Type, T_Allocator> >,
  public NCommon::NIterators::IIteratorMoveForward<CQueueIterator<T_Type, T_Allocator>, T_Type, T_Type, CQueue<T_Type, T_Allocator> >,
  public NCommon::NIterators::IIteratorInsertForward<CQueueIterator<T_Type, T_Allocator>, T_Type, T_Type, CQueue<T_Type, T_Allocator> >,
  public NCommon::NIterators::IIteratorRemoveForward<CQueueIterator<T_Type, T_Allocator>, T_Type, T_Type, CQueue<T_Type, T_Allocator> >
{
  // Friend class: Queue class (CQueue).
  friend class CQueue<T_Type, T_Allocator>;
  // Friend class: Queue constant iterator class (CQueueIteratorConst).
  ...
  typedef CQueueIterator<T_Type, T_Allocator> TDepthCheckType;
  ...
  // Check CQueueIterator class constraint to be a real Depth type.
...
public:
  ...
  /*!
      \param a_crInstance - Constant reference to another instance of the CQueueIterator class.
  */
  CQueueIterator(const CQueueIterator<T_Type, T_Allocator>& a_crInstance);
  //! Class virtual destructor.
  virtual ~CQueueIterator();
  ...
  */
  template <typename T_OtherType, class T_OtherAllocator>
  friend Tbool operator == (const CQueueIterator<T_OtherType, T_OtherAllocator>& a_crInstance1, const CQueueIterator<T_OtherType, T_OtherAllocator>& a_crInstance2);
  ...
  */
  CQueueIterator<T_Type, T_Allocator>& operator = (const CQueueIterator<T_Type, T_Allocator>& a_crInstance);
  ...
  */
  CQueueIterator<T_Type, T_Allocator>& operator += (const Tuint a_cStepCount);
  //! Operator: Step forward once. Prefix version.
  /*!
      \return Reference to the current class instance.
  */
  CQueueIterator<T_Type, T_Allocator>& operator ++ ();
  //! Operator: Step forward once. Postfix version.
  /*!
      \return New class instance.
  */
  CQueueIterator<T_Type, T_Allocator> operator ++ (int);
  ...
  */
  template <typename T_OtherType, class T_OtherAllocator>
  friend CQueueIterator<T_OtherType, T_OtherAllocator> operator + (const CQueueIterator<T_OtherType, T_OtherAllocator>& a_crInstance, const Tuint a_cStepCount);

  //! Set another CQueueIterator class instance.
  /*!
      \param a_crInstance - Constant reference to another instance of the CQueueIterator class.
  */
  ...
  */
  CQueueIterator<T_Type, T_Allocator> getForward() const;

  // IIterator interface overriding methods.
  virtual Tbool isValid() const;
  virtual Tbool isValidContainer() const;
  virtual CQueue<T_Type, T_Allocator>& getContainerRef() const;
  virtual CQueue<T_Type, T_Allocator>* getContainerPtr() const;
  ...
  //! Serialize CQueueIterator class instance.
  /*!
  ...
  */
  ...
  //! Swap two CQueueIterator class instances.
  /*!
      \param a_rInstance - Reference to another CQueueIterator class instance.
  */
  void swap(CQueueIterator<T_Type, T_Allocator>& a_rInstance);

private:
  CQueue<T_Type, T_Allocator>* m_pContainer;                 //!< Pointer to the iterator container.
  typename CQueue<T_Type, T_Allocator>::SQueueNode* m_pNode; //!< Pointer to the current queue node.

  //! Initialize iterator with the container value.
  /*!
      \param a_pContainer - Pointer to the iterator container value.
  */
  CQueueIterator(CQueue<T_Type, T_Allocator>* a_pContainer);
};
/*==========================================================================*/
}
/*--------------------------------------------------------------------------*/
...
namespace NTraits {
/*--------------------------------------------------------------------------*/
//! Traits meta-class: queue non constant iterator's traits specialization.
template <typename T_Type, class T_Allocator>
class MTraitsIterator<NContainers::NIterators::CQueueIterator<T_Type, T_Allocator> > :
  public MType<NContainers::NIterators::CQueueIterator<T_Type, T_Allocator> >
{
public:
  //! Iterator value type.
  typedef typename NContainers::NIterators::CQueueIterator<T_Type, T_Allocator>::TType value;
  //! Iterator return type.
  typedef typename NContainers::NIterators::CQueueIterator<T_Type, T_Allocator>::TReturn result;
  //! Iterator container type.
  typedef typename NContainers::NIterators::CQueueIterator<T_Type, T_Allocator>::TContainer container;
  //! Iterator base type.
  typedef typename NContainers::NIterators::CQueueIterator<T_Type, T_Allocator>::TIterator iterator;
...
/*==========================================================================*/
#include <Depth/include/containers/iterators/CQueueIterator.inl>
/*==========================================================================*/
#endif
