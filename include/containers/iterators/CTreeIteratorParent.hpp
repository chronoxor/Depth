/*!
 *  \file    CTreeIteratorParent.hpp Tree parent iterator definitions. It
 *           gives ability to do parent moving through the tree nodes.
 *  \brief   Tree parent iterator class.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Tree parent iterator class.
...
*/
/*==========================================================================*/
#ifndef __CTREEITERATORPARENT_HPP__
#define __CTREEITERATORPARENT_HPP__
/*==========================================================================*/
...
/* CLASS DECLARATIONS                                                       */
/*==========================================================================*/
//! Tree parent iterator class.
/*!
    Tree parent iterator represents tree iterations method. With this iterator
    you can perform tree parent looking through the tree items.
*/
template <class T_TreeIterator>
class CTreeIteratorParent :
  public T_TreeIterator
{
  ...
  typedef CTreeIteratorParent<T_TreeIterator> TDepthCheckType;
  ...
  // Check CTreeIteratorParent class constraint to be a real Depth type.
...
public:
  ...
  */
  CTreeIteratorParent(const T_TreeIterator& a_crTreeIterator);
  //! Class virtual destructor.
  virtual ~CTreeIteratorParent();

  //! Operator: Step forward once. Prefix version.
  /*!
      \return Reference to the current class instance.
  */
  CTreeIteratorParent<T_TreeIterator>& operator ++ ();
  ...
  */
  CTreeIteratorParent<T_TreeIterator> operator ++ (int);
  ...
  */
  ...
  friend CTreeIteratorParent<T_OtherTreeIterator> operator + (const CTreeIteratorParent<T_OtherTreeIterator>& a_crInstance, const Tuint a_cStepCount);
  ...
  */
  CTreeIteratorParent<T_TreeIterator> getForward() const;
  ...
  */
  ...
  //! Swap two CTreeIteratorParent class instances.
  /*!
      \param a_rInstance - Reference to another CTreeIteratorParent class instance.
  */
  void swap(CTreeIteratorParent<T_TreeIterator>& a_rInstance);
};
/*==========================================================================*/
}
/*--------------------------------------------------------------------------*/
...
namespace NTraits {
/*--------------------------------------------------------------------------*/
//! Traits meta-class: tree parent iterator's traits specialization.
template <class T_TreeIterator>
class MTraitsIterator<NContainers::NIterators::CTreeIteratorParent<T_TreeIterator> > :
  public MType<NContainers::NIterators::CTreeIteratorParent<T_TreeIterator> >
{
public:
  //! Iterator value type.
  typedef typename NContainers::NIterators::CTreeIteratorParent<T_TreeIterator>::TType value;
  //! Iterator return type.
  typedef typename NContainers::NIterators::CTreeIteratorParent<T_TreeIterator>::TReturn result;
  //! Iterator container type.
  typedef typename NContainers::NIterators::CTreeIteratorParent<T_TreeIterator>::TContainer container;
  //! Iterator base type.
  typedef typename NContainers::NIterators::CTreeIteratorParent<T_TreeIterator>::TIterator iterator;
...
/*==========================================================================*/
#include <Depth/include/containers/iterators/CTreeIteratorParent.inl>
/*==========================================================================*/
#endif
