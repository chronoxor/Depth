...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Double ended queue non constant iterator class.
...
*/
/*==========================================================================*/
#ifndef __CDEQUEITERATOR_HPP__
#define __CDEQUEITERATOR_HPP__
/*==========================================================================*/
...
/* CLASS DECLARATIONS                                                       */
/*==========================================================================*/
//! Double ended queue non constant iterator class.
/*!
    Double ended queue  non  constant  iterator  represents  deque  iterations
    method. With this iterator you can  perform  forward  and  backward  deque
    moving and modifying deque items.
*/
template <typename T_Type, class T_Allocator>
class CDequeIterator :
  public NCommon::NIterators::IIterator<CDequeIterator<T_Type, T_Allocator>, T_Type, T_Type, CDeque<T_Type, T_Allocator> >,
  public NCommon::NIterators::IIteratorMoveBackward<CDequeIterator<T_Type, T_Allocator>, T_Type, T_Type, CDeque<T_Type, T_Allocator> >,
  public NCommon::NIterators::IIteratorInsertBackward<CDequeIterator<T_Type, T_Allocator>, T_Type, T_Type, CDeque<T_Type, T_Allocator> >,
  public NCommon::NIterators::IIteratorRemoveBackward<CDequeIterator<T_Type, T_Allocator>, T_Type, T_Type, CDeque<T_Type, T_Allocator> >
{
  // Friend class: Deque class (CDeque).
  friend class CDeque<T_Type, T_Allocator>;
  // Friend class: Deque constant iterator class (CDequeIteratorConst).
  ...
  typedef CDequeIterator<T_Type, T_Allocator> TDepthCheckType;
  ...
  // Check CDequeIterator class constraint to be a real Depth type.
...
public:
  ...
  /*!
      \param a_crInstance - Constant reference to another instance of the CDequeIterator class.
  */
  CDequeIterator(const CDequeIterator<T_Type, T_Allocator>& a_crInstance);
  //! Class virtual destructor.
  virtual ~CDequeIterator();
  ...
  */
  template <typename T_OtherType, class T_OtherAllocator>
  friend Tbool operator == (const CDequeIterator<T_OtherType, T_OtherAllocator>& a_crInstance1, const CDequeIterator<T_OtherType, T_OtherAllocator>& a_crInstance2);
  ...
  */
  CDequeIterator<T_Type, T_Allocator>& operator = (const CDequeIterator<T_Type, T_Allocator>& a_crInstance);
  ...
  */
  CDequeIterator<T_Type, T_Allocator>& operator += (const Tuint a_cStepCount);
  ...
  */
  ...
  /*!
      \return Reference to the current class instance.
  */
  CDequeIterator<T_Type, T_Allocator>& operator ++ ();
  ...
  */
  CDequeIterator<T_Type, T_Allocator> operator ++ (int);
  ...
  */
  template <typename T_OtherType, class T_OtherAllocator>
  friend CDequeIterator<T_OtherType, T_OtherAllocator> operator + (const CDequeIterator<T_OtherType, T_OtherAllocator>& a_crInstance, const Tuint a_cStepCount);
  //! Operator: Step backward by given steps.
  /*!
      \param a_crInstance - Current instance of the iterator class.
      \param a_cStepCount - Steps count to iteration.
  ...
  */
  ...
  //! Set another CDequeIterator class instance.
  /*!
      \param a_crInstance - Constant reference to another instance of the CDequeIterator class.
  */
  ...
  */
  CDequeIterator<T_Type, T_Allocator> getForward() const;
  ...
  */
  CDequeIterator<T_Type, T_Allocator> getBackward() const;

  // IIterator interface overriding methods.
  virtual Tbool isValid() const;
  virtual Tbool isValidContainer() const;
  virtual CDeque<T_Type, T_Allocator>& getContainerRef() const;
  virtual CDeque<T_Type, T_Allocator>* getContainerPtr() const;
  ...
  //! Serialize CDequeIterator class instance.
  /*!
  ...
  */
  ...
  //! Swap two CDequeIterator class instances.
  /*!
      \param a_rInstance - Reference to another CDequeIterator class instance.
  */
  void swap(CDequeIterator<T_Type, T_Allocator>& a_rInstance);

private:
  CDeque<T_Type, T_Allocator>* m_pContainer;                 //!< Pointer to the iterator container.
  typename CDeque<T_Type, T_Allocator>::SDequeNode* m_pNode; //!< Pointer to the current deque node.

  //! Initialize iterator with the container value.
  /*!
      \param a_pContainer - Pointer to the iterator container value.
  */
  CDequeIterator(CDeque<T_Type, T_Allocator>* a_pContainer);
};
/*==========================================================================*/
}
/*--------------------------------------------------------------------------*/
...
namespace NTraits {
/*--------------------------------------------------------------------------*/
//! Traits meta-class: deque non constant iterator's traits specialization.
template <typename T_Type, class T_Allocator>
class MTraitsIterator<NContainers::NIterators::CDequeIterator<T_Type, T_Allocator> > :
  public MType<NContainers::NIterators::CDequeIterator<T_Type, T_Allocator> >
{
public:
  //! Iterator value type.
  typedef typename NContainers::NIterators::CDequeIterator<T_Type, T_Allocator>::TType value;
  //! Iterator return type.
  typedef typename NContainers::NIterators::CDequeIterator<T_Type, T_Allocator>::TReturn result;
  //! Iterator container type.
  typedef typename NContainers::NIterators::CDequeIterator<T_Type, T_Allocator>::TContainer container;
  //! Iterator base type.
  typedef typename NContainers::NIterators::CDequeIterator<T_Type, T_Allocator>::TIterator iterator;
...
/*==========================================================================*/
#include <Depth/include/containers/iterators/CDequeIterator.inl>
/*==========================================================================*/
#endif
