...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Tree depth pre-order iterator class.
...
*/
/*==========================================================================*/
#ifndef __CTREEITERATORDEPTHPREORDER_HPP__
#define __CTREEITERATORDEPTHPREORDER_HPP__
/*==========================================================================*/
...
/* CLASS DECLARATIONS                                                       */
/*==========================================================================*/
//! Tree depth pre-order iterator class.
/*!
    Tree depth pre-order iterator represents tree iterations method. With this
    iterator you can perform tree depth pre-order  looking  through  the  tree
    items. Depth pre-order iterations first visit parent node, then visit  all
    child nodes.
*/
template <class T_TreeIterator>
class CTreeIteratorDepthPreOrder :
  public T_TreeIterator
{
  ...
  typedef CTreeIteratorDepthPreOrder<T_TreeIterator> TDepthCheckType;
  ...
  // Check CTreeIteratorDepthPreOrder class constraint to be a real Depth type.
...
public:
  ...
  CTreeIteratorDepthPreOrder();
  //! Initialize with tree iterator.
  /*!
      \param a_crTreeIterator - Constant reference to the tree iterator instance.
  */
  CTreeIteratorDepthPreOrder(const T_TreeIterator& a_crTreeIterator);
  //! Class virtual destructor.
  virtual ~CTreeIteratorDepthPreOrder();

  //! Operator: Step forward once. Prefix version.
  /*!
      \return Reference to the current class instance.
  */
  CTreeIteratorDepthPreOrder<T_TreeIterator>& operator ++ ();
  ...
  */
  CTreeIteratorDepthPreOrder<T_TreeIterator> operator ++ (int);
  ...
  */
  ...
  friend CTreeIteratorDepthPreOrder<T_OtherTreeIterator> operator + (const CTreeIteratorDepthPreOrder<T_OtherTreeIterator>& a_crInstance, const Tuint a_cStepCount);
  ...
  */
  CTreeIteratorDepthPreOrder<T_TreeIterator> getForward() const;
  ...
  */
  CTreeIteratorDepthPreOrder<T_TreeIterator> getBackward() const;

  // IIteratorMoveTree interface overriding methods.
  virtual Tuint stepForward(const Tuint a_cStepCount = 1);
  virtual Tuint stepBackward(const Tuint a_cStepCount = 1);

  //! Serialize CTreeIteratorDepthPreOrder class instance.
  /*!
  ...
  */
  ...
  //! Swap two CTreeIteratorDepthPreOrder class instances.
  /*!
      \param a_rInstance - Reference to another CTreeIteratorDepthPreOrder class instance.
  */
  void swap(CTreeIteratorDepthPreOrder<T_TreeIterator>& a_rInstance);
};
/*==========================================================================*/
}
/*--------------------------------------------------------------------------*/
...
namespace NTraits {
/*--------------------------------------------------------------------------*/
//! Traits meta-class: tree depth pre-order iterator's traits specialization.
template <class T_TreeIterator>
class MTraitsIterator<NContainers::NIterators::CTreeIteratorDepthPreOrder<T_TreeIterator> > :
  public MType<NContainers::NIterators::CTreeIteratorDepthPreOrder<T_TreeIterator> >
{
public:
  //! Iterator value type.
  typedef typename NContainers::NIterators::CTreeIteratorDepthPreOrder<T_TreeIterator>::TType value;
  //! Iterator return type.
  typedef typename NContainers::NIterators::CTreeIteratorDepthPreOrder<T_TreeIterator>::TReturn result;
  //! Iterator container type.
  typedef typename NContainers::NIterators::CTreeIteratorDepthPreOrder<T_TreeIterator>::TContainer container;
  //! Iterator base type.
  typedef typename NContainers::NIterators::CTreeIteratorDepthPreOrder<T_TreeIterator>::TIterator iterator;
...
/*==========================================================================*/
#include <Depth/include/containers/iterators/CTreeIteratorDepthPreOrder.inl>
/*==========================================================================*/
#endif
