/*!
 *  \file    CTreeIteratorFirstChild.hpp Tree first child iterator
 *           definitions. It gives ability to do first child moving
 *           through the tree nodes.
 *  \brief   Tree first child iterator class.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Tree first child iterator class.
...
*/
/*==========================================================================*/
#ifndef __CTREEITERATORFIRSTCHILD_HPP__
#define __CTREEITERATORFIRSTCHILD_HPP__
/*==========================================================================*/
...
/* CLASS DECLARATIONS                                                       */
/*==========================================================================*/
//! Tree first child iterator class.
/*!
    Tree first child iterator represents tree  iterations  method.  With  this
    iterator you can perform tree first child looking through the tree items.
*/
template <class T_TreeIterator>
class CTreeIteratorFirstChild :
  public T_TreeIterator
{
  ...
  typedef CTreeIteratorFirstChild<T_TreeIterator> TDepthCheckType;
  ...
  // Check CTreeIteratorFirstChild class constraint to be a real Depth type.
...
public:
  ...
  CTreeIteratorFirstChild();
  //! Initialize with tree iterator.
  /*!
      \param a_crTreeIterator - Constant reference to the tree iterator instance.
  */
  CTreeIteratorFirstChild(const T_TreeIterator& a_crTreeIterator);
  //! Class virtual destructor.
  virtual ~CTreeIteratorFirstChild();

  //! Operator: Step forward once. Prefix version.
  /*!
      \return Reference to the current class instance.
  */
  CTreeIteratorFirstChild<T_TreeIterator>& operator ++ ();
  ...
  */
  CTreeIteratorFirstChild<T_TreeIterator> operator ++ (int);
  ...
  */
  ...
  friend CTreeIteratorFirstChild<T_OtherTreeIterator> operator + (const CTreeIteratorFirstChild<T_OtherTreeIterator>& a_crInstance, const Tuint a_cStepCount);
  ...
  */
  CTreeIteratorFirstChild<T_TreeIterator> getForward() const;
  ...
  */
  ...
  //! Swap two CTreeIteratorFirstChild class instances.
  /*!
      \param a_rInstance - Reference to another CTreeIteratorFirstChild class instance.
  */
  void swap(CTreeIteratorFirstChild<T_TreeIterator>& a_rInstance);
};
/*==========================================================================*/
}
/*--------------------------------------------------------------------------*/
...
namespace NTraits {
/*--------------------------------------------------------------------------*/
//! Traits meta-class: tree first child iterator's traits specialization.
template <class T_TreeIterator>
class MTraitsIterator<NContainers::NIterators::CTreeIteratorFirstChild<T_TreeIterator> > :
  public MType<NContainers::NIterators::CTreeIteratorFirstChild<T_TreeIterator> >
{
public:
  //! Iterator value type.
  typedef typename NContainers::NIterators::CTreeIteratorFirstChild<T_TreeIterator>::TType value;
  //! Iterator return type.
  typedef typename NContainers::NIterators::CTreeIteratorFirstChild<T_TreeIterator>::TReturn result;
  //! Iterator container type.
  typedef typename NContainers::NIterators::CTreeIteratorFirstChild<T_TreeIterator>::TContainer container;
  //! Iterator base type.
  typedef typename NContainers::NIterators::CTreeIteratorFirstChild<T_TreeIterator>::TIterator iterator;
...
/*==========================================================================*/
#include <Depth/include/containers/iterators/CTreeIteratorFirstChild.inl>
/*==========================================================================*/
#endif
