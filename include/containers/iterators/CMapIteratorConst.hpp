/*!
 *  \file    CMapIteratorConst.hpp Map constant iterator definitions. It gives
 *           ability to get map items.
 *  \brief   Map constant iterator class.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Map constant iterator class.
...
*/
/*==========================================================================*/
#ifndef __CMAPITERATORCONST_HPP__
#define __CMAPITERATORCONST_HPP__
/*==========================================================================*/
...
/* CLASS DECLARATIONS                                                       */
/*==========================================================================*/
//! Map constant iterator class.
/*!
    Map constant iterator represents map iterations method. With this iterator
    you can perform looking into map items. Note that you cannot   modify  map
    items with constant iterator. In this case use non constant map iterator.

    Serialization: Map constant iterator cannot be loaded.
*/
...
class CMapIteratorConst :
  public NCommon::NIterators::IIteratorConst<CMapIteratorConst<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator>, NUtility::CPair<T_Key, T_Value>, T_Value, CMap<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator> >,
  public NCommon::NIterators::IIteratorMoveAssociative<CMapIteratorConst<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator>, T_Key, T_Value, NUtility::CPair<T_Key, T_Value>, T_Value, CMap<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator> >,
  public NCommon::NIterators::IIteratorMoveBackward<CMapIteratorConst<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator>, NUtility::CPair<T_Key, T_Value>, T_Value, CMap<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator> >
{
  ...
  typedef CMapIteratorConst<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator> TDepthCheckType;
  ...
  // Check CMapIteratorConst class constraint to be a real Depth type.
...
public:
  ...
  typedef const CMap<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator> TContainer;
  //! Iterator base type.
  typedef CMapIteratorConst<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator> TIterator;
  ...
  CMapIteratorConst();
  //! Initialize with non constant map iterator.
  /*!
      \param a_crInstance - Constant reference to the instance of the CMapIterator class.
  */
  CMapIteratorConst(const CMapIterator<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator>& a_crInstance);
  //! Class copy constructor.
  /*!
      \param a_crInstance - Constant reference to another instance of the CMapIteratorConst class.
  */
  CMapIteratorConst(const CMapIteratorConst<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator>& a_crInstance);
  //! Class virtual destructor.
  virtual ~CMapIteratorConst();
  ...
  */
  template <typename T_OtherKey, typename T_OtherValue, typename T_OtherKeyBinaryPredicate, template <typename, typename, class> class T_OtherAssociativeContainer, class T_OtherAllocator>
  friend Tbool operator == (const CMapIteratorConst<T_OtherKey, T_OtherValue, T_OtherKeyBinaryPredicate, T_OtherAssociativeContainer, T_OtherAllocator>& a_crInstance1, const CMapIteratorConst<T_OtherKey, T_OtherValue, T_OtherKeyBinaryPredicate, T_OtherAssociativeContainer, T_OtherAllocator>& a_crInstance2);
  ...
  */
  CMapIteratorConst<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator>& operator = (const CMapIterator<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator>& a_crInstance);
  ...
  /*!
      ...
      \return Reference to the current iterator class instance.
  */
  CMapIteratorConst<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator>& operator = (const CMapIteratorConst<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator>& a_crInstance);
  ...
  */
  CMapIteratorConst<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator>& operator += (const Tuint a_cStepCount);
  ...
  */
  ...
  /*!
      \return Reference to the current class instance.
  */
  CMapIteratorConst<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator>& operator ++ ();
  ...
  */
  CMapIteratorConst<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator> operator ++ (int);
  ...
  */
  template <typename T_OtherKey, typename T_OtherValue, typename T_OtherKeyBinaryPredicate, template <typename, typename, class> class T_OtherAssociativeContainer, class T_OtherAllocator>
  friend CMapIteratorConst<T_OtherKey, T_OtherValue, T_OtherKeyBinaryPredicate, T_OtherAssociativeContainer, T_OtherAllocator> operator + (const CMapIteratorConst<T_OtherKey, T_OtherValue, T_OtherKeyBinaryPredicate, T_OtherAssociativeContainer, T_OtherAllocator>& a_crInstance, const Tuint a_cStepCount);
  //! Operator: Step backward by given steps.
  /*!
      \param a_crInstance - Current instance of the iterator class.
      \param a_cStepCount - Steps count to iteration.
  ...
  */
  CMapIteratorConst<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator> operator [] (const T_Key& a_crKey) const;

  //! Set CMapIterator class instance.
  /*!
      \param a_crInstance - Constant reference to instance of the CMapIterator class.
  */
  void set(const CMapIterator<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator>& a_crInstance);
  //! Set another CMapIteratorConst class instance.
  /*!
      \param a_crInstance - Constant reference to another instance of the CMapIteratorConst class.
  */
  void set(const CMapIteratorConst<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator>& a_crInstance);
  ...
  */
  CMapIteratorConst<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator> getForward() const;
  ...
  */
  CMapIteratorConst<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator> getBackward() const;
  ...
  */
  ...
  virtual const CMap<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator>& getContainerRef() const;
  virtual const CMap<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator>* getContainerPtr() const;
  ...
  virtual CMapIteratorConst<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator> find(const T_Key& a_crKey) const;

  // IIteratorMoveBackward interface overriding methods.
  virtual Tuint stepForward(const Tuint a_cStepCount = 1);
  virtual Tuint stepBackward(const Tuint a_cStepCount = 1);

  //! Serialization load CMapIteratorConst class instance.
  /*!
  ...
  */
  ...
  //! Serialization save CMapIteratorConst class instance.
  /*!
      \param a_rArchive - Reference to the serialization archive.
      \return true  - if serialization has been successfully done. \n
              false - if serialization has not been successfully done. \n
  */
  ...
  //! Serialize CMapIteratorConst class instance.
  /*!
      \param a_rArchive - Reference to the serialization archive.
      \return true  - if serialization has been successfully done. \n
              false - if serialization has not been successfully done. \n
  */
  ...
  //! Swap two CMapIteratorConst class instances.
  /*!
      \param a_rInstance - Reference to another CMapIteratorConst class instance.
  */
  void swap(CMapIteratorConst<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator>& a_rInstance);

private:
  const CMap<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator>* m_cpContainer;                                                                                    //!< Constant pointer to the iterator container.
  ...
  */
  CMapIteratorConst(const CMap<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator>* a_cpContainer);

  //! Get constant reference to the map iterator key/value pair.
  /*!
      Method returns constant reference to the map  iterator  key/value  pair.
      This method is unsafe and only for internal usage.

      \return Constant reference to the map iterator key/value pair.
  */
  const NUtility::CPair<T_Key, T_Value>& getPairRef() const;
  //! Get constant pointer to the map iterator key/value pair.
  /*!
      Method returns constant pointer to the map iterator key/value pair. This
      method is unsafe and only for internal usage.

      \return Constant pointer to the map iterator key/value pair.
  */
...
namespace NTraits {
/*--------------------------------------------------------------------------*/
//! Traits meta-class: map constant iterator's traits specialization.
template <typename T_Key, typename T_Value, typename T_KeyBinaryPredicate, template <typename, typename, class> class T_AssociativeContainer, class T_Allocator>
class MTraitsIterator<NContainers::NIterators::CMapIteratorConst<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator> > :
  public MType<NContainers::NIterators::CMapIteratorConst<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator> >
{
public:
  //! Iterator value type.
  typedef typename NContainers::NIterators::CMapIteratorConst<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator>::TType value;
  //! Iterator return type.
  typedef typename NContainers::NIterators::CMapIteratorConst<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator>::TReturn result;
  //! Iterator container type.
  typedef typename NContainers::NIterators::CMapIteratorConst<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator>::TContainer container;
  //! Iterator base type.
  typedef typename NContainers::NIterators::CMapIteratorConst<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator>::TIterator iterator;
...
/*==========================================================================*/
#include <Depth/include/containers/iterators/CMapIteratorConst.inl>
/*==========================================================================*/
#endif
