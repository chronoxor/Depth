/*!
 *  \file    CTreeIteratorLastChild.hpp Tree last child iterator
 *           definitions. It gives ability to do last child moving
 *           through the tree nodes.
 *  \brief   Tree last child iterator class.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Tree last child iterator class.
...
*/
/*==========================================================================*/
#ifndef __CTREEITERATORLASTCHILD_HPP__
#define __CTREEITERATORLASTCHILD_HPP__
/*==========================================================================*/
...
/* CLASS DECLARATIONS                                                       */
/*==========================================================================*/
//! Tree last child iterator class.
/*!
    Tree last child iterator represents  tree  iterations  method.  With  this
    iterator you can perform tree last child looking through the tree items.
*/
template <class T_TreeIterator>
class CTreeIteratorLastChild :
  public T_TreeIterator
{
  ...
  typedef CTreeIteratorLastChild<T_TreeIterator> TDepthCheckType;
  ...
  // Check CTreeIteratorLastChild class constraint to be a real Depth type.
...
public:
  ...
  CTreeIteratorLastChild();
  //! Initialize with tree iterator.
  /*!
      \param a_crTreeIterator - Constant reference to the tree iterator instance.
  */
  CTreeIteratorLastChild(const T_TreeIterator& a_crTreeIterator);
  //! Class virtual destructor.
  virtual ~CTreeIteratorLastChild();

  //! Operator: Step forward once. Prefix version.
  /*!
      \return Reference to the current class instance.
  */
  CTreeIteratorLastChild<T_TreeIterator>& operator ++ ();
  ...
  */
  CTreeIteratorLastChild<T_TreeIterator> operator ++ (int);
  ...
  */
  ...
  friend CTreeIteratorLastChild<T_OtherTreeIterator> operator + (const CTreeIteratorLastChild<T_OtherTreeIterator>& a_crInstance, const Tuint a_cStepCount);
  ...
  */
  CTreeIteratorLastChild<T_TreeIterator> getForward() const;
  ...
  */
  ...
  //! Swap two CTreeIteratorLastChild class instances.
  /*!
      \param a_rInstance - Reference to another CTreeIteratorLastChild class instance.
  */
  void swap(CTreeIteratorLastChild<T_TreeIterator>& a_rInstance);
};
/*==========================================================================*/
}
/*--------------------------------------------------------------------------*/
...
namespace NTraits {
/*--------------------------------------------------------------------------*/
//! Traits meta-class: tree last child iterator's traits specialization.
template <class T_TreeIterator>
class MTraitsIterator<NContainers::NIterators::CTreeIteratorLastChild<T_TreeIterator> > :
  public MType<NContainers::NIterators::CTreeIteratorLastChild<T_TreeIterator> >
{
public:
  //! Iterator value type.
  typedef typename NContainers::NIterators::CTreeIteratorLastChild<T_TreeIterator>::TType value;
  //! Iterator return type.
  typedef typename NContainers::NIterators::CTreeIteratorLastChild<T_TreeIterator>::TReturn result;
  //! Iterator container type.
  typedef typename NContainers::NIterators::CTreeIteratorLastChild<T_TreeIterator>::TContainer container;
  //! Iterator base type.
  typedef typename NContainers::NIterators::CTreeIteratorLastChild<T_TreeIterator>::TIterator iterator;
...
/*==========================================================================*/
#include <Depth/include/containers/iterators/CTreeIteratorLastChild.inl>
/*==========================================================================*/
#endif
