/*!
 *  \file    CMultimapIterator.hpp Multimap non constant iterator
 *           definitions. It gives ability to get and modify multimap
 *           items.
 *  \brief   Multimap non constant iterator class.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Multimap non constant iterator class.
...
*/
/*==========================================================================*/
#ifndef __CMULTIMAPITERATOR_HPP__
#define __CMULTIMAPITERATOR_HPP__
/*==========================================================================*/
...
/* CLASS DECLARATIONS                                                       */
/*==========================================================================*/
//! Multimap non constant iterator class.
/*!
    Multimap non constant iterator represents multimap iterations method. With
    this iterator you can perform looking into multimap items and also  modify
    them.
*/
...
class CMultimapIterator :
  public NCommon::NIterators::IIterator<CMultimapIterator<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator>, T_Key, T_Value, CMultimap<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator> >,
  public NCommon::NIterators::IIteratorMoveAssociative<CMultimapIterator<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator>, T_Key, T_Value, T_Key, T_Value, CMultimap<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator> >,
  public NCommon::NIterators::IIteratorMoveBackward<CMultimapIterator<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator>, T_Key, T_Value, CMultimap<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator> >,
  public NCommon::NIterators::IIteratorInsertAssociative<CMultimapIterator<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator>, T_Key, T_Value, NUtility::CPair<T_Key, T_Value>, T_Value, CMultimap<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator> >,
  public NCommon::NIterators::IIteratorRemoveAssociative<CMultimapIterator<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator>, T_Key, T_Value, NUtility::CPair<T_Key, T_Value>, T_Value, CMultimap<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator> >
{
  ...
  // Friend class: Multimap constant iterator class (CMultimapIteratorConst).
  friend class CMultimapIteratorConst<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator>;
  ...
  typedef CMultimapIterator<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator> TDepthCheckType;
  ...
  // Check CMultimapIterator class constraint to be a real Depth type.
...
public:
  ...
  typedef CMultimap<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator> TContainer;
  //! Iterator base type.
  typedef CMultimapIterator<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator> TIterator;
  ...
  /*!
      \param a_crInstance - Constant reference to another instance of the CMultimapIterator class.
  */
  CMultimapIterator(const CMultimapIterator<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator>& a_crInstance);
  //! Class virtual destructor.
  virtual ~CMultimapIterator();
  ...
  */
  template <typename T_OtherKey, typename T_OtherValue, typename T_OtherKeyBinaryPredicate, template <typename, typename, class> class T_OtherAssociativeContainer, class T_OtherAllocator>
  friend Tbool operator == (const CMultimapIterator<T_OtherKey, T_OtherValue, T_OtherKeyBinaryPredicate, T_OtherAssociativeContainer, T_OtherAllocator>& a_crInstance1, const CMultimapIterator<T_OtherKey, T_OtherValue, T_OtherKeyBinaryPredicate, T_OtherAssociativeContainer, T_OtherAllocator>& a_crInstance2);
  ...
  */
  CMultimapIterator<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator>& operator = (const CMultimapIterator<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator>& a_crInstance);
  ...
  */
  CMultimapIterator<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator>& operator += (const Tuint a_cStepCount);
  ...
  */
  ...
  /*!
      \return Reference to the current class instance.
  */
  CMultimapIterator<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator>& operator ++ ();
  ...
  */
  CMultimapIterator<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator> operator ++ (int);
  ...
  */
  template <typename T_OtherKey, typename T_OtherValue, typename T_OtherKeyBinaryPredicate, template <typename, typename, class> class T_OtherAssociativeContainer, class T_OtherAllocator>
  friend CMultimapIterator<T_OtherKey, T_OtherValue, T_OtherKeyBinaryPredicate, T_OtherAssociativeContainer, T_OtherAllocator> operator + (const CMultimapIterator<T_OtherKey, T_OtherValue, T_OtherKeyBinaryPredicate, T_OtherAssociativeContainer, T_OtherAllocator>& a_crInstance, const Tuint a_cStepCount);
  //! Operator: Step backward by given steps.
  /*!
      \param a_crInstance - Current instance of the iterator class.
      \param a_cStepCount - Steps count to iteration.
  ...
  */
  CMultimapIterator<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator> operator [] (const T_Key& a_crKey) const;

  //! Set another CMultimapIterator class instance.
  /*!
      \param a_crInstance - Constant reference to another instance of the CMultimapIterator class.
  */
  ...
  */
  CMultimapIterator<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator> getForward() const;
  ...
  */
  CMultimapIterator<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator> getBackward() const;
  ...
  */
  ...
  virtual CMultimap<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator>& getContainerRef() const;
  virtual CMultimap<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator>* getContainerPtr() const;
  virtual T_Value& getValueRef() const;
  virtual T_Value* getValuePtr() const;

  // IIteratorMoveAssociative interface overriding methods.
  virtual CMultimapIterator<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator> find(const T_Key& a_crKey) const;
  ...
  //! Serialization load CMultimapIterator class instance.
  /*!
  ...
  */
  ...
  //! Serialization save CMultimapIterator class instance.
  /*!
      \param a_rArchive - Reference to the serialization archive.
      \return true  - if serialization has been successfully done. \n
              false - if serialization has not been successfully done. \n
  */
  ...
  //! Serialize CMultimapIterator class instance.
  /*!
      \param a_rArchive - Reference to the serialization archive.
      \return true  - if serialization has been successfully done. \n
              false - if serialization has not been successfully done. \n
  */
  ...
  //! Swap two CMultimapIterator class instances.
  /*!
      \param a_rInstance - Reference to another CMultimapIterator class instance.
  */
  void swap(CMultimapIterator<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator>& a_rInstance);

private:
  CMultimap<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator>* m_pContainer;                                                                                 //!< Pointer to the iterator container.
  ...
  */
  CMultimapIterator(CMultimap<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator>* a_pContainer);

  //! Get non constant reference to the multimap iterator key/value pair.
  /*!
      Method returns non constant reference to the multimap iterator key/value
      pair. This method is unsafe and only for internal usage.

      \return Non constant reference to the multimap iterator key/value pair.
  */
  NUtility::CPair<T_Key, T_Value>& getPairRef() const;
  //! Get non constant pointer to the multimap iterator key/value pair.
  /*!
      Method returns non constant pointer to the multimap  iterator  key/value
      pair. This method is unsafe and only for internal usage.

      \return Non constant pointer to the multimap iterator key/value pair.
  */
...
namespace NTraits {
/*--------------------------------------------------------------------------*/
//! Traits meta-class: multimap non constant iterator's traits specialization.
template <typename T_Key, typename T_Value, typename T_KeyBinaryPredicate, template <typename, typename, class> class T_AssociativeContainer, class T_Allocator>
class MTraitsIterator<NContainers::NIterators::CMultimapIterator<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator> > :
  public MType<NContainers::NIterators::CMultimapIterator<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator> >
{
public:
  //! Iterator value type.
  typedef typename NContainers::NIterators::CMultimapIterator<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator>::TType value;
  //! Iterator return type.
  typedef typename NContainers::NIterators::CMultimapIterator<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator>::TReturn result;
  //! Iterator container type.
  typedef typename NContainers::NIterators::CMultimapIterator<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator>::TContainer container;
  //! Iterator base type.
  typedef typename NContainers::NIterators::CMultimapIterator<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator>::TIterator iterator;
...
/*==========================================================================*/
#include <Depth/include/containers/iterators/CMultimapIterator.inl>
/*==========================================================================*/
#endif
