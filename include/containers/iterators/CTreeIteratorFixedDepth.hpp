/*!
 *  \file    CTreeIteratorFixedDepth.hpp Tree fixed depth iterator
 *           definitions. It gives ability to do fixed depth moving
 *           through the tree nodes.
 *  \brief   Tree fixed depth iterator class.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Tree fixed depth iterator class.
...
*/
/*==========================================================================*/
#ifndef __CTREEITERATORFIXEDDEPTH_HPP__
#define __CTREEITERATORFIXEDDEPTH_HPP__
/*==========================================================================*/
#include <Depth/include/algorithms/iterators/tree/AGetNextSameDepth.hpp>
...
/* CLASS DECLARATIONS                                                       */
/*==========================================================================*/
//! Tree fixed depth iterator class.
/*!
    Tree fixed depth iterator represents tree  iterations  method.  With  this
    iterator you can perform tree fixed depth looking through the tree items.
*/
template <class T_TreeIterator>
class CTreeIteratorFixedDepth :
  public T_TreeIterator
{
  ...
  typedef CTreeIteratorFixedDepth<T_TreeIterator> TDepthCheckType;
  ...
  // Check CTreeIteratorFixedDepth class constraint to be a real Depth type.
...
public:
  ...
  CTreeIteratorFixedDepth();
  //! Initialize with tree iterator.
  /*!
      \param a_crTreeIterator - Constant reference to the tree iterator instance.
  */
  CTreeIteratorFixedDepth(const T_TreeIterator& a_crTreeIterator);
  //! Class virtual destructor.
  virtual ~CTreeIteratorFixedDepth();

  //! Operator: Step forward once. Prefix version.
  /*!
      \return Reference to the current class instance.
  */
  CTreeIteratorFixedDepth<T_TreeIterator>& operator ++ ();
  ...
  */
  CTreeIteratorFixedDepth<T_TreeIterator> operator ++ (int);
  ...
  */
  ...
  friend CTreeIteratorFixedDepth<T_OtherTreeIterator> operator + (const CTreeIteratorFixedDepth<T_OtherTreeIterator>& a_crInstance, const Tuint a_cStepCount);
  ...
  */
  CTreeIteratorFixedDepth<T_TreeIterator> getForward() const;
  ...
  */
  ...
  //! Swap two CTreeIteratorFixedDepth class instances.
  /*!
      \param a_rInstance - Reference to another CTreeIteratorFixedDepth class instance.
  */
  void swap(CTreeIteratorFixedDepth<T_TreeIterator>& a_rInstance);
};
/*==========================================================================*/
}
/*--------------------------------------------------------------------------*/
...
namespace NTraits {
/*--------------------------------------------------------------------------*/
//! Traits meta-class: tree fixed depth iterator's traits specialization.
template <class T_TreeIterator>
class MTraitsIterator<NContainers::NIterators::CTreeIteratorFixedDepth<T_TreeIterator> > :
  public MType<NContainers::NIterators::CTreeIteratorFixedDepth<T_TreeIterator> >
{
public:
  //! Iterator value type.
  typedef typename NContainers::NIterators::CTreeIteratorFixedDepth<T_TreeIterator>::TType value;
  //! Iterator return type.
  typedef typename NContainers::NIterators::CTreeIteratorFixedDepth<T_TreeIterator>::TReturn result;
  //! Iterator container type.
  typedef typename NContainers::NIterators::CTreeIteratorFixedDepth<T_TreeIterator>::TContainer container;
  //! Iterator base type.
  typedef typename NContainers::NIterators::CTreeIteratorFixedDepth<T_TreeIterator>::TIterator iterator;
...
/*==========================================================================*/
#include <Depth/include/containers/iterators/CTreeIteratorFixedDepth.inl>
/*==========================================================================*/
#endif
