/*!
 *  \file    CArrayIteratorConst.hpp Array constant iterator definitions. It
 *           gives ability to get array items and to do random moving through
 *           the array items.
 *  \brief   Array constant iterator class.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Array constant iterator class.
...
*/
/*==========================================================================*/
#ifndef __CARRAYITERATORCONST_HPP__
#define __CARRAYITERATORCONST_HPP__
/*==========================================================================*/
...
/* CLASS DECLARATIONS                                                       */
/*==========================================================================*/
//! Array constant iterator class.
/*!
    Array constant iterator represents  array  iterations  method.  With  this
    iterator you can perform random array moving and looking into array items.
    Note that you cannot  modify array items with constant iterator.  In  this
    case use non constant array iterator.

    Serialization: Array constant iterator cannot be loaded.
*/
template <typename T_Type, class T_ResizePolicy, class T_CopyPolicy, class T_Allocator>
class CArrayIteratorConst :
  public NCommon::NIterators::IIteratorConst<CArrayIteratorConst<T_Type, T_ResizePolicy, T_CopyPolicy, T_Allocator>, T_Type, T_Type, CArray<T_Type, T_ResizePolicy, T_CopyPolicy, T_Allocator> >,
  public NCommon::NIterators::IIteratorMoveRandom<CArrayIteratorConst<T_Type, T_ResizePolicy, T_CopyPolicy, T_Allocator>, T_Type, T_Type, CArray<T_Type, T_ResizePolicy, T_CopyPolicy, T_Allocator> >,
  public NCommon::ISeekable
{
  ...
  typedef CArrayIteratorConst<T_Type, T_ResizePolicy, T_CopyPolicy, T_Allocator> TDepthCheckType;
  ...
  // Check CArrayIteratorConst class constraint to be a real Depth type.
...
public:
  ...
  typedef const CArray<T_Type, T_ResizePolicy, T_CopyPolicy, T_Allocator> TContainer;
  //! Iterator base type.
  typedef CArrayIteratorConst<T_Type, T_ResizePolicy, T_CopyPolicy, T_Allocator> TIterator;
  ...
  CArrayIteratorConst();
  //! Initialize with non constant array iterator.
  /*!
      \param a_crInstance - Constant reference to the instance of the CArrayIterator class.
  */
  CArrayIteratorConst(const CArrayIterator<T_Type, T_ResizePolicy, T_CopyPolicy, T_Allocator>& a_crInstance);
  //! Class copy constructor.
  /*!
      \param a_crInstance - Constant reference to another instance of the CArrayIteratorConst class.
  */
  CArrayIteratorConst(const CArrayIteratorConst<T_Type, T_ResizePolicy, T_CopyPolicy, T_Allocator>& a_crInstance);
  ...
  */
  template <typename T_OtherType, class T_OtherResizePolicy, class T_OtherCopyPolicy, class T_OtherAllocator>
  friend Tbool operator == (const CArrayIteratorConst<T_OtherType, T_OtherResizePolicy, T_OtherCopyPolicy, T_OtherAllocator>& a_crInstance1, const CArrayIteratorConst<T_OtherType, T_OtherResizePolicy, T_OtherCopyPolicy, T_OtherAllocator>& a_crInstance2);
  ...
  */
  CArrayIteratorConst<T_Type, T_ResizePolicy, T_CopyPolicy, T_Allocator>& operator = (const CArrayIterator<T_Type, T_ResizePolicy, T_CopyPolicy, T_Allocator>& a_crInstance);
  ...
  /*!
      ...
      \return Reference to the current iterator class instance.
  */
  CArrayIteratorConst<T_Type, T_ResizePolicy, T_CopyPolicy, T_Allocator>& operator = (const CArrayIteratorConst<T_Type, T_ResizePolicy, T_CopyPolicy, T_Allocator>& a_crInstance);
  ...
  */
  CArrayIteratorConst<T_Type, T_ResizePolicy, T_CopyPolicy, T_Allocator>& operator += (const Tuint a_cStepCount);
  ...
  */
  ...
  /*!
      \return Reference to the current class instance.
  */
  CArrayIteratorConst<T_Type, T_ResizePolicy, T_CopyPolicy, T_Allocator>& operator ++ ();
  ...
  */
  CArrayIteratorConst<T_Type, T_ResizePolicy, T_CopyPolicy, T_Allocator> operator ++ (int);
  ...
  */
  template <typename T_OtherType, class T_OtherResizePolicy, class T_OtherCopyPolicy, class T_OtherAllocator>
  friend CArrayIteratorConst<T_OtherType, T_OtherResizePolicy, T_OtherCopyPolicy, T_OtherAllocator> operator + (const CArrayIteratorConst<T_OtherType, T_OtherResizePolicy, T_OtherCopyPolicy, T_OtherAllocator>& a_crInstance, const Tuint a_cStepCount);
  //! Operator: Step backward by given steps.
  /*!
      \param a_crInstance - Current instance of the iterator class.
      \param a_cStepCount - Steps count to iteration.
  ...
  */
  ...
  //! Operator: Get new array's constant iterator under the given index.
  /*!
      \param a_cIndex - Indexed array position to return.
      \return Array's constant iterator under the given index.
  */
  CArrayIteratorConst<T_Type, T_ResizePolicy, T_CopyPolicy, T_Allocator> operator [] (const Tsint a_cIndex) const;
  //! Operator: Get new array's constant iterator under the given index.
  /*!
      \param a_cIndex - Indexed array position to return.
      \return Array's constant iterator under the given index.
  */
  CArrayIteratorConst<T_Type, T_ResizePolicy, T_CopyPolicy, T_Allocator> operator [] (const Tuint a_cIndex) const;

  //! Set CArrayIterator class instance.
  /*!
      \param a_crInstance - Constant reference to instance of the CArrayIterator class.
  */
  void set(const CArrayIterator<T_Type, T_ResizePolicy, T_CopyPolicy, T_Allocator>& a_crInstance);
  //! Set another CArrayIteratorConst class instance.
  /*!
      \param a_crInstance - Constant reference to another instance of the CArrayIteratorConst class.
  */
  void set(const CArrayIteratorConst<T_Type, T_ResizePolicy, T_CopyPolicy, T_Allocator>& a_crInstance);
  ...
  */
  CArrayIteratorConst<T_Type, T_ResizePolicy, T_CopyPolicy, T_Allocator> getForward() const;
  ...
  */
  CArrayIteratorConst<T_Type, T_ResizePolicy, T_CopyPolicy, T_Allocator> getBackward() const;
  ...
  */
  CArrayIteratorConst<T_Type, T_ResizePolicy, T_CopyPolicy, T_Allocator> getIndex(const Tuint a_cIndex) const;

  // IIteratorConst interface overriding methods.
  virtual Tbool isValid() const;
  virtual Tbool isValidContainer() const;
  virtual const CArray<T_Type, T_ResizePolicy, T_CopyPolicy, T_Allocator>& getContainerRef() const;
  virtual const CArray<T_Type, T_ResizePolicy, T_CopyPolicy, T_Allocator>* getContainerPtr() const;
  ...
  */
  void swap(CArrayIteratorConst<T_Type, T_ResizePolicy, T_CopyPolicy, T_Allocator>& a_rInstance);

private:
  const CArray<T_Type, T_ResizePolicy, T_CopyPolicy, T_Allocator>* m_cpContainer; //!< Constant pointer to the iterator container.
  ...
  */
  CArrayIteratorConst(const CArray<T_Type, T_ResizePolicy, T_CopyPolicy, T_Allocator>* a_cpContainer);
};
/*==========================================================================*/
}
/*--------------------------------------------------------------------------*/
...
namespace NTraits {
/*--------------------------------------------------------------------------*/
//! Traits meta-class: array constant iterator's traits specialization.
template <typename T_Type, class T_ResizePolicy, class T_CopyPolicy, class T_Allocator>
class MTraitsIterator<NContainers::NIterators::CArrayIteratorConst<T_Type, T_ResizePolicy, T_CopyPolicy, T_Allocator> > :
  public MType<NContainers::NIterators::CArrayIteratorConst<T_Type, T_ResizePolicy, T_CopyPolicy, T_Allocator> >
{
public:
  //! Iterator value type.
  typedef typename NContainers::NIterators::CArrayIteratorConst<T_Type, T_ResizePolicy, T_CopyPolicy, T_Allocator>::TType value;
  //! Iterator return type.
  typedef typename NContainers::NIterators::CArrayIteratorConst<T_Type, T_ResizePolicy, T_CopyPolicy, T_Allocator>::TReturn result;
  //! Iterator container type.
  typedef typename NContainers::NIterators::CArrayIteratorConst<T_Type, T_ResizePolicy, T_CopyPolicy, T_Allocator>::TContainer container;
  //! Iterator base type.
  typedef typename NContainers::NIterators::CArrayIteratorConst<T_Type, T_ResizePolicy, T_CopyPolicy, T_Allocator>::TIterator iterator;
...
/*==========================================================================*/
#include <Depth/include/containers/iterators/CArrayIteratorConst.inl>
/*==========================================================================*/
#endif
