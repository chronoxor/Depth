...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Tree depth post-order iterator class.
...
*/
/*==========================================================================*/
#ifndef __CTREEITERATORDEPTHPOSTORDER_HPP__
#define __CTREEITERATORDEPTHPOSTORDER_HPP__
/*==========================================================================*/
...
/* CLASS DECLARATIONS                                                       */
/*==========================================================================*/
//! Tree depth post-order iterator class.
/*!
    Tree depth post-order iterator represents  tree  iterations  method.  With
    this iterator you can perform tree depth post-order  looking  through  the
    tree items. Depth post-order iterations first visit all child nodes,  then
    visit parent node.
*/
template <class T_TreeIterator>
class CTreeIteratorDepthPostOrder :
  public T_TreeIterator
{
  ...
  typedef CTreeIteratorDepthPostOrder<T_TreeIterator> TDepthCheckType;
  ...
  // Check CTreeIteratorDepthPostOrder class constraint to be a real Depth type.
...
public:
  ...
  CTreeIteratorDepthPostOrder();
  //! Initialize with tree iterator.
  /*!
      \param a_crTreeIterator - Constant reference to the tree iterator instance.
  */
  CTreeIteratorDepthPostOrder(const T_TreeIterator& a_crTreeIterator);
  //! Class virtual destructor.
  virtual ~CTreeIteratorDepthPostOrder();

  //! Operator: Step forward once. Prefix version.
  /*!
      \return Reference to the current class instance.
  */
  CTreeIteratorDepthPostOrder<T_TreeIterator>& operator ++ ();
  ...
  */
  CTreeIteratorDepthPostOrder<T_TreeIterator> operator ++ (int);
  ...
  */
  ...
  friend CTreeIteratorDepthPostOrder<T_OtherTreeIterator> operator + (const CTreeIteratorDepthPostOrder<T_OtherTreeIterator>& a_crInstance, const Tuint a_cStepCount);
  ...
  */
  CTreeIteratorDepthPostOrder<T_TreeIterator> getForward() const;
  ...
  */
  CTreeIteratorDepthPostOrder<T_TreeIterator> getBackward() const;

  // IIteratorMoveTree interface overriding methods.
  virtual Tuint stepForward(const Tuint a_cStepCount = 1);
  virtual Tuint stepBackward(const Tuint a_cStepCount = 1);

  //! Serialize CTreeIteratorDepthPostOrder class instance.
  /*!
  ...
  */
  ...
  //! Swap two CTreeIteratorDepthPostOrder class instances.
  /*!
      \param a_rInstance - Reference to another CTreeIteratorDepthPostOrder class instance.
  */
  void swap(CTreeIteratorDepthPostOrder<T_TreeIterator>& a_rInstance);
};
/*==========================================================================*/
}
/*--------------------------------------------------------------------------*/
...
namespace NTraits {
/*--------------------------------------------------------------------------*/
//! Traits meta-class: tree depth post-order iterator's traits specialization.
template <class T_TreeIterator>
class MTraitsIterator<NContainers::NIterators::CTreeIteratorDepthPostOrder<T_TreeIterator> > :
  public MType<NContainers::NIterators::CTreeIteratorDepthPostOrder<T_TreeIterator> >
{
public:
  //! Iterator value type.
  typedef typename NContainers::NIterators::CTreeIteratorDepthPostOrder<T_TreeIterator>::TType value;
  //! Iterator return type.
  typedef typename NContainers::NIterators::CTreeIteratorDepthPostOrder<T_TreeIterator>::TReturn result;
  //! Iterator container type.
  typedef typename NContainers::NIterators::CTreeIteratorDepthPostOrder<T_TreeIterator>::TContainer container;
  //! Iterator base type.
  typedef typename NContainers::NIterators::CTreeIteratorDepthPostOrder<T_TreeIterator>::TIterator iterator;
...
/*==========================================================================*/
#include <Depth/include/containers/iterators/CTreeIteratorDepthPostOrder.inl>
/*==========================================================================*/
#endif
