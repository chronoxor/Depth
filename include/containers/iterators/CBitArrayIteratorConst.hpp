/*!
 *  \file    CBitArrayIteratorConst.hpp Bit array constant iterator definitions.
 *           It gives ability to get bit array items and to do random moving
 *           through the bit array items.
 *  \brief   Bit array constant iterator class.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Bit array constant iterator class.
...
*/
/*==========================================================================*/
#ifndef __CBITARRAYITERATORCONST_HPP__
#define __CBITARRAYITERATORCONST_HPP__
/*==========================================================================*/
...
/* CLASS DECLARATIONS                                                       */
/*==========================================================================*/
//! Bit array constant iterator class (boolean array specialization).
/*!
    Bit array constant iterator represents bit array iterations  method.  With
    this iterator you can perform random bit array moving and looking into bit
    array items. Note that you cannot  modify bit array  items  with  constant
    iterator. In this case use non constant bit array iterator.

    Serialization: Bit array constant iterator cannot be loaded.
*/
...
class CArrayIteratorConst<Tbool, T_ResizePolicy, T_CopyPolicy, T_Allocator> :
  public NCommon::NIterators::IIteratorConst<CArrayIteratorConst<Tbool, T_ResizePolicy, T_CopyPolicy, T_Allocator>, Tbool, const NDetails::CBitArrayReference<T_ResizePolicy, T_CopyPolicy, T_Allocator>, const CArray<Tbool, T_ResizePolicy, T_CopyPolicy, T_Allocator> >,
  public NCommon::NIterators::IIteratorMoveRandom<CArrayIteratorConst<Tbool, T_ResizePolicy, T_CopyPolicy, T_Allocator>, Tbool, const NDetails::CBitArrayReference<T_ResizePolicy, T_CopyPolicy, T_Allocator>, const CArray<Tbool, T_ResizePolicy, T_CopyPolicy, T_Allocator> >,
  public NCommon::ISeekable
{
  ...
  typedef CArrayIteratorConst<Tbool, T_ResizePolicy, T_CopyPolicy, T_Allocator> TDepthCheckType;
  ...
  // Check CArrayIteratorConst<Tbool> class constraint to be a real Depth type.
...
public:
  ...
  typedef const NDetails::CBitArrayReference<T_ResizePolicy, T_CopyPolicy, T_Allocator> TReturn;
  //! Iterator container type.
  typedef const CArray<Tbool, T_ResizePolicy, T_CopyPolicy, T_Allocator> TContainer;
  //! Iterator base type.
  typedef CArrayIteratorConst<Tbool, T_ResizePolicy, T_CopyPolicy, T_Allocator> TIterator;
  ...
  CArrayIteratorConst();
  //! Initialize with non constant bit array iterator.
  /*!
      \param a_crInstance - Constant reference to the instance of the CArrayIterator<Tbool> class.
  */
  CArrayIteratorConst(const CArrayIterator<Tbool, T_ResizePolicy, T_CopyPolicy, T_Allocator>& a_crInstance);
  //! Class copy constructor.
  /*!
      \param a_crInstance - Constant reference to another instance of the CArrayIteratorConst<Tbool> class.
  */
  CArrayIteratorConst(const CArrayIteratorConst<Tbool, T_ResizePolicy, T_CopyPolicy, T_Allocator>& a_crInstance);
  //! Class virtual destructor.
  virtual ~CArrayIteratorConst();
  ...
  */
  template <class T_OtherResizePolicy, class T_OtherCopyPolicy, class T_OtherAllocator>
  friend Tbool operator == (const CArrayIteratorConst<Tbool, T_OtherResizePolicy, T_OtherCopyPolicy, T_OtherAllocator>& a_crInstance1, const CArrayIteratorConst<Tbool, T_OtherResizePolicy, T_OtherCopyPolicy, T_OtherAllocator>& a_crInstance2);
  ...
  */
  ...
  /*!
      \param a_crInstance - Another instance of the non constantiterator class.
      \return Reference to the current iterator class instance.
  */
  CArrayIteratorConst<Tbool, T_ResizePolicy, T_CopyPolicy, T_Allocator>& operator = (const CArrayIterator<Tbool, T_ResizePolicy, T_CopyPolicy, T_Allocator>& a_crInstance);
  ...
  /*!
      ...
      \return Reference to the current iterator class instance.
  */
  CArrayIteratorConst<Tbool, T_ResizePolicy, T_CopyPolicy, T_Allocator>& operator = (const CArrayIteratorConst<Tbool, T_ResizePolicy, T_CopyPolicy, T_Allocator>& a_crInstance);
  ...
  */
  CArrayIteratorConst<Tbool, T_ResizePolicy, T_CopyPolicy, T_Allocator>& operator += (const Tuint a_cStepCount);
  ...
  */
  ...
  /*!
      \return Reference to the current class instance.
  */
  CArrayIteratorConst<Tbool, T_ResizePolicy, T_CopyPolicy, T_Allocator>& operator ++ ();
  ...
  */
  CArrayIteratorConst<Tbool, T_ResizePolicy, T_CopyPolicy, T_Allocator> operator ++ (int);
  ...
  */
  template <class T_OtherResizePolicy, class T_OtherCopyPolicy, class T_OtherAllocator>
  friend CArrayIteratorConst<Tbool, T_OtherResizePolicy, T_OtherCopyPolicy, T_OtherAllocator> operator + (const CArrayIteratorConst<Tbool, T_OtherResizePolicy, T_OtherCopyPolicy, T_OtherAllocator>& a_crInstance, const Tuint a_cStepCount);
  //! Operator: Step backward by given steps.
  /*!
      \param a_crInstance - Current instance of the iterator class.
      \param a_cStepCount - Steps count to iteration.
  ...
  */
  ...
  //! Operator: Get new bit array's constant iterator under the given index.
  /*!
      \param a_cIndex - Indexed bit array position to return.
      \return Bit array's constant iterator under the given index.
  */
  CArrayIteratorConst<Tbool, T_ResizePolicy, T_CopyPolicy, T_Allocator> operator [] (const Tsint a_cIndex) const;
  //! Operator: Get new bit array's constant iterator under the given index.
  /*!
      \param a_cIndex - Indexed bit array position to return.
      \return Bit array's constant iterator under the given index.
  */
  CArrayIteratorConst<Tbool, T_ResizePolicy, T_CopyPolicy, T_Allocator> operator [] (const Tuint a_cIndex) const;

  //! Set CArrayIterator<Tbool> class instance.
  /*!
      \param a_crInstance - Constant reference to instance of the CArrayIterator<Tbool> class.
  */
  ...
  /*!
      \param a_crInstance - Constant reference to another instance of the CArrayIteratorConst<Tbool> class.
  */
  void set(const CArrayIteratorConst<Tbool, T_ResizePolicy, T_CopyPolicy, T_Allocator>& a_crInstance);
  ...
  */
  CArrayIteratorConst<Tbool, T_ResizePolicy, T_CopyPolicy, T_Allocator> getForward() const;
  ...
  */
  CArrayIteratorConst<Tbool, T_ResizePolicy, T_CopyPolicy, T_Allocator> getBackward() const;
  ...
  */
  CArrayIteratorConst<Tbool, T_ResizePolicy, T_CopyPolicy, T_Allocator> getIndex(const Tuint a_cIndex) const;

  // IIteratorConst interface overriding methods.
  virtual Tbool isValid() const;
  virtual Tbool isValidContainer() const;
  virtual const CArray<Tbool, T_ResizePolicy, T_CopyPolicy, T_Allocator>& getContainerRef() const;
  virtual const CArray<Tbool, T_ResizePolicy, T_CopyPolicy, T_Allocator>* getContainerPtr() const;
  virtual const NDetails::CBitArrayReference<T_ResizePolicy, T_CopyPolicy, T_Allocator>& getValueRef() const;
  virtual const NDetails::CBitArrayReference<T_ResizePolicy, T_CopyPolicy, T_Allocator>* getValuePtr() const;
  ...
  //! Serialization load CArrayIteratorConst class instance.
  /*!
  ...
  */
  ...
  //! Serialization save CArrayIteratorConst class instance.
  /*!
      \param a_rArchive - Reference to the serialization archive.
      \return true  - if serialization has been successfully done. \n
              false - if serialization has not been successfully done. \n
  */
  ...
  //! Serialize CArrayIteratorConst class instance.
  /*!
      \param a_rArchive - Reference to the serialization archive.
      \return true  - if serialization has been successfully done. \n
              false - if serialization has not been successfully done. \n
  */
  ...
  //! Swap two CArrayIteratorConst class instances.
  /*!
      \param a_rInstance - Reference to another CArrayIteratorConst class instance.
  */
  void swap(CArrayIteratorConst<Tbool, T_ResizePolicy, T_CopyPolicy, T_Allocator>& a_rInstance);

private:
  const CArray<Tbool, T_ResizePolicy, T_CopyPolicy, T_Allocator>* m_cpContainer;       //!< Constant pointer to the iterator container.
  NDetails::CBitArrayReference<T_ResizePolicy, T_CopyPolicy, T_Allocator> m_Reference; //!< Bit array reference.
  ...
  */
  CArrayIteratorConst(const CArray<Tbool, T_ResizePolicy, T_CopyPolicy, T_Allocator>* a_cpContainer);
};
/*==========================================================================*/
}
/*--------------------------------------------------------------------------*/
...
namespace NTraits {
/*--------------------------------------------------------------------------*/
//! Traits meta-class: bit array constant iterator's traits specialization.
template <class T_ResizePolicy, class T_CopyPolicy, class T_Allocator>
class MTraitsIterator<NContainers::NIterators::CArrayIteratorConst<Tbool, T_ResizePolicy, T_CopyPolicy, T_Allocator> > :
  public MType<NContainers::NIterators::CArrayIteratorConst<Tbool, T_ResizePolicy, T_CopyPolicy, T_Allocator> >
{
public:
  //! Iterator value type.
  typedef typename NContainers::NIterators::CArrayIteratorConst<Tbool, T_ResizePolicy, T_CopyPolicy, T_Allocator>::TType value;
  //! Iterator return type.
  typedef typename NContainers::NIterators::CArrayIteratorConst<Tbool, T_ResizePolicy, T_CopyPolicy, T_Allocator>::TReturn result;
  //! Iterator container type.
  typedef typename NContainers::NIterators::CArrayIteratorConst<Tbool, T_ResizePolicy, T_CopyPolicy, T_Allocator>::TContainer container;
  //! Iterator base type.
  typedef typename NContainers::NIterators::CArrayIteratorConst<Tbool, T_ResizePolicy, T_CopyPolicy, T_Allocator>::TIterator iterator;
...
/*==========================================================================*/
#include <Depth/include/containers/iterators/CBitArrayIteratorConst.inl>
/*==========================================================================*/
#endif
