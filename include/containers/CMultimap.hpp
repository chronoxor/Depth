/*!
 *  \file    CMultimap.hpp Template multimap container class.
 *  \brief   Template multimap container class.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Template multimap container class.
...
*/
/*==========================================================================*/
#ifndef __CMULTIMAP_HPP__
#define __CMULTIMAP_HPP__
/*==========================================================================*/
...
/* CLASS DECLARATIONS                                                       */
/*==========================================================================*/
//! Template multimap container class.
/*!
    Multimaps are the good structures for associative keys/value storing. They
    keep more than one same key/value instance and have ability to  get  value
    by the key. Default implementation of the map uses Red-Black  trees  as  a
...
template <typename T_Key, typename T_Value, typename T_KeyBinaryPredicate = NAlgorithms::NFunctions::FBoolLessThan<const T_Key&>, template <typename, typename, class> class T_AssociativeContainer = CBinTreeRB, class T_Allocator = NMemory::NAllocators::CAllocatorMemory>
class CMultimap :
  public NCommon::NContainers::IAssociative<CMultimap<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator>, T_Key, T_Value, NUtility::CPair<T_Key, T_Value>, CMultimapIterator<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator>, CMultimapIteratorConst<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator> >,
  public NCommon::NContainers::IAssociativeConst<CMultimap<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator>, T_Key, T_Value, NUtility::CPair<T_Key, T_Value>, CMultimapIterator<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator>, CMultimapIteratorConst<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator> >,
  public NCommon::NContainers::IDequeConst<CMultimap<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator>, NUtility::CPair<T_Key, T_Value>, CMultimapIterator<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator>, CMultimapIteratorConst<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator> >
{
  // Friend class: Multimap iterator class (CMultimapIterator).
  friend class CMultimapIterator<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator>;
  // Friend class: Constant multimap iterator class (CMultimapIteratorConst).
  ...
  typedef CMultimap<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator> TDepthCheckType;
  ...
  // Check CMultimap class constraint to be a real Depth type.
...
public:
  ...
  //! Non constant multimap iterator type.
  typedef CMultimapIterator<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator> TIterator;
  //! Constant multimap iterator type.
  typedef CMultimapIteratorConst<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator> TIteratorConst;
  ...
  */
  CMultimap(T_KeyBinaryPredicate a_fLessThan = T_KeyBinaryPredicate(), const T_Allocator& a_crAllocator = T_Allocator());
  //! Initialize multimap with one key and its value.
  /*!
      Create an empty multimap, then insert key and its value into it.
      ...
      \param a_crAllocator - Constant reference to the memory allocator (default is T_Allocator()).
  */
  CMultimap(const T_Key& a_crKey, const T_Value& a_crValue, T_KeyBinaryPredicate a_fLessThan = T_KeyBinaryPredicate(), const T_Allocator& a_crAllocator = T_Allocator());
  //! Initialize multimap with one key/value pair.
  /*!
      Create an empty multimap, then insert key/value pair into it.

      \param a_crKeyValuePair - Constant reference to the key/value pair to insert.
      \param a_fLessThan - 'LessThan' binary comparator function (default is T_KeyBinaryPredicate()).
      \param a_crAllocator - Constant reference to the memory allocator (default is T_Allocator()).
  */
  CMultimap(const NUtility::CPair<T_Key, T_Value>& a_crKeyValuePair, T_KeyBinaryPredicate a_fLessThan = T_KeyBinaryPredicate(), const T_Allocator& a_crAllocator = T_Allocator());
  //! Class copy constructor.
  /*!
      \param a_crInstance - Constant reference to another instance of the CMultimap class.
      \param a_fLessThan - 'LessThan' binary comparator function (default is T_KeyBinaryPredicate()).
      \param a_crAllocator - Constant reference to the memory allocator (default is T_Allocator()).
  */
  CMultimap(const CMultimap<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator>& a_crInstance, T_KeyBinaryPredicate a_fLessThan = T_KeyBinaryPredicate(), const T_Allocator& a_crAllocator = T_Allocator());
  //! Class virtual destructor.
  virtual ~CMultimap();

  //! Operator: Assign another CMultimap class instance.
  /*!
      \param a_crInstance - Constant reference to another instance of the CMultimap class.
      \return Reference to the current class instance.
  */
  CMultimap<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator>& operator = (const CMultimap<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator>& a_crInstance);

  //! Operator: Insert key/value pair into multimap.
  /*!
      \param a_crKeyValuePair - Constant reference to the key/value pair to insert.
      \return Reference to the current class instance.
  */
  CMultimap<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator>& operator += (const NUtility::CPair<T_Key, T_Value>& a_crKeyValuePair);
  //! Operator: Insert another multimap into multimap.
  /*!
      \param a_crMultimap - Constant reference to the multimap to insert.
      \return Reference to the current class instance.
  */
  CMultimap<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator>& operator += (const CMultimap<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator>& a_crMultimap);
  //! Operator: Remove key from multimap.
  /*!
      \param a_crKey - Constant reference to the key to remove.
      \return Reference to the current class instance.
  */
  CMultimap<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator>& operator -= (const T_Key& a_crKey);
  //! Operator: Remove another multimap from multimap.
  /*!
      \param a_crMultimap - Constant reference to the multimap to remove.
      \return Reference to the current class instance.
  */
  CMultimap<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator>& operator -= (const CMultimap<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator>& a_crMultimap);

  //! Operator: Return non constant iterator to the first multimap value with given key.
  /*!
  ...
  */
  ...
  //! Operator: Return constant iterator to the first multimap value with given key.
  /*!
      \param a_crKey - Constant reference to the searching key.
  ...
  */
  ...
  //! Set another CMultimap class instance.
  /*!
      \param a_crInstance - Constant reference to another instance of the CMultimap class.
      \return true  - if another multimap was successfully set. \n
              false - if another multimap was not successfully set. \n
  */
  Tbool set(const CMultimap<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator>& a_crInstance);
  ...
  virtual Tbool insert(const CMultimap<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator>& a_crMultimap);
  virtual Tbool remove(const T_Key& a_crKey, const Tbool a_cRemoveSame = false);
  virtual Tbool remove(const CMultimap<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator>& a_crMultimap, const Tbool a_cRemoveSame = false);
  ...
  //! Serialization load CMultimap class instance.
  /*!
  ...
  */
  ...
  //! Serialization save CMultimap class instance.
  /*!
      \param a_rArchive - Reference to the serialization archive.
      \return true  - if serialization has been successfully done. \n
              false - if serialization has not been successfully done. \n
  */
  ...
  //! Serialize CMultimap class instance.
  /*!
      \param a_rArchive - Reference to the serialization archive.
      \return true  - if serialization has been successfully done. \n
              false - if serialization has not been successfully done. \n
  */
  ...
  //! Swap two CMultimap class instances.
  /*!
      \param a_rInstance - Reference to another CMultimap class instance.
  */
  void swap(CMultimap<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator>& a_rInstance);

private:
  T_AssociativeContainer<NUtility::CPair<T_Key, T_Value>, NAlgorithms::NFunctions::FMapComparator<T_Key, T_Value, T_KeyBinaryPredicate>, T_Allocator> m_AssociativeContainer; //!< Associative container for the multimap.
};
/*==========================================================================*/
}
/*--------------------------------------------------------------------------*/
...
namespace NTraits {
/*--------------------------------------------------------------------------*/
//! Traits meta-class: multimap container traits specialization.
...
class MTraitsContainer<NContainers::CMultimap<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator> > :
  public MType<NContainers::CMultimap<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator> >
{
public:
  //! Container value type.
  typedef typename NContainers::CMultimap<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator>::TType value;
  //! Container type.
  typedef typename NContainers::CMultimap<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator>::TContainer container;
  //! Container non constant iterator type.
  typedef typename NContainers::CMultimap<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator>::TIterator iterator;
  //! Container constant iterator type.
  typedef typename NContainers::CMultimap<T_Key, T_Value, T_KeyBinaryPredicate, T_AssociativeContainer, T_Allocator>::TIteratorConst citerator;
...
/*==========================================================================*/
#include <Depth/include/containers/iterators/CMultimapIterator.hpp>
#include <Depth/include/containers/iterators/CMultimapIteratorConst.hpp>
/*--------------------------------------------------------------------------*/
#include <Depth/include/containers/CMultimap.inl>
/*==========================================================================*/
//! \example example-containers-CMultimap.cpp
/*--------------------------------------------------------------------------*/
//! \test test-containers-CMultimap.cpp
/*==========================================================================*/
#endif
