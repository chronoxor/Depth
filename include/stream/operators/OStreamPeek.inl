/*!
 *  \file    OStreamPeek.inl Set of the stream peek operators are used to
 *           peek common values (character, string, boolean, integer, real,
 *           pointer) from the stream.
 *  \brief   Stream peek operators (inline).
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Stream peek operators (inline).
...
*/
/*==========================================================================*/
#ifndef __OSTREAMPEEK_INL__
#define __OSTREAMPEEK_INL__
/*==========================================================================*/
...
{ CALL
  a_rReader.peek(a_rBoolean, a_rReader.getCurrentParseFlags());
  return a_rReader;
}
/*--------------------------------------------------------------------------*/
inline IReader& operator > (IReader& a_rReader, Tsint08& a_rInteger)
{ CALL
  a_rReader.peek(a_rInteger, a_rReader.getCurrentParseFlags());
  return a_rReader;
}
/*--------------------------------------------------------------------------*/
...
{ CALL
  a_rReader.peek(a_rReal, a_rReader.getCurrentParseFlags());
  return a_rReader;
}
/*--------------------------------------------------------------------------*/
...
{ CALL
  a_rReader.peek(a_rpPointer, a_rReader.getCurrentParseFlags());
  return a_rReader;
}
/*==========================================================================*/
}
