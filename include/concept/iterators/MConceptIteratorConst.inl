/*!
 *  \file    MConceptIteratorConst.inl Template checking conception. Checks if
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Constant iterator template checking conception (inline).
...
*/
/*==========================================================================*/
#ifndef __MCONCEPTITERATORCONST_INL__
#define __MCONCEPTITERATORCONST_INL__
/*==========================================================================*/
...
inline MConceptIteratorConst<T_Class>::MConceptIteratorConst() :
  MConcept()
{ CALL
...
/*--------------------------------------------------------------------------*/
template <class T_Class>
inline void MConceptIteratorConst<T_Class>::constraints()
{ CALL
  Tbool result;

  // Check for the constant iterator types.
  typename T_Class::TIterator it;

  // Check for the constant iterator operators.
  it = m_It;

  // Check for the constant iterator methods.
  result = m_It.isValid();
