/*!
 *  \file    MConceptPredicate4.hpp Template checking conception. Checks if
 *           template argument is a predicate with 4 arguments.
 *  \brief   Predicate with 4 arguments template checking conception.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Predicate with 4 arguments template checking conception.
...
*/
/*==========================================================================*/
#ifndef __MCONCEPTPREDICATE4_HPP__
#define __MCONCEPTPREDICATE4_HPP__
/*==========================================================================*/
...
/*==========================================================================*/
//! Predicate template checking conception meta-class (predicate with 4 arguments).
/*!
...
#define DEF_TEMPLATE_DECLARATION                 typename T_Predicate, typename T_Argument1, typename T_Argument2, typename T_Argument3, typename T_Argument4
#define DEF_TEMPLATE_PARAMETERS                  T_Predicate, T_Argument1, T_Argument2, T_Argument3, T_Argument4
...
/*==========================================================================*/
#include <Depth/include/concept/functions/MConceptPredicate4.inl>
/*==========================================================================*/
#endif
