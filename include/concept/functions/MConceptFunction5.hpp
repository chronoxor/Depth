/*!
 *  \file    MConceptFunction5.hpp Template checking conception. Checks if
 *           template argument is a function with 5 arguments.
 *  \brief   Function with 5 arguments template checking conception.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Function with 5 arguments template checking conception.
...
*/
/*==========================================================================*/
#ifndef __MCONCEPTFUNCTION5_HPP__
#define __MCONCEPTFUNCTION5_HPP__
/*==========================================================================*/
...
/*==========================================================================*/
//! Function template checking conception meta-class (function with 5 arguments).
/*!
...
/*--------------------------------------------------------------------------*/
//! Function template checking conception meta-class (empty return function with 5 arguments).
/*!
    This conception helps to  constrain  template  argument  to  be  an  empty
    return function with 5 arguments.
*/
...
class MConceptFunction5<T_Function, void, T_Argument1, T_Argument2, T_Argument3, T_Argument4, T_Argument5> :
  public MConcept
{
public:
  // MConcept meta-class overriding method.
...
#define DEF_TEMPLATE_FULL_DECLARATION            typename T_Function, typename T_Result, typename T_Argument1, typename T_Argument2, typename T_Argument3, typename T_Argument4, typename T_Argument5
#define DEF_TEMPLATE_FULL_PARAMETERS             T_Function, T_Result, T_Argument1, T_Argument2, T_Argument3, T_Argument4, T_Argument5
#define DEF_TEMPLATE_EMPTY_DECLARATION           typename T_Function, typename T_Argument1, typename T_Argument2, typename T_Argument3, typename T_Argument4, typename T_Argument5
#define DEF_TEMPLATE_EMPTY_PARAMETERS            T_Function, void, T_Argument1, T_Argument2, T_Argument3, T_Argument4, T_Argument5
...
/*==========================================================================*/
#include <Depth/include/concept/functions/MConceptFunction5.inl>
/*==========================================================================*/
#endif
