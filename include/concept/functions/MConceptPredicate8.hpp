/*!
 *  \file    MConceptPredicate8.hpp Template checking conception. Checks if
 *           template argument is a predicate with 8 arguments.
 *  \brief   Predicate with 8 arguments template checking conception.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Predicate with 8 arguments template checking conception.
...
*/
/*==========================================================================*/
#ifndef __MCONCEPTPREDICATE8_HPP__
#define __MCONCEPTPREDICATE8_HPP__
/*==========================================================================*/
...
/*==========================================================================*/
//! Predicate template checking conception meta-class (predicate with 8 arguments).
/*!
    This conception helps to constrain template argument  to  be  a  predicate
    with 8 arguments.
*/
template <typename T_Predicate, typename T_Argument1, typename T_Argument2, typename T_Argument3, typename T_Argument4, typename T_Argument5, typename T_Argument6, typename T_Argument7, typename T_Argument8>
class MConceptPredicate8 :
  public MConcept
{
public:
...
#define DEF_TEMPLATE_DECLARATION                 typename T_Predicate, typename T_Argument1, typename T_Argument2, typename T_Argument3, typename T_Argument4, typename T_Argument5, typename T_Argument6, typename T_Argument7, typename T_Argument8
#define DEF_TEMPLATE_PARAMETERS                  T_Predicate, T_Argument1, T_Argument2, T_Argument3, T_Argument4, T_Argument5, T_Argument6, T_Argument7, T_Argument8
...
/*==========================================================================*/
#include <Depth/include/concept/functions/MConceptPredicate8.inl>
/*==========================================================================*/
#endif
