/*!
 *  \file    MConceptPredicateMethod2.hpp Template checking conception.
 *           Checks if template argument is a class predicate method
 *           with 2 arguments.
 *  \brief   Class predicate method with 2 arguments template checking conception.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Class predicate method with 2 arguments template checking conception.
...
*/
/*==========================================================================*/
#ifndef __MCONCEPTPREDICATEMETHOD2_HPP__
#define __MCONCEPTPREDICATEMETHOD2_HPP__
/*==========================================================================*/
...
/*==========================================================================*/
//! Class predicate method template checking conception meta-class (predicate method with 2 arguments).
/*!
    This conception helps  to  constrain  template  argument  to  be  a  class
    predicate method with 2 arguments.
*/
template <typename T_PredicateMethod, class T_Class, typename T_Argument1, typename T_Argument2>
class MConceptPredicateMethod2 :
  public MConcept
{
public:
...
protected:
  ...
  MConceptPredicateMethod2();
  //! Meta-class protected destructor.
  virtual ~MConceptPredicateMethod2();
...
#define DEF_TEMPLATE_DECLARATION                 typename T_PredicateMethod, class T_Class, typename T_Argument1, typename T_Argument2
#define DEF_TEMPLATE_PARAMETERS                  T_PredicateMethod, T_Class, T_Argument1, T_Argument2
...
/*==========================================================================*/
#include <Depth/include/concept/functions/MConceptPredicateMethod2.inl>
/*==========================================================================*/
#endif
