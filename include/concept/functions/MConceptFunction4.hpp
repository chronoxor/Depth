/*!
 *  \file    MConceptFunction4.hpp Template checking conception. Checks if
 *           template argument is a function with 4 arguments.
 *  \brief   Function with 4 arguments template checking conception.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Function with 4 arguments template checking conception.
...
*/
/*==========================================================================*/
#ifndef __MCONCEPTFUNCTION4_HPP__
#define __MCONCEPTFUNCTION4_HPP__
/*==========================================================================*/
...
/*==========================================================================*/
//! Function template checking conception meta-class (function with 4 arguments).
/*!
...
/*--------------------------------------------------------------------------*/
//! Function template checking conception meta-class (empty return function with 4 arguments).
/*!
    This conception helps to  constrain  template  argument  to  be  an  empty
    return function with 4 arguments.
*/
template <typename T_Function, typename T_Argument1, typename T_Argument2, typename T_Argument3, typename T_Argument4>
class MConceptFunction4<T_Function, void, T_Argument1, T_Argument2, T_Argument3, T_Argument4> :
  public MConcept
{
public:
  // MConcept meta-class overriding method.
...
#define DEF_TEMPLATE_FULL_DECLARATION            typename T_Function, typename T_Result, typename T_Argument1, typename T_Argument2, typename T_Argument3, typename T_Argument4
#define DEF_TEMPLATE_FULL_PARAMETERS             T_Function, T_Result, T_Argument1, T_Argument2, T_Argument3, T_Argument4
#define DEF_TEMPLATE_EMPTY_DECLARATION           typename T_Function, typename T_Argument1, typename T_Argument2, typename T_Argument3, typename T_Argument4
#define DEF_TEMPLATE_EMPTY_PARAMETERS            T_Function, void, T_Argument1, T_Argument2, T_Argument3, T_Argument4
...
/*==========================================================================*/
#include <Depth/include/concept/functions/MConceptFunction4.inl>
/*==========================================================================*/
#endif
