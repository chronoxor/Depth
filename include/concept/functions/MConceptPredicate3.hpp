/*!
 *  \file    MConceptPredicate3.hpp Template checking conception. Checks if
 *           template argument is a predicate with 3 arguments.
 *  \brief   Predicate with 3 arguments template checking conception.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Predicate with 3 arguments template checking conception.
...
*/
/*==========================================================================*/
#ifndef __MCONCEPTPREDICATE3_HPP__
#define __MCONCEPTPREDICATE3_HPP__
/*==========================================================================*/
...
/*==========================================================================*/
//! Predicate template checking conception meta-class (predicate with 3 arguments).
/*!
    This conception helps to constrain template argument  to  be  a  predicate
    with 3 arguments.
*/
template <typename T_Predicate, typename T_Argument1, typename T_Argument2, typename T_Argument3>
class MConceptPredicate3 :
  public MConcept
{
public:
...
#define DEF_TEMPLATE_DECLARATION                 typename T_Predicate, typename T_Argument1, typename T_Argument2, typename T_Argument3
#define DEF_TEMPLATE_PARAMETERS                  T_Predicate, T_Argument1, T_Argument2, T_Argument3
...
/*==========================================================================*/
#include <Depth/include/concept/functions/MConceptPredicate3.inl>
/*==========================================================================*/
#endif
