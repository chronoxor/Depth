/*!
 *  \file    MConceptMethod5.hpp Template checking conception. Checks if
 *           template argument is a class method with 5 arguments.
 *  \brief   Class method with 5 arguments template checking conception.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Class method with 5 arguments template checking conception.
...
*/
/*==========================================================================*/
#ifndef __MCONCEPTMETHOD5_HPP__
#define __MCONCEPTMETHOD5_HPP__
/*==========================================================================*/
...
/*==========================================================================*/
//! Class method conception meta-class (method with 5 arguments).
/*!
...
/*--------------------------------------------------------------------------*/
//! Class method conception meta-class (empty return method with 5 arguments).
/*!
...
class MConceptMethod5<T_Method, T_Class, void, T_Argument1, T_Argument2, T_Argument3, T_Argument4, T_Argument5> :
  public MConcept
{
public:
  // MConcept meta-class overriding method.
...
#define DEF_TEMPLATE_FULL_DECLARATION            typename T_Method, class T_Class, typename T_Result, typename T_Argument1, typename T_Argument2, typename T_Argument3, typename T_Argument4, typename T_Argument5
#define DEF_TEMPLATE_FULL_PARAMETERS             T_Method, T_Class, T_Result, T_Argument1, T_Argument2, T_Argument3, T_Argument4, T_Argument5
#define DEF_TEMPLATE_EMPTY_DECLARATION           typename T_Method, class T_Class, typename T_Argument1, typename T_Argument2, typename T_Argument3, typename T_Argument4, typename T_Argument5
#define DEF_TEMPLATE_EMPTY_PARAMETERS            T_Method, T_Class, void, T_Argument1, T_Argument2, T_Argument3, T_Argument4, T_Argument5
...
/*==========================================================================*/
#include <Depth/include/concept/functions/MConceptMethod5.inl>
/*==========================================================================*/
#endif
