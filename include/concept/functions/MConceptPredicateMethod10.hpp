/*!
 *  \file    MConceptPredicateMethod10.hpp Template checking conception.
 *           Checks if template argument is a class predicate method
 *           with 10 arguments.
 *  \brief   Class predicate method with 10 arguments template checking conception.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Class predicate method with 10 arguments template checking conception.
...
*/
/*==========================================================================*/
#ifndef __MCONCEPTPREDICATEMETHOD10_HPP__
#define __MCONCEPTPREDICATEMETHOD10_HPP__
/*==========================================================================*/
...
/*==========================================================================*/
//! Class predicate method template checking conception meta-class (predicate method with 10 arguments).
/*!
    This conception helps  to  constrain  template  argument  to  be  a  class
    predicate method with 10 arguments.
*/
template <typename T_PredicateMethod, class T_Class, typename T_Argument1, typename T_Argument2, typename T_Argument3, typename T_Argument4, typename T_Argument5, typename T_Argument6, typename T_Argument7, typename T_Argument8, typename T_Argument9, typename T_Argument10>
class MConceptPredicateMethod10 :
  public MConcept
{
public:
...
protected:
  ...
  MConceptPredicateMethod10();
  //! Meta-class protected destructor.
  virtual ~MConceptPredicateMethod10();
...
private:
  ...
  typename NTraits::MTraitsConcept<T_Argument9>::attribute       m_Argument9;       //!< The 9'th predicate method argument.
  typename NTraits::MTraitsConcept<T_Argument10>::attribute      m_Argument10;      //!< The 10'th predicate method argument.
};
/*==========================================================================*/
}
/*--------------------------------------------------------------------------*/
...
#define DEF_TEMPLATE_DECLARATION                 typename T_PredicateMethod, class T_Class, typename T_Argument1, typename T_Argument2, typename T_Argument3, typename T_Argument4, typename T_Argument5, typename T_Argument6, typename T_Argument7, typename T_Argument8, typename T_Argument9, typename T_Argument10
#define DEF_TEMPLATE_PARAMETERS                  T_PredicateMethod, T_Class, T_Argument1, T_Argument2, T_Argument3, T_Argument4, T_Argument5, T_Argument6, T_Argument7, T_Argument8, T_Argument9, T_Argument10
...
/*==========================================================================*/
#include <Depth/include/concept/functions/MConceptPredicateMethod10.inl>
/*==========================================================================*/
#endif
