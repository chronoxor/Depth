/*!
 *  \file    MConceptBoolEqual.inl Template checking conception. Checks if
...
*/
/*==========================================================================*/
#ifndef __MCONCEPTBOOLEQUAL_INL__
#define __MCONCEPTBOOLEQUAL_INL__
/*==========================================================================*/
...
inline MConceptBoolEqual<T_FirstType, T_SecondType>::MConceptBoolEqual() :
  MConcept()
{ CALL
...
/*--------------------------------------------------------------------------*/
template <typename T_FirstType, typename T_SecondType>
inline void MConceptBoolEqual<T_FirstType, T_SecondType>::constraints()
{ CALL
  constraintsOperator();
}
/*--------------------------------------------------------------------------*/
template <typename T_FirstType, typename T_SecondType>
inline Tbool MConceptBoolEqual<T_FirstType, T_SecondType>::constraintsOperator()
{ CALL
  return (m_X == m_Y);
}
/*==========================================================================*/
