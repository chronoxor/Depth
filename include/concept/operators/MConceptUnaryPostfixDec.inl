/*!
 *  \file    MConceptUnaryPostfixDec.inl Template checking conception. Checks
...
*/
/*==========================================================================*/
#ifndef __MCONCEPTUNARYPOSTFIXDEC_INL__
#define __MCONCEPTUNARYPOSTFIXDEC_INL__
/*==========================================================================*/
...
inline MConceptUnaryPostfixDec<T_ResultType, T_FirstType>::MConceptUnaryPostfixDec() :
  MConcept()
{ CALL
...
/*--------------------------------------------------------------------------*/
template <typename T_ResultType, typename T_FirstType>
inline void MConceptUnaryPostfixDec<T_ResultType, T_FirstType>::constraints()
{ CALL
  constraintsOperator();
}
/*--------------------------------------------------------------------------*/
template <typename T_ResultType, typename T_FirstType>
inline T_ResultType MConceptUnaryPostfixDec<T_ResultType, T_FirstType>::constraintsOperator()
{ CALL
  return (m_X--);
}
/*==========================================================================*/
