/*!
 *  \file    MConceptUnaryPrefixDec.inl Template checking conception. Checks
...
*/
/*==========================================================================*/
#ifndef __MCONCEPTUNARYPREFIXDEC_INL__
#define __MCONCEPTUNARYPREFIXDEC_INL__
/*==========================================================================*/
...
inline MConceptUnaryPrefixDec<T_ResultType, T_FirstType>::MConceptUnaryPrefixDec() :
  MConcept()
{ CALL
...
/*--------------------------------------------------------------------------*/
template <typename T_ResultType, typename T_FirstType>
inline void MConceptUnaryPrefixDec<T_ResultType, T_FirstType>::constraints()
{ CALL
  constraintsOperator();
}
/*--------------------------------------------------------------------------*/
template <typename T_ResultType, typename T_FirstType>
inline T_ResultType MConceptUnaryPrefixDec<T_ResultType, T_FirstType>::constraintsOperator()
{ CALL
  return (--m_X);
}
/*==========================================================================*/
