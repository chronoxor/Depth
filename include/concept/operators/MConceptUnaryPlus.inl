/*!
 *  \file    MConceptUnaryPlus.inl Template checking conception. Checks
...
*/
/*==========================================================================*/
#ifndef __MCONCEPTUNARYPLUS_INL__
#define __MCONCEPTUNARYPLUS_INL__
/*==========================================================================*/
...
inline MConceptUnaryPlus<T_ResultType, T_FirstType>::MConceptUnaryPlus() :
  MConcept()
{ CALL
...
/*--------------------------------------------------------------------------*/
template <typename T_ResultType, typename T_FirstType>
inline void MConceptUnaryPlus<T_ResultType, T_FirstType>::constraints()
{ CALL
  constraintsOperator();
}
/*--------------------------------------------------------------------------*/
template <typename T_ResultType, typename T_FirstType>
inline T_ResultType MConceptUnaryPlus<T_ResultType, T_FirstType>::constraintsOperator()
{ CALL
  return (+m_X);
}
/*==========================================================================*/
