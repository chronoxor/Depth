/*!
 *  \file    CIntegralRomberg.hpp Integral class contains functionality to
 *           calculate one-dimensional integrals with Romberg method.
 *  \brief   Static class for integral calculations with Romberg method.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Static class for integral calculations with Romberg method.
...
*/
/*==========================================================================*/
#ifndef __CINTEGRALROMBERG_HPP__
#define __CINTEGRALROMBERG_HPP__
/*==========================================================================*/
...
/* CLASS DECLARATIONS                                                       */
/*==========================================================================*/
//! Static class for integral calculations with Romberg method.
/*!
    This class helps  to  calculate  one-dimensional  integral  value  of  the
    arbitrary function inside fixed bounds with Romberg method.
*/
class BASE_API CIntegralRomberg :
...
public:
  ...
  */
  ...
  /*!
      ...
      \param a_cOrder - Romberg order of the integration (default is 5).
      \return Integral value.
  */
  static Treal integral(const TFunctor& a_cfrFunction, const Treal a_cA, const Treal a_cB, const Tuint a_cOrder = 5);
};
/*==========================================================================*/
}
/*--------------------------------------------------------------------------*/
