/*!
 *  \file    AItUniqueSortedCount.inl Contains general template implementation
 *           of the iterator get count of unique sorted items algorithm.
 *  \brief   Iterator get count of unique sorted items algorithm (inline).
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Iterator get count of unique sorted items algorithm (inline).
...
*/
/*==========================================================================*/
#ifndef __AITUNIQUESORTEDCOUNT_INL__
#define __AITUNIQUESORTEDCOUNT_INL__
/*==========================================================================*/
...
inline Tuint uniqueSortedCountNext(const T_Iterator& a_crIterator)
{ CALL
  return uniqueSortedCountNext(a_crIterator, NFunctions::FBoolEqual<const typename T_Iterator::TReturn&, const typename T_Iterator::TReturn&>());
}
/*--------------------------------------------------------------------------*/
template <class T_Iterator, typename T_BinaryPredicate>
inline Tuint uniqueSortedCountNext(const T_Iterator& a_crIterator, T_BinaryPredicate a_fEqual)
{ CALL
...
/*--------------------------------------------------------------------------*/
template <class T_Iterator>
inline Tuint uniqueSortedCountPrev(const T_Iterator& a_crIterator)
{ CALL
  return uniqueSortedCountPrev(a_crIterator, NFunctions::FBoolEqual<const typename T_Iterator::TReturn&, const typename T_Iterator::TReturn&>());
}
/*--------------------------------------------------------------------------*/
template <class T_Iterator, typename T_BinaryPredicate>
inline Tuint uniqueSortedCountPrev(const T_Iterator& a_crIterator, T_BinaryPredicate a_fEqual)
{ CALL
