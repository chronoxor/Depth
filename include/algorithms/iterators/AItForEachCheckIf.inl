/*!
 *  \file    AItForEachCheckIf.inl Contains general template implementation of
 *           the iterator for each check calling algorithm with unary 'If'
 *           predicate.
 *  \brief   Iterator for each check calling algorithm with unary 'If' predicate (inline).
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Iterator for each check calling algorithm with unary 'If' predicate (inline).
...
*/
/*==========================================================================*/
#ifndef __AITFOREACHCHECKIF_INL__
#define __AITFOREACHCHECKIF_INL__
/*==========================================================================*/
...
inline Tuint forEachCheckIfNext(const T_Iterator& a_crIterator, T_UnaryPredicate a_fPredicate, T_UnaryIfPredicate a_fIf)
{ CALL
...
/*--------------------------------------------------------------------------*/
template <class T_Iterator, typename T_UnaryPredicate, typename T_UnaryIfPredicate>
inline Tuint forEachCheckIfPrev(const T_Iterator& a_crIterator, T_UnaryPredicate a_fPredicate, T_UnaryIfPredicate a_fIf)
{ CALL
  return forEachCheckIfNext(reverseIt(a_crIterator), a_fPredicate, a_fIf);
}
/*==========================================================================*/
}
/*--------------------------------------------------------------------------*/
