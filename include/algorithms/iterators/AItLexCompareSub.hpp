/*!
 *  \file    AItLexCompareSub.hpp Contains general template implementation of
 *           the iterator two subsequences lexicographical compare algorithm.
 *  \brief   Iterator two subsequences lexicographical compare algorithm.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Iterator two subsequences lexicographical compare algorithm.
...
*/
/*==========================================================================*/
#ifndef __AITLEXCOMPARESUB_HPP__
#define __AITLEXCOMPARESUB_HPP__
/*==========================================================================*/
...
/*==========================================================================*/
//! Algorithm: Forward iterator two subsequences lexicographical compare.
/*!
    Algorithm lexicographical compares two subsequences represented with their
    forward iterators.
...
Tsint lexCompareSubNext(const T_Iterator1& a_crIterator1, const T_Iterator2& a_crIterator2);
/*--------------------------------------------------------------------------*/
//! Algorithm: Forward iterator two subsequences lexicographical compare using binary comparator function.
/*!
    Algorithm lexicographical compares two subsequences represented with their
    forward iterators.
...
Tsint lexCompareSubNext(const T_Iterator1& a_crIterator1, const T_Iterator2& a_crIterator2, T_Comparator a_fComparator);
/*--------------------------------------------------------------------------*/
//! Algorithm: Backward iterator two subsequences lexicographical compare.
/*!
    Algorithm lexicographical compares two subsequences represented with their
    backward iterators.
...
*/
template <class T_Iterator1, class T_Iterator2>
Tsint lexCompareSubPrev(const T_Iterator1& a_crIterator1, const T_Iterator2& a_crIterator2);
/*--------------------------------------------------------------------------*/
//! Algorithm: Backward iterator two subsequences lexicographical compare using binary comparator function.
/*!
    Algorithm lexicographical compares two subsequences represented with their
    backward iterators.
...
*/
template <class T_Iterator1, class T_Iterator2, typename T_Comparator>
Tsint lexCompareSubPrev(const T_Iterator1& a_crIterator1, const T_Iterator2& a_crIterator2, T_Comparator a_fComparator);
/*==========================================================================*/
}
/*--------------------------------------------------------------------------*/
}
...
/*==========================================================================*/
#include <Depth/include/algorithms/iterators/AItLexCompareSub.inl>
/*==========================================================================*/
#endif
