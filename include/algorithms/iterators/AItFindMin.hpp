/*!
 *  \file    AItFindMin.hpp Contains general template implementation of the
 *           find minimum value algorithm.
 *  \brief   Find minimum value algorithm.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Find minimum value algorithm.
...
*/
/*==========================================================================*/
#ifndef __AITFINDMIN_HPP__
#define __AITFINDMIN_HPP__
/*==========================================================================*/
...
/*==========================================================================*/
//! Algorithm: Forward searching for the iterator with minimum value.
/*!
    Algorithm searches  forward  for  the  iterator  with  minimum  value.  It
    ...
    \return Forward iterator to the minimum value, or invalid iterator.
*/
template <class T_Iterator>
T_Iterator findMinNext(const T_Iterator& a_crIterator);
/*--------------------------------------------------------------------------*/
//! Algorithm: Forward searching for the iterator with minimum value using 'LessThan' predicate.
/*!
    Algorithm searches  forward  for  the  iterator  with  minimum  value.  It
    implements searching in container which  represented  with  given  forward
    iterator. It stops searching process when  iterator  cannot  step  forward
...
/*--------------------------------------------------------------------------*/
//! Algorithm: Backward searching for the iterator with minimum value.
/*!
    Algorithm searches backward  for  the  iterator  with  minimum  value.  It
    ...
    \return Backward iterator to the minimum value, or invalid iterator.
*/
template <class T_Iterator>
T_Iterator findMinPrev(const T_Iterator& a_crIterator);
/*--------------------------------------------------------------------------*/
//! Algorithm: Backward searching for the iterator with minimum value using 'LessThan' predicate.
/*!
    Algorithm searches backward  for  the  iterator  with  minimum  value.  It
    implements searching in container which represented  with  given  backward
    iterator. It stops searching process when iterator  cannot  step  backward
...
/*==========================================================================*/
#include <Depth/include/algorithms/iterators/AItFindMin.inl>
/*==========================================================================*/
#endif
