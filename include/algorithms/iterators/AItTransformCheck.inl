/*!
 *  \file    AItTransformCheck.inl Contains general template implementation of
 *           the iterator check transform all items algorithm.
 *  \brief   Iterator check transform all items algorithm (inline).
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Iterator check transform all items algorithm (inline).
...
*/
/*==========================================================================*/
#ifndef __AITTRANSFORMCHECK_INL__
#define __AITTRANSFORMCHECK_INL__
/*==========================================================================*/
...
inline Tuint transformCheckNext(const T_Iterator& a_crIterator, T_UnaryPredicate a_fPredicate)
{ CALL
...
/*--------------------------------------------------------------------------*/
template <class T_Iterator, typename T_UnaryPredicate>
inline Tuint transformCheckPrev(const T_Iterator& a_crIterator, T_UnaryPredicate a_fPredicate)
{ CALL
  return transformCheckNext(reverseIt(a_crIterator), a_fPredicate);
}
/*==========================================================================*/
}
/*--------------------------------------------------------------------------*/
