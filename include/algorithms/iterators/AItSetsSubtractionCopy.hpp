/*!
 *  \file    AItSetsSubtractionCopy.hpp Contains general template
 *           implementation of the iterator subtraction and copy
 *           of two sets algorithm.
 *  \brief   Iterator subtraction and copy of two sets algorithm.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Iterator subtraction and copy of two sets algorithm.
...
*/
/*==========================================================================*/
#ifndef __AITSETSSUBTRACTIONCOPY_HPP__
#define __AITSETSSUBTRACTIONCOPY_HPP__
/*==========================================================================*/
...
/*==========================================================================*/
//! Algorithm: Forward subtraction and copy two set sequences.
/*!
...
Tuint setsSubtractionCopyNext(const T_Iterator1& a_crIterator1, const T_Iterator2& a_crIterator2, const T_IteratorCopy& a_crIteratorCopy);
/*--------------------------------------------------------------------------*/
//! Algorithm: Forward subtraction and copy two set sequences using 'LessThan' predicate.
/*!
    Algorithm subtracts forward all items from two sequences represented  with
    their forward iterators and puts them into the copy sequence.
...
Tuint setsSubtractionCopyNext(const T_Iterator1& a_crIterator1, const T_Iterator2& a_crIterator2, const T_IteratorCopy& a_crIteratorCopy, T_BinaryPredicate a_fLessThan);
/*--------------------------------------------------------------------------*/
//! Algorithm: Backward subtraction and copy two set sequences.
/*!
...
*/
template <class T_Iterator1, class T_Iterator2, class T_IteratorCopy>
Tuint setsSubtractionCopyPrev(const T_Iterator1& a_crIterator1, const T_Iterator2& a_crIterator2, const T_IteratorCopy& a_crIteratorCopy);
/*--------------------------------------------------------------------------*/
//! Algorithm: Backward subtraction and copy two set sequences using 'LessThan' predicate.
/*!
    Algorithm subtracts backward all items from two sequences represented with
    their backward iterators and puts them into the copy sequence.
...
*/
template <class T_Iterator1, class T_Iterator2, class T_IteratorCopy, typename T_BinaryPredicate>
Tuint setsSubtractionCopyPrev(const T_Iterator1& a_crIterator1, const T_Iterator2& a_crIterator2, const T_IteratorCopy& a_crIteratorCopy, T_BinaryPredicate a_fLessThan);
/*==========================================================================*/
}
/*--------------------------------------------------------------------------*/
}
...
/*==========================================================================*/
#include <Depth/include/algorithms/iterators/AItSetsSubtractionCopy.inl>
/*==========================================================================*/
#endif
