/*!
 *  \file    AItIncludes.inl Contains general template implementation of the
 *           iterator two sequences include test algorithm.
 *  \brief   Iterator two sequences include test algorithm (inline).
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Iterator two sequences include test algorithm (inline).
...
*/
/*==========================================================================*/
#ifndef __AITINCLUDES_INL__
#define __AITINCLUDES_INL__
/*==========================================================================*/
...
inline Tbool includesNext(const T_Iterator1& a_crIterator1, const T_Iterator2& a_crIterator2)
{ CALL
  return includesNext(a_crIterator1, a_crIterator2, NFunctions::FBoolLessThan<const typename T_Iterator1::TReturn&, const typename T_Iterator2::TReturn&>());
}
/*--------------------------------------------------------------------------*/
template <class T_Iterator1, class T_Iterator2, typename T_BinaryPredicate>
inline Tbool includesNext(const T_Iterator1& a_crIterator1, const T_Iterator2& a_crIterator2, T_BinaryPredicate a_fLessThan)
{ CALL
  ...
  if (it1.isValid() && it2.isValid())
  {
    ...
    return ((it2 == a_crIterator2) || (it2.stepForward() == 0));
  }
  else
...
/*--------------------------------------------------------------------------*/
template <class T_Iterator1, class T_Iterator2>
inline Tbool includesPrev(const T_Iterator1& a_crIterator1, const T_Iterator2& a_crIterator2)
{ CALL
  return includesPrev(a_crIterator1, a_crIterator2, NFunctions::FBoolLessThan<const typename T_Iterator1::TReturn&, const typename T_Iterator2::TReturn&>());
}
/*--------------------------------------------------------------------------*/
template <class T_Iterator1, class T_Iterator2, typename T_BinaryPredicate>
inline Tbool includesPrev(const T_Iterator1& a_crIterator1, const T_Iterator2& a_crIterator2, T_BinaryPredicate a_fLessThan)
{ CALL
  ...
  if (it1.isValid() && it2.isValid())
  {
    ...
    return ((it2 == a_crIterator2) || (it2.stepBackward() == 0));
  }
  else
    return (!it1.isValid() && !it2.isValid());
}
