/*!
 *  \file    AGetLastSameDepth.inl Contains implementation of the algorithm
 *           which searches last tree node with same depth as in given one.
 *  \brief   Algorithm to find last tree node with same depth (inline).
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Algorithm to find last tree node with same depth (inline).
...
*/
/*==========================================================================*/
#ifndef __AGETLASTSAMEDEPTH_INL__
#define __AGETLASTSAMEDEPTH_INL__
/*==========================================================================*/
...
inline T_TreeIterator getLastSameDepth(const T_TreeIterator& a_crTreeIterator)
{ CALL
  ...
  T_TreeIterator it_prev(getNextSameDepth(it_result));

  while (it_prev.isValid())
  {
    it_result = it_prev;
    it_prev = getNextSameDepth(it_result);
  }
  return it_result;
}
/*==========================================================================*/
