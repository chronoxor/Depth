/*!
 *  \file    AItFindNIf.hpp Contains general template implementation of the
 *           find N'th algorithm with given unary 'If' predicate.
 *  \brief   Find N'th algorithm with given unary 'If' predicate.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Find N'th algorithm with given unary 'If' predicate.
...
*/
/*==========================================================================*/
#ifndef __AITFINDNIF_HPP__
#define __AITFINDNIF_HPP__
/*==========================================================================*/
...
/*==========================================================================*/
//! Algorithm: Forward searching for the N'th iterator with given unary 'If' predicate.
/*!
    Algorithm searches forward for the N'th iterator accepted with  the  given
...
T_Iterator findNIfNext(const T_Iterator& a_crIterator, const Tuint a_cN, T_UnaryIfPredicate a_fIf);
/*--------------------------------------------------------------------------*/
//! Algorithm: Backward searching for the N'th iterator with given unary 'If' predicate.
/*!
    Algorithm searches backward for the N'th iterator accepted with the  given
    unary  'If'  predicate.  It  implements  searching  in  container   which
...
*/
template <class T_Iterator, typename T_UnaryIfPredicate>
T_Iterator findNIfPrev(const T_Iterator& a_crIterator, const Tuint a_cN, T_UnaryIfPredicate a_fIf);
/*==========================================================================*/
}
/*--------------------------------------------------------------------------*/
}
...
/*==========================================================================*/
#include <Depth/include/algorithms/iterators/AItFindNIf.inl>
/*==========================================================================*/
#endif
