/*!
 *  \file    AItReverseCopyIf.inl Contains general template implementation of
 *           the iterator reverse and copy all items algorithm with unary 'If'
 *           predicate.
 *  \brief   Iterator reverse and copy all items algorithm with unary 'If' predicate (inline).
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Iterator reverse and copy all items algorithm with unary 'If' predicate (inline).
...
*/
/*==========================================================================*/
#ifndef __AITREVERSECOPYIF_INL__
#define __AITREVERSECOPYIF_INL__
/*==========================================================================*/
...
inline Tuint reverseCopyIfNext(const T_Iterator& a_crIterator, const T_IteratorCopy& a_crIteratorCopy, T_UnaryIfPredicate a_fIf)
{ CALL
...
/*--------------------------------------------------------------------------*/
template <class T_Iterator, class T_IteratorCopy, typename T_UnaryIfPredicate>
inline Tuint reverseCopyIfPrev(const T_Iterator& a_crIterator, const T_IteratorCopy& a_crIteratorCopy, T_UnaryIfPredicate a_fIf)
{ CALL
  // Check T_Iterator class constraint to be an any backward iterator.
  NConcept::MConstraint::requiresConcept<NConcept::NIterators::MConceptIteratorAnyBackward<T_Iterator> >();
