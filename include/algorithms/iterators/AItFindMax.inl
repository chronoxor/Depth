/*!
 *  \file    AItFindMax.inl Contains general template implementation of the
 *           find maximum value algorithm.
 *  \brief   Find maximum value algorithm (inline).
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Find maximum value algorithm (inline).
...
*/
/*==========================================================================*/
#ifndef __AITFINDMAX_INL__
#define __AITFINDMAX_INL__
/*==========================================================================*/
...
{ CALL
  return findMaxNext(a_crIterator, NFunctions::FBoolLessThan<const typename T_Iterator::TReturn&>());
}
/*--------------------------------------------------------------------------*/
...
{ CALL
  ...
  if (it.isValid())
  {
    ...
    while ((it.stepForward() > 0) && (it != a_crIterator))
      if (a_fLessThan(result.getValueRef(), it.getValueRef()))
        result = it;
    return result;
  }
  else
...
{ CALL
  return findMaxNext(reverseIt(a_crIterator), NFunctions::FBoolLessThan<const typename T_Iterator::TReturn&>());
}
/*--------------------------------------------------------------------------*/
template <class T_Iterator, typename T_BinaryPredicate>
T_Iterator findMaxPrev(const T_Iterator& a_crIterator, T_BinaryPredicate a_fLessThan)
{ CALL
  return findMaxNext(reverseIt(a_crIterator), a_fLessThan);
}
/*==========================================================================*/
}
/*--------------------------------------------------------------------------*/
