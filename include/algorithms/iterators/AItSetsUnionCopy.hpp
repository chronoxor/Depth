/*!
 *  \file    AItSetsUnionCopy.hpp Contains general template implementation of
 *           the iterator union and copy of two sets algorithm.
 *  \brief   Iterator union and copy of two sets algorithm.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Iterator union and copy of two sets algorithm.
...
*/
/*==========================================================================*/
#ifndef __AITSETSUNIONCOPY_HPP__
#define __AITSETSUNIONCOPY_HPP__
/*==========================================================================*/
...
/*==========================================================================*/
//! Algorithm: Forward union and copy two set sequences.
/*!
    ...
    \return Count of copied items from the set union.
*/
template <class T_Iterator1, class T_Iterator2, class T_IteratorCopy>
Tuint setsUnionCopyNext(const T_Iterator1& a_crIterator1, const T_Iterator2& a_crIterator2, const T_IteratorCopy& a_crIteratorCopy);
/*--------------------------------------------------------------------------*/
//! Algorithm: Forward union and copy two set sequences using 'LessThan' predicate.
/*!
    Algorithm unites forward all items from  two  sequences  represented  with
    their forward iterators and puts them into the copy sequence.
...
Tuint setsUnionCopyNext(const T_Iterator1& a_crIterator1, const T_Iterator2& a_crIterator2, const T_IteratorCopy& a_crIteratorCopy, T_BinaryPredicate a_fLessThan);
/*--------------------------------------------------------------------------*/
//! Algorithm: Backward union and copy two set sequences.
/*!
...
*/
template <class T_Iterator1, class T_Iterator2, class T_IteratorCopy>
Tuint setsUnionCopyPrev(const T_Iterator1& a_crIterator1, const T_Iterator2& a_crIterator2, const T_IteratorCopy& a_crIteratorCopy);
/*--------------------------------------------------------------------------*/
//! Algorithm: Backward union and copy two set sequences using 'LessThan' predicate.
/*!
    Algorithm unites backward all items from two  sequences  represented  with
    their backward iterators and puts them into the copy sequence.
...
*/
template <class T_Iterator1, class T_Iterator2, class T_IteratorCopy, typename T_BinaryPredicate>
Tuint setsUnionCopyPrev(const T_Iterator1& a_crIterator1, const T_Iterator2& a_crIterator2, const T_IteratorCopy& a_crIteratorCopy, T_BinaryPredicate a_fLessThan);
/*==========================================================================*/
}
/*--------------------------------------------------------------------------*/
}
...
/*==========================================================================*/
#include <Depth/include/algorithms/iterators/AItSetsUnionCopy.inl>
/*==========================================================================*/
#endif
