/*!
 *  \file    AItIsSetIntersectCount.inl Contains general template
 *           implementation of the check and get count of the two
 *           sets intersection algorithm.
 *  \brief   Check and get count of the two sets intersection algorithm (inline).
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Check and get count of the two sets intersection algorithm (inline).
...
*/
/*==========================================================================*/
#ifndef __AITISSETINTERSECTCOUNT_INL__
#define __AITISSETINTERSECTCOUNT_INL__
/*==========================================================================*/
...
inline Tuint isSetIntersectCountNext(const T_Iterator1& a_crIterator1, const T_Iterator2& a_crIterator2)
{ CALL
  return isSetIntersectCountNext(a_crIterator1, a_crIterator2, NFunctions::FBoolLessThan<const typename T_Iterator1::TReturn&, const typename T_Iterator2::TReturn&>());
}
/*--------------------------------------------------------------------------*/
template <class T_Iterator1, class T_Iterator2, typename T_BinaryPredicate>
inline Tuint isSetIntersectCountNext(const T_Iterator1& a_crIterator1, const T_Iterator2& a_crIterator2, T_BinaryPredicate a_fLessThan)
{ CALL
...
/*--------------------------------------------------------------------------*/
template <class T_Iterator1, class T_Iterator2>
inline Tuint isSetIntersectCountPrev(const T_Iterator1& a_crIterator1, const T_Iterator2& a_crIterator2)
{ CALL
  return isSetIntersectCountPrev(a_crIterator1, a_crIterator2, NFunctions::FBoolLessThan<const typename T_Iterator1::TReturn&, const typename T_Iterator2::TReturn&>());
}
/*--------------------------------------------------------------------------*/
template <class T_Iterator1, class T_Iterator2, typename T_BinaryPredicate>
inline Tuint isSetIntersectCountPrev(const T_Iterator1& a_crIterator1, const T_Iterator2& a_crIterator2, T_BinaryPredicate a_fLessThan)
{ CALL
