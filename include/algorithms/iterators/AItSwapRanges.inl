/*!
 *  \file    AItSwapRanges.inl Contains general template implementation of the
 *           iterator two sequences swap ranges algorithm.
 *  \brief   Iterator two sequences swap ranges algorithm (inline).
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Iterator two sequences swap ranges algorithm (inline).
...
*/
/*==========================================================================*/
#ifndef __AITSWAPRANGES_INL__
#define __AITSWAPRANGES_INL__
/*==========================================================================*/
...
inline Tuint swapRangesNext(const T_Iterator1& a_crIterator1, const T_Iterator2& a_crIterator2)
{ CALL
...
/*--------------------------------------------------------------------------*/
template <class T_Iterator1, class T_Iterator2>
inline Tuint equalRangesPrev(const T_Iterator1& a_crIterator1, const T_Iterator2& a_crIterator2)
{ CALL
  return swapRangesNext(reverseIt(a_crIterator1), reverseIt(a_crIterator2));
}
/*==========================================================================*/
}
/*--------------------------------------------------------------------------*/
