/*!
 *  \file    AItSetsMerge.hpp Contains general template implementation of the
 *           iterator merge of two sets algorithm.
 *  \brief   Iterator merge of two sets algorithm.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Iterator merge of two sets algorithm.
...
*/
/*==========================================================================*/
#ifndef __AITSETSMERGE_HPP__
#define __AITSETSMERGE_HPP__
/*==========================================================================*/
...
/*==========================================================================*/
//! Algorithm: Forward merge two set sequences.
/*!
...
Tbool setsMergeNext(const T_Iterator1& a_crIterator1, const T_Iterator2& a_crIterator2);
/*--------------------------------------------------------------------------*/
//! Algorithm: Forward merge two set sequences using 'LessThan' predicate.
/*!
    Algorithm merges forward all items  from two  sequences  represented  with
    their forward iterators and puts them into the first one.
...
Tbool setsMergeNext(const T_Iterator1& a_crIterator1, const T_Iterator2& a_crIterator2, T_BinaryPredicate a_fLessThan);
/*--------------------------------------------------------------------------*/
//! Algorithm: Backward merge two set sequences.
/*!
...
*/
template <class T_Iterator1, class T_Iterator2>
Tbool setsMergePrev(const T_Iterator1& a_crIterator1, const T_Iterator2& a_crIterator2);
/*--------------------------------------------------------------------------*/
//! Algorithm: Backward merge two set sequences using 'LessThan' predicate.
/*!
    Algorithm merges backward all items from two  sequences  represented  with
    their forward iterators and puts them into the first one.
...
*/
template <class T_Iterator1, class T_Iterator2, typename T_BinaryPredicate>
Tbool setsMergePrev(const T_Iterator1& a_crIterator1, const T_Iterator2& a_crIterator2, T_BinaryPredicate a_fLessThan);
/*==========================================================================*/
}
/*--------------------------------------------------------------------------*/
}
...
/*==========================================================================*/
#include <Depth/include/algorithms/iterators/AItSetsMerge.inl>
/*==========================================================================*/
#endif
