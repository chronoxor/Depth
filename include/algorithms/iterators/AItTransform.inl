/*!
 *  \file    AItTransform.inl Contains general template implementation of the
 *           iterator transform all items algorithm.
 *  \brief   Iterator transform all items algorithm (inline).
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Iterator transform all items algorithm (inline).
...
*/
/*==========================================================================*/
#ifndef __AITTRANSFORM_INL__
#define __AITTRANSFORM_INL__
/*==========================================================================*/
...
inline Tuint transformNext(const T_Iterator& a_crIterator, T_UnaryFunction a_fFunction)
{ CALL
...
/*--------------------------------------------------------------------------*/
template <class T_Iterator, typename T_UnaryFunction>
inline Tuint transformPrev(const T_Iterator& a_crIterator, T_UnaryFunction a_fFunction)
{ CALL
  return transformNext(reverseIt(a_crIterator), a_fFunction);
}
/*==========================================================================*/
}
/*--------------------------------------------------------------------------*/
