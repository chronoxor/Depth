/*!
 *  \file    FStringComparatorIgnoreCase.hpp String comparator function
 *           class (ignore case version).
 *  \brief   String comparator function class (ignore case version).
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: String comparator function class (ignore case version).
...
*/
/*==========================================================================*/
#ifndef __FSTRINGCOMPARATORIGNORECASE_HPP__
#define __FSTRINGCOMPARATORIGNORECASE_HPP__
/*==========================================================================*/
...
/*==========================================================================*/
//! String comparator function class (ignore case version).
/*!
    This class implements function object which  performs  string  comparation
    (ignoring their cases) to check if two strings are equal.
*/
template <typename T_Argument1, typename T_Argument2 = T_Argument1>
class FStringComparatorIgnoreCase
{
  ...
  typedef FStringComparatorIgnoreCase<T_Argument1, T_Argument2> TDepthCheckType;
  ...
  // Check FStringComparatorIgnoreCase class constraint to be a real Depth type.
...
public:
  ...
  */
  ...
  //! Serialize FStringComparatorIgnoreCase class instance.
  /*!
  ...
  */
  ...
  //! Swap two FStringComparatorIgnoreCase class instances.
  /*!
      \param a_rInstance - Reference to another FStringComparatorIgnoreCase class instance.
  */
  void swap(FStringComparatorIgnoreCase<T_Argument1, T_Argument2>& a_rInstance);
};
/*==========================================================================*/
}
/*--------------------------------------------------------------------------*/
...
/*==========================================================================*/
#include <Depth/include/algorithms/functions/FStringComparatorIgnoreCase.inl>
/*==========================================================================*/
#endif
