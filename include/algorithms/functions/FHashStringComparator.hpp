/*!
 *  \file    FHashStringComparator.hpp Hash string comparator function class.
 *  \brief   Hash string comparator function class.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Hash string comparator function class.
...
*/
/*==========================================================================*/
#ifndef __FHASHSTRINGCOMPARATOR_HPP__
#define __FHASHSTRINGCOMPARATOR_HPP__
/*==========================================================================*/
...
class FHashStringComparator
{
  ...
  typedef FHashStringComparator<T_Argument1, T_Argument2> TDepthCheckType;
  ...
  // Check FHashStringComparator class constraint to be a real Depth type.
...
public:
  ...
  */
  ...
  //! Serialize FHashStringComparator class instance.
  /*!
  ...
  */
  ...
  //! Swap two FHashStringComparator class instances.
  /*!
      \param a_rInstance - Reference to another FHashStringComparator class instance.
  */
  void swap(FHashStringComparator<T_Argument1, T_Argument2>& a_rInstance);
};
/*==========================================================================*/
}
/*--------------------------------------------------------------------------*/
...
/*==========================================================================*/
#include <Depth/include/algorithms/functions/FHashStringComparator.inl>
/*==========================================================================*/
#endif
