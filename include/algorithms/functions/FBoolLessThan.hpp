/*!
 *  \file    FBoolLessThan.hpp Boolean operator '<' function class.
...
*/
/*==========================================================================*/
#ifndef __FBOOLLESSTHAN_HPP__
#define __FBOOLLESSTHAN_HPP__
/*==========================================================================*/
...
class FBoolLessThan
{
  ...
  typedef FBoolLessThan<T_Argument1, T_Argument2> TDepthCheckType;
  ...
  // Check FBoolLessThan class constraint to be a real Depth type.
...
public:
  ...
  */
  ...
  //! Serialize FBoolLessThan class instance.
  /*!
  ...
  */
  ...
  //! Swap two FBoolLessThan class instances.
  /*!
      \param a_rInstance - Reference to another FBoolLessThan class instance.
  */
  void swap(FBoolLessThan<T_Argument1, T_Argument2>& a_rInstance);
};
/*==========================================================================*/
}
/*--------------------------------------------------------------------------*/
...
/*==========================================================================*/
#include <Depth/include/algorithms/functions/FBoolLessThan.inl>
/*==========================================================================*/
#endif
