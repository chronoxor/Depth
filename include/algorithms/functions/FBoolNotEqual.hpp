/*!
 *  \file    FBoolNotEqual.hpp Boolean '!=' operator function class.
...
*/
/*==========================================================================*/
#ifndef __FBOOLNOTEQUAL_HPP__
#define __FBOOLNOTEQUAL_HPP__
/*==========================================================================*/
...
class FBoolNotEqual
{
  ...
  typedef FBoolNotEqual<T_Argument1, T_Argument2> TDepthCheckType;
  ...
  // Check FBoolNotEqual class constraint to be a real Depth type.
...
public:
  ...
  */
  ...
  //! Serialize FBoolNotEqual class instance.
  /*!
  ...
  */
  ...
  //! Swap two FBoolNotEqual class instances.
  /*!
      \param a_rInstance - Reference to another FBoolNotEqual class instance.
  */
  void swap(FBoolNotEqual<T_Argument1, T_Argument2>& a_rInstance);
};
/*==========================================================================*/
}
/*--------------------------------------------------------------------------*/
...
/*==========================================================================*/
#include <Depth/include/algorithms/functions/FBoolNotEqual.inl>
/*==========================================================================*/
#endif
