/*!
 *  \file    FBoolEqual.hpp Boolean '==' operator function class.
...
*/
/*==========================================================================*/
#ifndef __FBOOLEQUAL_HPP__
#define __FBOOLEQUAL_HPP__
/*==========================================================================*/
...
class FBoolEqual
{
  ...
  typedef FBoolEqual<T_Argument1, T_Argument2> TDepthCheckType;
  ...
  // Check FBoolEqual class constraint to be a real Depth type.
...
public:
  ...
  */
  ...
  //! Serialize FBoolEqual class instance.
  /*!
  ...
  */
  ...
  //! Swap two FBoolEqual class instances.
  /*!
      \param a_rInstance - Reference to another FBoolEqual class instance.
  */
  void swap(FBoolEqual<T_Argument1, T_Argument2>& a_rInstance);
};
/*==========================================================================*/
}
/*--------------------------------------------------------------------------*/
...
/*==========================================================================*/
#include <Depth/include/algorithms/functions/FBoolEqual.inl>
/*==========================================================================*/
#endif
