/*!
 *  \file    AStringCompare.hpp Contains general template implementation of
 *           the strings compare algorithm.
 *  \brief   Algorithm to compare of the two given strings.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Algorithm to compare of the two given strings.
...
*/
/*==========================================================================*/
#ifndef __ASTRINGCOMPARE_HPP__
#define __ASTRINGCOMPARE_HPP__
/*==========================================================================*/
...
/*!
    ...
    If sizes of the strings  are  equal,  algorithms  returns  the  difference
    between the first two different characters on a same place in the strings.
...
Tsint stringCompare(const T_StringType1& a_crString1, const T_StringType2& a_crString2);
/*--------------------------------------------------------------------------*/
...
*/
template <typename T_StringType1, typename T_StringType2>
Tsint stringCompare(const T_StringType1& a_crString1, const Tuint a_cString1Length, const T_StringType2& a_crString2, const Tuint a_cString2Length);
/*--------------------------------------------------------------------------*/
...
*/
template <typename T_StringType1, typename T_StringType2>
Tsint stringCompare(const T_StringType1& a_crString1, const Tuint a_cString1Index, const Tuint a_cString1Length, const T_StringType2& a_crString2, const Tuint a_cString2Index, const Tuint a_cString2Length);
/*==========================================================================*/
}
/*--------------------------------------------------------------------------*/
}
...
/*==========================================================================*/
#include <Depth/include/algorithms/string/AStringCompare.inl>
/*==========================================================================*/
#endif
