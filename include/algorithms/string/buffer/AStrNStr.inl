/*!
 *  \file    AStrNStr.inl Contains general template implementation of the
 *           find first occurrence of the substring in the fixed-size string.
 *  \brief   Find first occurrence of the substring in the fixed-size string algorithm (inline).
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Find first occurrence of the substring in the fixed-size string algorithm (inline).
...
*/
/*==========================================================================*/
#ifndef __ASTRNSTR_INL__
#define __ASTRNSTR_INL__
/*==========================================================================*/
...
inline Tsint strNStr(const T_StringType1& a_crString, const Tuint a_cMaxLength, const T_StringType2& a_crSubstring)
{ CALL
  ...
  ASSERT(((Tcptr)a_crString != NULL), STR("Algorithm 'strnstr()' cannot work with a NULL string."))
  {
    return -1;
  }
  // Check the given substring not to be NULL.
  ASSERT(((Tcptr)a_crSubstring != NULL), STR("Algorithm 'strnstr()' cannot work with a NULL substring."))
  {
    return 0;
  }
