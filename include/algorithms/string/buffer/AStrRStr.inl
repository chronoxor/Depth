/*!
 *  \file    AStrRStr.inl Contains general template implementation of the
 *           find last occurrence of the substring in the string.
 *  \brief   Find last occurrence of the substring in the string algorithm (inline).
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Find last occurrence of the substring in the string algorithm (inline).
...
*/
/*==========================================================================*/
#ifndef __ASTRRSTR_INL__
#define __ASTRRSTR_INL__
/*==========================================================================*/
...
inline Tsint strRStr(const T_StringType1& a_crString, const T_StringType2& a_crSubstring)
{ CALL
  ...
  ASSERT(((Tcptr)a_crString != NULL), STR("Algorithm 'strrstr()' cannot work with a NULL string."))
  {
    return -1;
  }
  // Check the given substring not to be NULL.
  ASSERT(((Tcptr)a_crSubstring != NULL), STR("Algorithm 'strrstr()' cannot work with a NULL substring."))
  {
    return 0;
  }
