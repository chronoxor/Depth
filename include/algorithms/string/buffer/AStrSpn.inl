/*!
 *  \file    AStrSpn.inl Contains general template implementation of the
 *           calculate the length of the initial string segment which
 *           consists entirely of characters from the given set.
 *  \brief   Calculate the length of the included initial string segment algorithm (inline).
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Calculate the length of the included initial string segment algorithm (inline).
...
*/
/*==========================================================================*/
#ifndef __ASTRSPN_INL__
#define __ASTRSPN_INL__
/*==========================================================================*/
...
inline Tuint strSpn(const T_StringType1& a_crString, const T_StringType2& a_crCharSet)
{ CALL
  ...
  ASSERT(((Tcptr)a_crString != NULL), STR("Algorithm 'strspn()' cannot work with a NULL string."))
  {
    return 0;
  }
  // Check the given character set not to be NULL.
  ASSERT(((Tcptr)a_crCharSet != NULL), STR("Algorithm 'strspn()' cannot work with a NULL character set."))
  {
    return 0;
  }
  ...
  while ((a_crString[index] != 0) && (a_crCharSet[indexSet] != 0))
  {
