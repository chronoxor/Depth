/*!
 *  \file    AStrNChr.inl Contains general template implementation of the
 *           find first character position in the fixed-size string.
 *  \brief   Find first character position in the fixed-size string algorithm (inline).
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Find first character position in the fixed-size string algorithm (inline).
...
*/
/*==========================================================================*/
#ifndef __ASTRNCHR_INL__
#define __ASTRNCHR_INL__
/*==========================================================================*/
...
inline Tsint strNChr(const T_StringType& a_crString, const Tuint a_cMaxLength, const T_CharacterType& a_crCharacter)
{ CALL
  ...
  ASSERT(((Tcptr)a_crString != NULL), STR("Algorithm 'strnchr()' cannot work with a NULL string."))
  {
    return -1;
  }
