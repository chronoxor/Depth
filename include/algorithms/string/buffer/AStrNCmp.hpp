/*!
 *  \file    AStrNCmp.hpp Contains general template implementation of the
 *           case-sensitive compare of two fixed-size strings.
 *  \brief   Case-sensitive compare of two fixed-size strings algorithm.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Case-sensitive compare of two fixed-size strings algorithm.
...
*/
/*==========================================================================*/
#ifndef __ASTRNCMP_HPP__
#define __ASTRNCMP_HPP__
/*==========================================================================*/
...
/*==========================================================================*/
//! Algorithm: Case-sensitive compare of two fixed-size strings algorithm.
/*!
    Case-sensitive  compare  two  fixed-size  strings,   not   including   the
    terminating '\\0' character, but at most maximum length. Algorithm returns
    difference between two first differ characters from the first  string  and
    the second one.
...
Tsint strNCmp(const T_StringType1& a_crString1, const T_StringType2& a_crString2, const Tuint a_cMaxLength);
/*==========================================================================*/
}
/*--------------------------------------------------------------------------*/
}
...
/*==========================================================================*/
#include <Depth/include/algorithms/string/buffer/AStrNCmp.inl>
/*==========================================================================*/
#endif
