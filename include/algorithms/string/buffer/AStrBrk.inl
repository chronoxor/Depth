/*!
 *  \file    AStrBrk.inl Contains general template implementation of the
 *           find break position in the string.
 *  \brief   Find break position in the string algorithm (inline).
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Find break position in the string algorithm (inline).
...
*/
/*==========================================================================*/
#ifndef __ASTRBRK_INL__
#define __ASTRBRK_INL__
/*==========================================================================*/
...
inline Tsint strBrk(const T_StringType1& a_crString, const T_StringType2& a_crCharSet)
{ CALL
  ...
  ASSERT(((Tcptr)a_crString != NULL), STR("Algorithm 'strbrk()' cannot work with a NULL string."))
  {
    return -1;
  }
  // Check the given character set not to be NULL.
  ASSERT(((Tcptr)a_crCharSet != NULL), STR("Algorithm 'strbrk()' cannot work with a NULL character set."))
  {
    return 0;
  }
