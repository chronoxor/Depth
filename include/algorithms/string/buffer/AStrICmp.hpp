/*!
 *  \file    AStrICmp.hpp Contains general template implementation of the
 *           case-insensitive compare of two strings.
 *  \brief   Case-insensitive compare of two strings algorithm.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Case-insensitive compare of two strings algorithm.
...
*/
/*==========================================================================*/
#ifndef __ASTRICMP_HPP__
#define __ASTRICMP_HPP__
/*==========================================================================*/
...
/*==========================================================================*/
//! Algorithm: Case-insensitive compare of two strings algorithm.
/*!
    Case-insensitive compare two strings, not including the  terminating '\\0'
    character. Algorithm returns difference between lower  case  form  of  two
    first differ characters from the first string and the second one.
...
Tsint strICmp(const T_StringType1& a_crString1, const T_StringType2& a_crString2);
/*==========================================================================*/
}
/*--------------------------------------------------------------------------*/
}
...
/*==========================================================================*/
#include <Depth/include/algorithms/string/buffer/AStrICmp.inl>
/*==========================================================================*/
#endif
