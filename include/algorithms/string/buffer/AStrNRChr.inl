/*!
 *  \file    AStrNRChr.inl Contains general template implementation of the
 *           find last character position in the fixed-size string.
 *  \brief   Find lasr character position in the fixed-size string algorithm (inline).
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Find last character position in the fixed-size string algorithm (inline).
...
*/
/*==========================================================================*/
#ifndef __ASTRNRCHR_INL__
#define __ASTRNRCHR_INL__
/*==========================================================================*/
...
inline Tsint strNRChr(const T_StringType& a_crString, const Tuint a_cMaxLength, const T_CharacterType& a_crCharacter)
{ CALL
  ...
  ASSERT(((Tcptr)a_crString != NULL), STR("Algorithm 'strnrchr()' cannot work with a NULL string."))
  {
    return -1;
  }
