/*!
 *  \file    CGetItFirstHelper.hpp Contains template implementations of the
 *           get first container's iterator algorithm for different types of
 *           containers.
 *  \brief   Get first container's iterator algorithm helper class.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Get first container's iterator algorithm helper class.
...
*/
/*==========================================================================*/
#ifndef __CGETITFIRSTHELPER_HPP__
#define __CGETITFIRSTHELPER_HPP__
/*==========================================================================*/
...
/* CLASS DECLARATIONS                                                       */
/*==========================================================================*/
//! Get first container's iterator algorithm helper class.
/*!
    Get  first  container's  iterator  algorithm  helper  class   uses   class
    specialization to implement various  kinds  of  algorithms  for  different
    container types.
*/
template <Tuint t_Algorithm>
class CGetItFirstHelper :
  public NDepth::NCommon::IStatic
{
public:
  //! Algorithm: Get first container's iterator.
  /*!
      ...
      \return Iterator to the first container's value, or invalid iterator.
  */
  template <class T_Container>
  static typename NTraits::MTraitsContainer<T_Container>::iterator getItFirst(T_Container& a_rContainer);
};
/*==========================================================================*/
}
/*--------------------------------------------------------------------------*/
...
/*==========================================================================*/
#include <Depth/include/algorithms/containers/details/CGetItFirstHelper.inl>
/*==========================================================================*/
#endif
