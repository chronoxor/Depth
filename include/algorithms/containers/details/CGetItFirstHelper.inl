/*!
 *  \file    CGetItFirstHelper.inl Contains template implementations of the
 *           get first container's iterator algorithm for different types of
 *           containers.
 *  \brief   Get first container's iterator algorithm helper class (inline).
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Get first container's iterator algorithm helper class (inline).
...
*/
/*==========================================================================*/
#ifndef __CGETITFIRSTHELPER_INL__
#define __CGETITFIRSTHELPER_INL__
/*==========================================================================*/
...
inline typename NTraits::MTraitsContainer<T_Container>::iterator CGetItFirstHelper<t_Algorithm>::getItFirst(T_Container& a_rContainer)
{ CALL
...
template <>
template <class T_Container>
inline typename NTraits::MTraitsContainer<T_Container>::iterator CGetItFirstHelper<1>::getItFirst(T_Container& a_rContainer)
{ CALL
  ...
  return a_rContainer.getItLeftmostChild();
}
/*--------------------------------------------------------------------------*/
template <>
template <class T_Container>
inline typename NTraits::MTraitsContainer<T_Container>::iterator CGetItFirstHelper<2>::getItFirst(T_Container& a_rContainer)
{ CALL
  ...
  return a_rContainer.getItCurrent();
}
/*--------------------------------------------------------------------------*/
template <>
template <class T_Container>
inline typename NTraits::MTraitsContainer<T_Container>::iterator CGetItFirstHelper<3>::getItFirst(T_Container& a_rContainer)
{ CALL
...
template <>
template <class T_Container>
inline typename NTraits::MTraitsContainer<T_Container>::iterator CGetItFirstHelper<4>::getItFirst(T_Container& a_rContainer)
{ CALL
  ...
  return a_rContainer.getItFirst();
}
/*--------------------------------------------------------------------------*/
template <>
template <class T_Container>
inline typename NTraits::MTraitsContainer<T_Container>::iterator CGetItFirstHelper<5>::getItFirst(T_Container& a_rContainer)
{ CALL
