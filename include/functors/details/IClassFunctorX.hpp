/*!
 *  \file    IClassFunctorX.hpp Class functor interface declares objects with
 *           'operator()'. To call such functor a class instance should be used.
 *  \brief   General declaration of the class functor interfaces.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: General declaration of the class functor interfaces.
...
*/
/*==========================================================================*/
#ifndef __ICLASSFUNCTORX_HPP__
#define __ICLASSFUNCTORX_HPP__
/*==========================================================================*/
...
/*==========================================================================*/
//! General class functor interface.
/*!
    Now any class functor supports only 10 method  arguments.  This  interface
    has private constructor, so you cannot  use  more  than  10  class  method
