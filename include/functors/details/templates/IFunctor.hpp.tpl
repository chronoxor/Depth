/*!
 *  \file    IFunctor.hpp.tpl Functor with DEF_FUNCTOR_ARITY arguments
 *           interface declares objects with 'operator()' method.
 *  \brief   Functor with DEF_FUNCTOR_ARITY arguments interfaces (template header).
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Functor with DEF_FUNCTOR_ARITY arguments interfaces (template header).
...
/*==========================================================================*/
//! Functor interface for functions with DEF_FUNCTOR_ARITY arguments.
/*!
    This interface specialize functor with DEF_FUNCTOR_ARITY arguments. It has
    'operator()' so you  can  use  this  interface  in  corresponding  functor
    hierarchy.
*/
template <DEF_TEMPLATE_DECLARATION>
class IFunctor<DEF_TEMPLATE_PARAMETERS> :
  public NCommon::IClonable<IFunctor<DEF_TEMPLATE_PARAMETERS> >,
  public NCommon::IEquatable<IFunctor<DEF_TEMPLATE_PARAMETERS> >
{
protected:
...
public:
  ...
  */
  ...
  //! Operator: Call functor with DEF_FUNCTOR_ARITY arguments.
  /*!
  ...
  */
  virtual T_Result operator () (DEF_CALL_DECLARATION) const = 0;
};
/*==========================================================================*/
}
/*--------------------------------------------------------------------------*/
...
/*==========================================================================*/
#include <Depth/include/functors/details/templates/IFunctor.inl.tpl>
/*==========================================================================*/
