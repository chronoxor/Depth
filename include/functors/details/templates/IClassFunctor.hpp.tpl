/*!
 *  \file    IClassFunctor.hpp.tpl Class functor with DEF_FUNCTOR_ARITY
 *           arguments interface declares objects with 'operator()'. To
 *           call such functor a class instance should be used.
 *  \brief   Class functor with DEF_FUNCTOR_ARITY arguments interfaces (template header).
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Class functor with DEF_FUNCTOR_ARITY arguments interfaces (template header).
...
/*==========================================================================*/
//! Class functor interface for class methods with DEF_FUNCTOR_ARITY arguments.
/*!
    This interface specialize  class  functor  with  DEF_FUNCTOR_ARITY  method
    arguments.  It  has  'operator()'  so  you  can  use  this  interface   in
    corresponding class functor hierarchy.
*/
template <class T_Class, DEF_TEMPLATE_DECLARATION>
class IClassFunctor<T_Class, DEF_TEMPLATE_PARAMETERS> :
  public NCommon::IClonable<IClassFunctor<T_Class, DEF_TEMPLATE_PARAMETERS> >,
  public NCommon::IEquatable<IClassFunctor<T_Class, DEF_TEMPLATE_PARAMETERS> >
{
protected:
...
public:
  ...
  */
  ...
  //! Operator: Call functor with the class instance and DEF_FUNCTOR_ARITY method arguments.
  /*!
      \param a_rInstance - Reference to the class instance.
  ...
  */
  virtual T_Result operator () (T_Class& a_rInstance DEF_CALL_COMMA DEF_CALL_DECLARATION) const = 0;
};
/*==========================================================================*/
}
/*--------------------------------------------------------------------------*/
...
/*==========================================================================*/
#include <Depth/include/functors/details/templates/IClassFunctor.inl.tpl>
/*==========================================================================*/
