/*!
 *  \file    IClassFunctorConstX.hpp Constant class functor interface
 *           declares objects with 'operator()'. To call such functor
 *           a constant class instance should be used.
 *  \brief   General declaration of the constant class functor interfaces.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: General declaration of the constant class functor interfaces.
...
*/
/*==========================================================================*/
#ifndef __ICLASSFUNCTORCONSTX_HPP__
#define __ICLASSFUNCTORCONSTX_HPP__
/*==========================================================================*/
...
/*==========================================================================*/
//! General constant class functor interface.
/*!
    Now any constant class functor supports only  10  method  arguments.  This
