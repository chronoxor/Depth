/*!
 *  \file    CClassFunctor10.hpp Class functor class emulates an object that
 *           can be called as a class method with 'operator()'. Version
 *           with 10 arguments.
 *  \brief   Class functor class with 10 arguments.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Class functor class with 10 arguments.
...
*/
/*==========================================================================*/
#ifndef __CCLASSFUNCTOR10_HPP__
#define __CCLASSFUNCTOR10_HPP__
/*==========================================================================*/
#include <Depth/include/algorithms/common/ACast.hpp>
#include <Depth/include/algorithms/common/ASwap.hpp>
#include <Depth/include/concept/functions/MConceptAnyMethod10.hpp>
