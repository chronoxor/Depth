/*!
 *  \file    CFunctor10.hpp Functor class emulates an object that can be called
 *           as a function with 'operator()'. Version with 10 arguments.
 *  \brief   Functor class with 10 arguments.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Functor class with 10 arguments.
...
#define DEF_TEMPLATE_PARAMETERS                  T_Result, T_Argument1, T_Argument2, T_Argument3, T_Argument4, T_Argument5, T_Argument6, T_Argument7, T_Argument8, T_Argument9, T_Argument10
#define DEF_TEMPLATE_OTHER_DECLARATION           typename T_OtherResult, typename T_OtherArgument1, typename T_OtherArgument2, typename T_OtherArgument3, typename T_OtherArgument4, typename T_OtherArgument5, typename T_OtherArgument6, typename T_OtherArgument7, typename T_OtherArgument8, typename T_OtherArgument9, typename T_OtherArgument10
#define DEF_TEMPLATE_OTHER_PARAMETERS            T_OtherResult, T_OtherArgument1, T_OtherArgument2, T_OtherArgument3, T_OtherArgument4, T_OtherArgument5, T_OtherArgument6, T_OtherArgument7, T_OtherArgument8, T_OtherArgument9, T_OtherArgument10
#define DEF_CALL_DECLARATION                     T_Argument1 a_Argument1, T_Argument2 a_Argument2, T_Argument3 a_Argument3, T_Argument4 a_Argument4, T_Argument5 a_Argument5, T_Argument6 a_Argument6, T_Argument7 a_Argument7, T_Argument8 a_Argument8, T_Argument9 a_Argument9, T_Argument10 a_Argument10
#define DEF_CALL_PARAMETERS                      a_Argument1, a_Argument2, a_Argument3, a_Argument4, a_Argument5, a_Argument6, a_Argument7, a_Argument8, a_Argument9, a_Argument10
/*--------------------------------------------------------------------------*/
