/*!
 *  \file    CFunctor6.hpp Functor class emulates an object that can be called
 *           as a function with 'operator()'. Version with 6 arguments.
 *  \brief   Functor class with 6 arguments.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Functor class with 6 arguments.
...
*/
/*==========================================================================*/
#ifndef __CFUNCTOR6_HPP__
#define __CFUNCTOR6_HPP__
/*==========================================================================*/
#include <Depth/include/algorithms/common/ACast.hpp>
#include <Depth/include/algorithms/common/ASwap.hpp>
#include <Depth/include/concept/functions/MConceptAnyFunction6.hpp>
#include <Depth/include/functors/details/IFunctorX.hpp>
#include <Depth/include/functors/details/CFunctorHelperX.hpp>
#include <Depth/include/traits/functions/MRemoveFunctionPtr6.hpp>
#include <Depth/include/utility/observer/IObserver.hpp>
/*==========================================================================*/
/* CLASS DECLARATIONS                                                       */
/*==========================================================================*/
#define DEF_FUNCTOR_ARITY                        6
#define DEF_FUNCTOR_DECLARATION(name)            JOIN(name, DEF_FUNCTOR_ARITY)
#define DEF_TEMPLATE_DECLARATION                 typename T_Result, typename T_Argument1, typename T_Argument2, typename T_Argument3, typename T_Argument4, typename T_Argument5, typename T_Argument6
#define DEF_TEMPLATE_PARAMETERS                  T_Result, T_Argument1, T_Argument2, T_Argument3, T_Argument4, T_Argument5, T_Argument6
#define DEF_TEMPLATE_OTHER_DECLARATION           typename T_OtherResult, typename T_OtherArgument1, typename T_OtherArgument2, typename T_OtherArgument3, typename T_OtherArgument4, typename T_OtherArgument5, typename T_OtherArgument6
#define DEF_TEMPLATE_OTHER_PARAMETERS            T_OtherResult, T_OtherArgument1, T_OtherArgument2, T_OtherArgument3, T_OtherArgument4, T_OtherArgument5, T_OtherArgument6
#define DEF_CALL_DECLARATION                     T_Argument1 a_Argument1, T_Argument2 a_Argument2, T_Argument3 a_Argument3, T_Argument4 a_Argument4, T_Argument5 a_Argument5, T_Argument6 a_Argument6
#define DEF_CALL_PARAMETERS                      a_Argument1, a_Argument2, a_Argument3, a_Argument4, a_Argument5, a_Argument6
/*--------------------------------------------------------------------------*/
