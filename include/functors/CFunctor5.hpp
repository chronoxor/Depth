/*!
 *  \file    CFunctor5.hpp Functor class emulates an object that can be called
 *           as a function with 'operator()'. Version with 5 arguments.
 *  \brief   Functor class with 5 arguments.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Functor class with 5 arguments.
