/*!
 *  \file    CFunctor3.hpp Functor class emulates an object that can be called
 *           as a function with 'operator()'. Version with 3 arguments.
 *  \brief   Functor class with 3 arguments.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Functor class with 3 arguments.
...
*/
/*==========================================================================*/
#ifndef __CFUNCTOR3_HPP__
#define __CFUNCTOR3_HPP__
/*==========================================================================*/
#include <Depth/include/algorithms/common/ACast.hpp>
#include <Depth/include/algorithms/common/ASwap.hpp>
#include <Depth/include/concept/functions/MConceptAnyFunction3.hpp>
#include <Depth/include/functors/details/IFunctorX.hpp>
#include <Depth/include/functors/details/CFunctorHelperX.hpp>
#include <Depth/include/traits/functions/MRemoveFunctionPtr3.hpp>
#include <Depth/include/utility/observer/IObserver.hpp>
/*==========================================================================*/
/* CLASS DECLARATIONS                                                       */
/*==========================================================================*/
#define DEF_FUNCTOR_ARITY                        3
#define DEF_FUNCTOR_DECLARATION(name)            JOIN(name, DEF_FUNCTOR_ARITY)
#define DEF_TEMPLATE_DECLARATION                 typename T_Result, typename T_Argument1, typename T_Argument2, typename T_Argument3
#define DEF_TEMPLATE_PARAMETERS                  T_Result, T_Argument1, T_Argument2, T_Argument3
#define DEF_TEMPLATE_OTHER_DECLARATION           typename T_OtherResult, typename T_OtherArgument1, typename T_OtherArgument2, typename T_OtherArgument3
#define DEF_TEMPLATE_OTHER_PARAMETERS            T_OtherResult, T_OtherArgument1, T_OtherArgument2, T_OtherArgument3
#define DEF_CALL_DECLARATION                     T_Argument1 a_Argument1, T_Argument2 a_Argument2, T_Argument3 a_Argument3
#define DEF_CALL_PARAMETERS                      a_Argument1, a_Argument2, a_Argument3
/*--------------------------------------------------------------------------*/
