/*!
 *  \file    CClassFunctor2.hpp Class functor class emulates an object that
 *           can be called as a class method with 'operator()'. Version
 *           with 2 arguments.
 *  \brief   Class functor class with 2 arguments.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Class functor class with 2 arguments.
...
*/
/*==========================================================================*/
#ifndef __CCLASSFUNCTOR2_HPP__
#define __CCLASSFUNCTOR2_HPP__
/*==========================================================================*/
#include <Depth/include/algorithms/common/ACast.hpp>
#include <Depth/include/algorithms/common/ASwap.hpp>
#include <Depth/include/concept/functions/MConceptAnyMethod2.hpp>
