/*!
 *  \file    MAddFunctionPtr8.hpp Traits meta-class that helps to add
 *           pointer qualifier to the function template parameter. Version
 *           with 8 arguments.
 *  \brief   Traits meta-class: add function pointer qualifier. Version with 8 arguments.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Traits meta-class: add function pointer qualifier. Version with 8 arguments.
...
*/
/*==========================================================================*/
#ifndef __MADDFUNCTIONPTR8_HPP__
#define __MADDFUNCTIONPTR8_HPP__
/*==========================================================================*/
...
#define DEF_TEMPLATE_TRAITS                      T_Result (*)(T_Argument1, T_Argument2, T_Argument3, T_Argument4, T_Argument5, T_Argument6, T_Argument7, T_Argument8)
