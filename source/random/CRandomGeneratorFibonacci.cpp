/*!
 *  \file    CRandomGeneratorFibonacci.cpp Knuth's lagged Fibonacci random
 *           number generator.
 *  \brief   Knuth's lagged Fibonacci random number generator class (source).
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Knuth's lagged Fibonacci random number generator class (source).
...
/*==========================================================================*/
#ifndef __CRANDOMGENERATORFIBONACCI_CPP__
#define __CRANDOMGENERATORFIBONACCI_CPP__
/*==========================================================================*/
...
/*==========================================================================*/
Tbool CRandomGeneratorFibonacci::set(const CRandomGeneratorFibonacci& a_crInstance)
{ CALL
  // Check if the given class instance is not the same to the current one.
  ASSERT((&a_crInstance != this), STR("Setting the same CRandomGeneratorFibonacci class instance."))
  {
    return false;
  }
...
/*--------------------------------------------------------------------------*/
Tbool CRandomGeneratorFibonacci::setSeed(const Tuint a_cSeed/* = IRandomGenerator::getSystemSeed() */)
{ CALL
  Tsint i, ii, j, k;
...
/*--------------------------------------------------------------------------*/
Tuint CRandomGeneratorFibonacci::randomInteger()
{ CALL
...
/*--------------------------------------------------------------------------*/
Treal CRandomGeneratorFibonacci::randomReal()
{ CALL
  return (((Treal)randomInteger())/((Treal)m_MaxInteger));
}
/*--------------------------------------------------------------------------*/
void CRandomGeneratorFibonacci::swap(CRandomGeneratorFibonacci& a_rInstance)
{ CALL
