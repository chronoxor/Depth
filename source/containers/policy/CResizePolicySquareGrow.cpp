/*!
 *  \file    CResizePolicySquareGrow.cpp Growing square resize policy class.
 *           It uses square resize factor allocation strategy.
 *  \brief   Growing square resize policy class (source).
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Growing square resize policy class (source).
...
/*==========================================================================*/
#ifndef __CRESIZEPOLICYSQUAREGROW_CPP__
#define __CRESIZEPOLICYSQUAREGROW_CPP__
/*==========================================================================*/
...
/*==========================================================================*/
Tbool CResizePolicySquareGrow::setResizeFactor(const Tuint a_cResizeFactor)
{ CALL
  m_ResizeFactor = a_cResizeFactor;
  return true;
}
/*--------------------------------------------------------------------------*/
Tuint CResizePolicySquareGrow::resize(const Tuint a_cSize)
{ CALL
