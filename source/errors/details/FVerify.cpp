/*!
 *  \file    FVerify.cpp Helper function that invokes verify handler.
 *  \brief   Verify helper function (source).
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Verify helper function (source).
...
/*==========================================================================*/
#ifndef __FVERIFY_CPP__
#define __FVERIFY_CPP__
/*==========================================================================*/
...
{ CALL
  /*!
      \todo Implement verify helper function.
  */
  IGNORE_UNUSED(a_cpFunctionSignature);
  IGNORE_UNUSED(a_cpFileName);
  IGNORE_UNUSED(a_cLine);
  IGNORE_UNUSED(a_cCondition);
  IGNORE_UNUSED(a_cpVerification);
