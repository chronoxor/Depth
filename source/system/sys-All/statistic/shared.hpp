/*!
 *  \file    shared.hpp Depth statistic shared library implementation header
 *           contains valid SHARED_LIBRARY_CLASS and include definitions.
 *  \brief   Depth statistic shared library implementation header.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Depth statistic shared library implementation header.
...
#define SHARED_LIBRARY_NAME DepthStatistic
// Define full class name of the shared library (including namespace).
#define SHARED_LIBRARY_CLASS NDepth::NSystem::CSystemStatistic
