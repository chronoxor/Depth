/*!
 *  \file    shared.hpp Depth geometry shared library implementation header
 *           contains valid SHARED_LIBRARY_CLASS and include definitions.
 *  \brief   Depth geometry shared library implementation header.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Depth geometry shared library implementation header.
...
#define SHARED_LIBRARY_NAME DepthGeometry
// Define full class name of the shared library (including namespace).
#define SHARED_LIBRARY_CLASS NDepth::NSystem::CSystemGeometry
