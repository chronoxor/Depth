/*!
 *  \file    CSystemBaseEncoding-Dummy.cpp Base system class contains common
 *           functionality such as memory routines, math functions, error
 *           handling, standard I/O routines.
 *  \brief   Base system class - Dummy OS - encoding methods (source).
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Base system class - Dummy OS - encoding methods (source).
...
/*==========================================================================*/
#ifndef __CSYSTEMBASEENCODING_DUMMY_CPP__
#define __CSYSTEMBASEENCODING_DUMMY_CPP__
/*==========================================================================*/
...
{ CALL
  ...
  #endif
  NString::NDetails::CSystemStringHelper::ms_fGetMaxBytesPerSystemChar = &NString::NDetails::CSystemStringHelper::getMaxBytesPerUTF32Char;
  ...
  #endif
  NString::NDetails::CSystemStringHelper::ms_fGetSystemCharsCount = &NString::NDetails::CSystemStringHelper::getUTF32CharsCount;
  NString::NDetails::CSystemStringHelper::ms_fASCIIToSystemCount = &NString::NDetails::CSystemStringHelper::UCS1ToUTF32Count;
  #if (defined(__WCHAR_S_UCS2__) || defined(__WCHAR_U_UCS2__))
  NString::NDetails::CSystemStringHelper::ms_fUnicodeToSystemCount = &NString::NDetails::CSystemStringHelper::UCS2ToUTF32Count;
  #else
  NString::NDetails::CSystemStringHelper::ms_fUnicodeToSystemCount = &NString::NDetails::CSystemStringHelper::UCS4ToUTF32Count;
  #endif
  NString::NDetails::CSystemStringHelper::ms_fUTF8ToSystemCount = &NString::NDetails::CSystemStringHelper::UTF8ToUTF32Count;
  ...
  #endif
  NString::NDetails::CSystemStringHelper::ms_fSystemToASCIICount = &NString::NDetails::CSystemStringHelper::UTF32ToUCS1Count;
  #if (defined(__WCHAR_S_UCS2__) || defined(__WCHAR_U_UCS2__))
  NString::NDetails::CSystemStringHelper::ms_fSystemToUnicodeCount = &NString::NDetails::CSystemStringHelper::UTF32ToUCS2Count;
  #else
  NString::NDetails::CSystemStringHelper::ms_fSystemToUnicodeCount = &NString::NDetails::CSystemStringHelper::UTF32ToUCS4Count;
  #endif
  NString::NDetails::CSystemStringHelper::ms_fSystemToUTF8Count = &NString::NDetails::CSystemStringHelper::UTF32ToUTF8Count;
  ...
  #endif
  NString::NDetails::CSystemStringHelper::ms_fASCIIToSystem = &NString::NDetails::CSystemStringHelper::UCS1ToUTF32;
  #if (defined(__WCHAR_S_UCS2__) || defined(__WCHAR_U_UCS2__))
  NString::NDetails::CSystemStringHelper::ms_fUnicodeToSystem = &NString::NDetails::CSystemStringHelper::UCS2ToUTF32;
  #else
  NString::NDetails::CSystemStringHelper::ms_fUnicodeToSystem = &NString::NDetails::CSystemStringHelper::UCS4ToUTF32;
  #endif
  NString::NDetails::CSystemStringHelper::ms_fUTF8ToSystem = &NString::NDetails::CSystemStringHelper::UTF8ToUTF32;
  ...
  #endif
  NString::NDetails::CSystemStringHelper::ms_fSystemToASCII = &NString::NDetails::CSystemStringHelper::UTF32ToUCS1;
  #if (defined(__WCHAR_S_UCS2__) || defined(__WCHAR_U_UCS2__))
  NString::NDetails::CSystemStringHelper::ms_fSystemToUnicode = &NString::NDetails::CSystemStringHelper::UTF32ToUCS2;
  #else
  NString::NDetails::CSystemStringHelper::ms_fSystemToUnicode = &NString::NDetails::CSystemStringHelper::UTF32ToUCS4;
  #endif
  NString::NDetails::CSystemStringHelper::ms_fSystemToUTF8 = &NString::NDetails::CSystemStringHelper::UTF32ToUTF8;
