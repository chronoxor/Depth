/*!
 *  \file    IApplication-native-Dummy.cpp Application interface provides
 *           OS independent functionality to handle native application
 *           startup.
 *  \brief   Application interface - native - Dummy OS (source).
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Application interface - native - Dummy OS (source).
...
#include "../Dummy.hpp"
/*==========================================================================*/
#ifndef __IAPPLICATION_NATIVE_DUMMY_CPP__
#define __IAPPLICATION_NATIVE_DUMMY_CPP__
/*==========================================================================*/
...
/*==========================================================================*/
//! Dummy system layer native application entry point function.
/*!
...
void unused_IApplication_native_Dummy() { }
#endif
#endif
