/*!
 *  \file    IApplication-console-Dummy.cpp Application interface provides
 *           OS independent functionality to handle console application
 *           startup.
 *  \brief   Application interface - console - Dummy OS (source).
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Application interface - console - Dummy OS (source).
...
#include "../Dummy.hpp"
/*==========================================================================*/
#ifndef __IAPPLICATION_CONSOLE_DUMMY_CPP__
#define __IAPPLICATION_CONSOLE_DUMMY_CPP__
/*==========================================================================*/
...
void unused_IApplication_console_Dummy() { }
#endif
#endif
