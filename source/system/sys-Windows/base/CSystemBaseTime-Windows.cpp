/*!
 *  \file    CSystemBaseTime-Windows.cpp Base system class contains common
 *           functionality such as memory routines, math functions, error
 *           handling, standard I/O routines.
 *  \brief   Base system class - Windows OS - date & time methods (source).
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Base system class - Windows OS - date & time methods (source).
...
{ CALL
  ...
  GetSystemTimeAsFileTime(&system_file_time);
...
{ CALL
  ...
  // Update time fields.
  system_time.wHour = (WORD)a_crTime.getClearHours();
  system_time.wMinute = (WORD)a_crTime.getClearMinutes();
  system_time.wSecond = (WORD)a_crTime.getClearSeconds();
  system_time.wMilliseconds = (WORD)a_crTime.getClearMilliseconds();
...
{ CALL
  ...
  // Update time fields.
  system_time.wYear = (WORD)a_crDate.getClearYears();
  system_time.wMonth = (WORD)a_crDate.getClearMonths() + 1;
  system_time.wDay = (WORD)a_crDate.getClearDays() + 1;
...
{ CALL
  ...
  // Update time fields.
  system_time.wYear = (WORD)a_crDateTime.getDate().getClearYears();
  system_time.wMonth = (WORD)a_crDateTime.getDate().getClearMonths() + 1;
  system_time.wDay = (WORD)a_crDateTime.getDate().getClearDays() + 1;
  system_time.wHour = (WORD)a_crDateTime.getTime().getClearHours();
  system_time.wMinute = (WORD)a_crDateTime.getTime().getClearMinutes();
  system_time.wSecond = (WORD)a_crDateTime.getTime().getClearSeconds();
  system_time.wMilliseconds = (WORD)a_crDateTime.getTime().getClearMilliseconds();
