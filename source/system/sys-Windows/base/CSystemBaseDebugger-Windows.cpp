/*!
 *  \file    CSystemBaseDebugger-Windows.cpp Base system class contains common
 *           functionality such as memory routines, math functions, error
 *           handling, standard I/O routines.
 *  \brief   Base system class - Windows OS - debugger methods (source).
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Base system class - Windows OS - debugger methods (source).
...
#include "../Windows.hpp"
/*==========================================================================*/
#ifndef __CSYSTEMBASEDEBUGGER_WINDOWS_CPP__
#define __CSYSTEMBASEDEBUGGER_WINDOWS_CPP__
/*==========================================================================*/
...
{ CALL
  ...
  OutputDebugStringA((Tcsstr)message);
  return a_cSize;
}
/*--------------------------------------------------------------------------*/
