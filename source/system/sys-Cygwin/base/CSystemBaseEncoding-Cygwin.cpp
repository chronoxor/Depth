/*!
 *  \file    CSystemBaseEncoding-Cygwin.cpp Base system class contains common
 *           functionality such as memory routines, math functions, error
 *           handling, standard I/O routines.
 *  \brief   Base system class - Cygwin OS - encoding methods (source).
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Base system class - Cygwin OS - encoding methods (source).
...
/*==========================================================================*/
#ifndef __CSYSTEMBASEENCODING_CYGWIN_CPP__
#define __CSYSTEMBASEENCODING_CYGWIN_CPP__
/*==========================================================================*/
