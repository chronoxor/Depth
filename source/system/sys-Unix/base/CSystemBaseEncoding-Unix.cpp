/*!
 *  \file    CSystemBaseEncoding-Unix.cpp Base system class contains common
 *           functionality such as memory routines, math functions, error
 *           handling, standard I/O routines.
 *  \brief   Base system class - Unix OS - encoding methods (source).
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Base system class - Unix OS - encoding methods (source).
...
/*==========================================================================*/
#ifndef __CSYSTEMBASEENCODING_UNIX_CPP__
#define __CSYSTEMBASEENCODING_UNIX_CPP__
/*==========================================================================*/
...
{ CALL
  ...
  #endif
  NString::NDetails::CSystemStringHelper::ms_fGetMaxBytesPerSystemChar = &NString::NDetails::CSystemStringHelper::getMaxBytesPerUTF8Char;
  ...
  #endif
  NString::NDetails::CSystemStringHelper::ms_fGetSystemCharsCount = &NString::NDetails::CSystemStringHelper::getUTF8CharsCount;
  NString::NDetails::CSystemStringHelper::ms_fASCIIToSystemCount = &NString::NDetails::CSystemStringHelper::UCS1ToUTF8Count;
  #if (defined(__WCHAR_S_UCS2__) || defined(__WCHAR_U_UCS2__))
  NString::NDetails::CSystemStringHelper::ms_fUnicodeToSystemCount = &NString::NDetails::CSystemStringHelper::UCS2ToUTF8Count;
  #else
  NString::NDetails::CSystemStringHelper::ms_fUnicodeToSystemCount = &NString::NDetails::CSystemStringHelper::UCS4ToUTF8Count;
  #endif
  NString::NDetails::CSystemStringHelper::ms_fUTF8ToSystemCount = &NString::NDetails::CSystemStringHelper::UTF8ToUTF8Count;
  ...
  #endif
  NString::NDetails::CSystemStringHelper::ms_fSystemToASCIICount = &NString::NDetails::CSystemStringHelper::UTF8ToUCS1Count;
  #if (defined(__WCHAR_S_UCS2__) || defined(__WCHAR_U_UCS2__))
  NString::NDetails::CSystemStringHelper::ms_fSystemToUnicodeCount = &NString::NDetails::CSystemStringHelper::UTF8ToUCS2Count;
  #else
  NString::NDetails::CSystemStringHelper::ms_fSystemToUnicodeCount = &NString::NDetails::CSystemStringHelper::UTF8ToUCS4Count;
  #endif
  NString::NDetails::CSystemStringHelper::ms_fSystemToUTF8Count = &NString::NDetails::CSystemStringHelper::UTF8ToUTF8Count;
  ...
  #endif
  NString::NDetails::CSystemStringHelper::ms_fASCIIToSystem = &NString::NDetails::CSystemStringHelper::UCS1ToUTF8;
  #if (defined(__WCHAR_S_UCS2__) || defined(__WCHAR_U_UCS2__))
  NString::NDetails::CSystemStringHelper::ms_fUnicodeToSystem = &NString::NDetails::CSystemStringHelper::UCS2ToUTF8;
  #else
  NString::NDetails::CSystemStringHelper::ms_fUnicodeToSystem = &NString::NDetails::CSystemStringHelper::UCS4ToUTF8;
  #endif
  NString::NDetails::CSystemStringHelper::ms_fUTF8ToSystem = &NString::NDetails::CSystemStringHelper::UTF8ToUTF8;
  ...
  #endif
  NString::NDetails::CSystemStringHelper::ms_fSystemToASCII = &NString::NDetails::CSystemStringHelper::UTF8ToUCS1;
  #if (defined(__WCHAR_S_UCS2__) || defined(__WCHAR_U_UCS2__))
  NString::NDetails::CSystemStringHelper::ms_fSystemToUnicode = &NString::NDetails::CSystemStringHelper::UTF8ToUCS2;
  #else
  NString::NDetails::CSystemStringHelper::ms_fSystemToUnicode = &NString::NDetails::CSystemStringHelper::UTF8ToUCS4;
  #endif
  NString::NDetails::CSystemStringHelper::ms_fSystemToUTF8 = &NString::NDetails::CSystemStringHelper::UTF8ToUTF8;
