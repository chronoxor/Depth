/*!
 *  \file    IApplication-console-Unix.cpp Application interface provides
 *           OS independent functionality to handle console application
 *           startup.
 *  \brief   Application interface - console - Unix OS (source).
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Application interface - console - Unix OS (source).
...
#include "../Unix.hpp"
/*==========================================================================*/
#ifndef __IAPPLICATION_CONSOLE_UNIX_CPP__
#define __IAPPLICATION_CONSOLE_UNIX_CPP__
/*==========================================================================*/
#if defined(__UNIX__)
/*==========================================================================*/
...
void unused_IApplication_console_Unix() { }
#endif
#endif
