/*!
 *  \file    IApplication-native-Unix.cpp Application interface provides
 *           OS independent functionality to handle native application
 *           startup.
 *  \brief   Application interface - native - Unix OS (source).
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Application interface - native - Unix OS (source).
...
#include "../Unix.hpp"
/*==========================================================================*/
#ifndef __IAPPLICATION_NATIVE_UNIX_CPP__
#define __IAPPLICATION_NATIVE_UNIX_CPP__
/*==========================================================================*/
#if defined(__UNIX__)
/*==========================================================================*/
...
/*==========================================================================*/
//! Unix system layer native application entry point function.
/*!
...
void unused_IApplication_native_Unix() { }
#endif
#endif
