/*!
 *  \file    i386FPU-atan.s
 *  \brief   atan assembler function (source).
 *  \author  J.T. Conklin (jtc@wimsey.com)
 *  \version 1.0
 *  \date    03.01.2006
 */
#=============================================================================
#   FILE DESCRIPTION: atan assembler function.
#
#   AUTHOR:    J.T. Conklin (jtc@wimsey.com)
...
#   These functions compute the arc tangent of x---that is, the value whose
#   tangent is x. The value is in units of radians. Mathematically, there are
#   infinitely many such values; the one actually returned is the one between
#   -pi/2 and pi/2 (inclusive).
#=============================================================================
.text
.global	_i386FPU_atan
_i386FPU_atan:
	fldl	4(%esp)
	fld1
	fpatan
