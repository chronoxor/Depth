/*!
 *  \file    i386FPU-significand.s
 *  \brief   significand assembler function (source).
 *  \author  J.T. Conklin (jtc@wimsey.com)
 *  \version 1.0
 *  \date    03.01.2006
 */
#=============================================================================
#   FILE DESCRIPTION: significand assembler function.
#
#   AUTHOR:    J.T. Conklin (jtc@wimsey.com)
...
#=============================================================================
.text
.global _i386FPU_significand
_i386FPU_significand:
	fldl	4(%esp)
	fxtract
	fstp	%st(1)
	ret
