/*!
 *  \file    OFormatVarList.cpp Format using variable arguments list stream
 *           control operator. It is used to format output or unformat input
 *           through stream operators using variable arguments list.
 *  \brief   Format using variable arguments list stream control operator (source).
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Format using variable arguments list stream control operator (source).
...
/*==========================================================================*/
#ifndef __OFORMATVARLIST_CPP__
#define __OFORMATVARLIST_CPP__
/*==========================================================================*/
...
/*==========================================================================*/
BASE_API IReader& operator >> (IReader& a_rReader, const formatVarList& a_crFormat)
{ CALL
...
/*--------------------------------------------------------------------------*/
BASE_API IWriter& operator << (IWriter& a_rWriter, const formatVarList& a_crFormat)
{ CALL
  switch (a_crFormat.m_Type)
  {
    case 0:
