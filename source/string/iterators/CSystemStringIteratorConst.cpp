 ...
 *  \brief   System string constant iterator class (source).
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: System string constant iterator class (source).
...
/*==========================================================================*/
#ifndef __CSYSTEMSTRINGITERATORCONST_CPP__
#define __CSYSTEMSTRINGITERATORCONST_CPP__
/*==========================================================================*/
...
/*==========================================================================*/
Tuint CSystemStringIteratorConst::stepForward(const Tuint a_cStepCount/* = 1 */)
{ CALL
...
/*--------------------------------------------------------------------------*/
Tuint CSystemStringIteratorConst::stepBackward(const Tuint a_cStepCount/* = 1 */)
{ CALL
  // Check if the iterator is in the valid state.
...
/*--------------------------------------------------------------------------*/
Tbool CSystemStringIteratorConst::stepIndex(const Tuint a_cIndex)
{ CALL
