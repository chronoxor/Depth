 ...
 *  \brief   Unicode string constant iterator class (source).
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Unicode string constant iterator class (source).
...
/*==========================================================================*/
#ifndef __CSTRINGUNICODEITERATORCONST_CPP__
#define __CSTRINGUNICODEITERATORCONST_CPP__
/*==========================================================================*/
...
/*==========================================================================*/
Tuint CStringUnicodeIteratorConst::stepForward(const Tuint a_cStepCount/* = 1 */)
{ CALL
...
/*--------------------------------------------------------------------------*/
Tuint CStringUnicodeIteratorConst::stepBackward(const Tuint a_cStepCount/* = 1 */)
{ CALL
  // Check if the iterator is in the valid state.
...
/*--------------------------------------------------------------------------*/
Tbool CStringUnicodeIteratorConst::stepIndex(const Tuint a_cIndex)
{ CALL
