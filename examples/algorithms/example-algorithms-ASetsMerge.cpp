/*!
 *  \file    example-algorithms-ASetsMerge.cpp Example of using the iterator 
 *           sets merge algorithms.
 *  \brief   Example of using the iterator sets merge algorithms.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Example of using the iterator sets merge algorithms.
  ...
  public NApplication::IApplication
{
  ...
  { CALL
    ...
    // Print the count of elements in merge of two sets.
    stdoutput << STR("Merge count = ") << setsMergeCount(array1, array2) << ln;

    // Find and copy merge of two sets.
    setsMergeCopy(array1, array2, array_result);
    stdoutput << array_result << ln;

    // Find merge of two sets.
    setsMerge(array1, array2);
    stdoutput << array1 << ln;
