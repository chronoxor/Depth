/*!
 *  \file    example-algorithms-ASetsIntersection.cpp Example of using the 
 *           iterator sets intersection algorithms.
 *  \brief   Example of using the iterator sets intersection algorithms.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Example of using the iterator sets intersection algorithms.
  ...
  public NApplication::IApplication
{
  ...
  { CALL
    ...
    // Print the count of elements in intersection of two sets.
    stdoutput << STR("Intersections count = ") << setsIntersectionCount(array1, array2) << ln;

    // Find and copy intersection of two sets.
    setsIntersectionCopy(array1, array2, array_result);
    stdoutput << array_result << ln;

    // Find intersection of two sets.
    setsIntersection(array1, array2);
    stdoutput << array1 << ln;
