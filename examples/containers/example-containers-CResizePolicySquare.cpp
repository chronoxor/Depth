/*!
 *  \file    example-containers-CResizePolicySquare.cpp Example of using the
 *           square resize policy.
 *  \brief   Example of using the square resize policy.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Example of using the square resize policy.
  ...
  public NApplication::IApplication
{
  ...
  { CALL
    ...
    CResizePolicySquare resize_policy;

    // Setup the resize factor.
    resize_policy.setResizeFactor(4);
    stdoutput << STR("CResizePolicySquare(factor = ") << resize_policy.getResizeFactor() << STR(")") << ln;
