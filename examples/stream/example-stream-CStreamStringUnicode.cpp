/*!
 *  \file    example-stream-CStreamStringUnicode.cpp Example of using the
 *           CStreamStringUnicode class.
 *  \brief   Example of using the CStreamStringUnicode class.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Example of using the CStreamStringUnicode class.
  ...
  public NApplication::IApplication
{
  ...
  // Write content of the fixed size Unicode string buffer into the given writer.
  static void show(IWriter& writer, Tcwstr a_cpBuffer, const Tuint a_cSize)
  { CALL
