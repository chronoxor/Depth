/*!
 *  \file    example-stream-CFilterXXE.cpp Example of using the CFilterXXE
 *           class.
 *  \brief   Example of using the CFilterXXE class.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Example of using the CFilterXXE class.
  ...
  public NApplication::IApplication
{
  ...
  { CALL
    ...
    // Link standard output stream with XXE filter.
    CFilterXXE filter(&stdoutput, true, stdoutput.isTextMode(), stdoutput.getByteOrder(), stdoutput.getLineEnding());
