/*!
 *  \file    example-geometry-CVector4D.cpp Example of using the CVector4D
 *           class.
 *  \brief   Example of using the CVector4D class.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Example of using the CVector4D class.
...
/*==========================================================================*/
// Write instance of the CVector4D class into the given writer.
IWriter& operator << (IWriter& writer, const CVector4D& a_crVector)
{ CALL
  return writer << STR("CVector4D(") << a_crVector.m_X << STR(", ") << a_crVector.m_Y << STR(", ") << a_crVector.m_Z << STR(", ") << a_crVector.m_W << STR(")");
}
/*==========================================================================*/
class CExample :
  public NApplication::IApplication
{
  ...
  { CALL
    ...
    CVector4D vector;
    stdoutput << STR("CVector4D vector;") << ln << STR(" ---> ") << vector << ln;

    vector.set(10.0, 0.0, 0.0, 0.0);
    stdoutput << STR("vector.set(10.0, 0.0, 0.0, 0.0);") << ln << STR(" ---> ") << vector << ln;
