/*!
 *  \file    example-base-CInteger.cpp Example of using the CInteger class.
 *  \brief   Example of using the CInteger class.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Example of using the CInteger class.
  ...
  public NApplication::IApplication
{
  ...
  { CALL
    ...
    stdoutput << STR("d = ") << d.getValue() << ln;
    stdoutput << STR("CIntegerMaker::make(100) = ") << CIntegerMaker::make(100).getValue() << ln;
