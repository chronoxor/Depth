/*!
 *  \file    example-base-CPointer.cpp Example of using the CPointer class.
 *  \brief   Example of using the CPointer class.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Example of using the CPointer class.
