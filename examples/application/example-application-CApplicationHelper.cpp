/*!
 *  \file    example-application-CApplicationHelper.cpp Example of using the
 *           CApplicationHelper class.
 *  \brief   Example of using the CApplicationHelper class.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Example of using the CApplicationHelper class.
