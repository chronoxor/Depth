/*!
 *  \file    example-unit-CUnitTestSuite.cpp Example of using the
 *           CUnitTestSuite class.
 *  \brief   Example of using the CUnitTestSuite class.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Example of using the CUnitTestSuite class.
