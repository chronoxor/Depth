/*!
 *  \file    example-tokenizer-CTokenizerCharDelimiters.cpp Example of using
 *           the CTokenizer class with the CTokenizerFunctionCharDelimiters
 *           rules.
 *  \brief   Example of using the CTokenizer class with the CTokenizerFunctionCharDelimiters rules.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Example of using the CTokenizer class with the CTokenizerFunctionCharDelimiters rules.
