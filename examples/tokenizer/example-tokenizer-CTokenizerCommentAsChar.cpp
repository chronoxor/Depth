/*!
 *  \file    example-tokenizer-CTokenizerCommentAsChar.cpp Example of using
 *           the CTokenizer class with the CTokenizerFunctionCommentAsChar
 *           rules.
 *  \brief   Example of using the CTokenizer class with the CTokenizerFunctionCommentAsChar rules.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Example of using the CTokenizer class with the CTokenizerFunctionCommentAsChar rules.
  ...
  public NApplication::IApplication
{
  ...
  { CALL
    ...
    stdoutput << STR("Please input single line of '#' comment delimited characters (10 or more tokens): ");

    // Use standard input stream of the current process.
    CStreamStdInput stdinput(true);

    // Create the tokenizer.
    CTokenizerFunctionCommentAsChar tf(STR('#'));
