/*!
 *  \file    example-tokenizer-CTokenizerEscapedComma.cpp Example of using
 *           the CTokenizer class with the CTokenizerFunctionEscapedComma
 *           rules.
 *  \brief   Example of using the CTokenizer class with the CTokenizerFunctionEscapedComma rules.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Example of using the CTokenizer class with the CTokenizerFunctionEscapedComma rules.
  ...
  public NApplication::IApplication
{
  ...
  { CALL
    ...
    stdoutput << STR("Please input single line of escaped comma delimited characters (10 or more tokens): ");

    // Use standard input stream of the current process.
    CStreamStdInput stdinput(true);

    // Create the tokenizer.
    CTokenizerFunctionEscapedComma tf;
