/*-----------------------------------------------------------------------------*\
| Matpack - Bezier cubic spline                                     mpbspline.h |
|                                                                               |
...
#ifndef _MPBSPLINE_H_
#define _MPBSPLINE_H_

//----------------------------------------------------------------------------//

namespace MATPACK {

class MpBezierCubicSpline : public MpCurveBase
{
  protected:
    void Draw4 (Scene& scene, const double *x, const double *y, int &first);

  public:
    MpBezierCubicSpline (void) { }
    virtual ~MpBezierCubicSpline (void) { }
