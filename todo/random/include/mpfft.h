/*-----------------------------------------------------------------------------*\
| class MpFFT, class MpConvolution                                      mpfft.h |
| FFT and convlutions in  1/2/3 dimensions                                      |
|                                                                               |
...
//
//  (3) C++ implementation of the GPF-Algorithm for the Matpack C++
//      Numerics and Graphics Library by B. M. Gammel, 1996-1997.
//
//-----------------------------------------------------------------------------//
