/*!
 *  \file    test-memory-CAllocatorNew.cpp Testing of the CAllocatorNew 
 *           class.
 *  \brief   Testing of the CAllocatorNew class.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Testing of the CAllocatorNew class.
