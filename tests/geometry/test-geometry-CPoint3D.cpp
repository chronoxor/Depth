/*!
 *  \file    test-geometry-CPoint3D.cpp Testing of the CPoint3D class.
 *  \brief   Testing of the CPoint3D class.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Testing of the CPoint3D class.
  ...
  public CUnitTest
{
  ...
  // Compare instance of CPoint3D<Tsint> class with separate point's coordinates.
  void UT_ASSERT_EQUAL_POINTS(const CPoint3D<Tsint>& point, const Tsint x, const Tsint y, const Tsint z)
  {
    UT_ASSERT_EQUAL(point.m_X, x);
    UT_ASSERT_EQUAL(point.m_Y, y);
    UT_ASSERT_EQUAL(point.m_Z, z);
  }
} the_Test;
/*==========================================================================*/
