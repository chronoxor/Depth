/*!
 *  \file    test-geometry-CVector4D.cpp Testing of the CVector4D class.
 *  \brief   Testing of the CVector4D class.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Testing of the CVector4D class.
  ...
  public CUnitTest
{
  ...
  { CALL
    CVector4D vector;
    UT_ASSERT_EQUAL_VECTORS(vector, CVector4D(0.0, 0.0, 0.0, 0.0));

    vector.set(10.0, 0.0, 0.0, 0.0);
    UT_ASSERT_EQUAL_VECTORS(vector, CVector4D(10.0, 0.0, 0.0, 0.0));

    vector.normalize();
    UT_ASSERT_EQUAL_VECTORS(vector, CVector4D(1.0, 0.0, 0.0, 0.0));

    vector = vector.translate(4.0, 5.0, 5.0, 5.0);
    UT_ASSERT_EQUAL_VECTORS(vector, CVector4D(5.0, 5.0, 5.0, 5.0));

    vector = vector.scale(CONSTR(0.2), CONSTR(0.2), CONSTR(0.2), CONSTR(0.2));
    UT_ASSERT_EQUAL_VECTORS(vector, CVector4D(1.0, 1.0, 1.0, 1.0));
