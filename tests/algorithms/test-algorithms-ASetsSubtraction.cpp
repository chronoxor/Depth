/*!
 *  \file    test-algorithms-ASetsSubtraction.cpp Testing of the iterator 
 *           sets subtraction algorithms.
 *  \brief   Testing of the iterator sets subtraction algorithms.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Testing of the iterator sets subtraction algorithms.
  ...
  public CUnitTest
{
  ...
  { CALL
    ...
    // Check the count of elements in subtraction of two sets.
    UT_ASSERT_EQUAL(setsSubtractionCount(array1, array2), 4);

    // Find and copy subtraction of two sets.
    UT_ASSERT_EQUAL(setsSubtractionCopy(array1, array2, array_result), 4);
    UT_ASSERT_CHECK_ARRAY(array_result);

    // Find subtraction of two sets.
    UT_ASSERT(setsSubtraction(array1, array2));
