/*!
 *  \file    test-algorithms-ASetsUnion.cpp Testing of the iterator sets 
 *           union algorithms.
 *  \brief   Testing of the iterator sets union algorithms.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Testing of the iterator sets union algorithms.
  ...
  public CUnitTest
{
  ...
  { CALL
    ...
    // Check the count of elements in union of two sets.
    UT_ASSERT_EQUAL(setsUnionCount(array1, array2), 13);

    // Find and copy union of two sets.
    UT_ASSERT_EQUAL(setsUnionCopy(array1, array2, array_result), 13);
    UT_ASSERT_CHECK_ARRAY(array_result);

    // Find union of two sets.
    UT_ASSERT(setsUnion(array1, array2));
