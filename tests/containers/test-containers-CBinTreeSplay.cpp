/*!
 *  \file    test-containers-CBinTreeSplay.cpp Testing of the CBinTreeSplay 
 *           class.
 *  \brief   Testing of the CBinTreeSplay class.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Testing of the CBinTreeSplay class.
  ...
  public CUnitTest
{
  ...
  // Check the fill functionality of the CBinTreeSplay<Tsint>.
  void UT_ASSERT_CHECK_FILL(CBinTreeSplay<Tsint>& a_rBinTree)
  { CALL
  ...
  // Check the show functionality of the CBinTreeSplay<Tsint>.
  void UT_ASSERT_CHECK_SHOW(const CBinTreeSplay<Tsint>& a_crBinTree)
  { CALL
    Tsint step = 0;
    Tsint value = 1;
  ...
  // Check the remove functionality of the CBinTreeSplay<Tsint>.
  void UT_ASSERT_CHECK_REMOVE(CBinTreeSplay<Tsint>& a_rBinTree)
  { CALL
    Tsint step = 0;
    Tsint value = 1;
