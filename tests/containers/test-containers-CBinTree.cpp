/*!
 *  \file    test-containers-CBinTree.cpp Testing of the CBinTree class.
 *  \brief   Testing of the CBinTree class.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Testing of the CBinTree class.
  ...
  public CUnitTest
{
  ...
  // Check the fill functionality of the CBinTree<Tsint>.
  void UT_ASSERT_CHECK_FILL(CBinTree<Tsint>& a_rBinTree)
  { CALL
  ...
  // Check the show functionality of the CBinTree<Tsint>.
  void UT_ASSERT_CHECK_SHOW(const CBinTree<Tsint>& a_crBinTree)
  { CALL
    Tsint step = 0;
    Tsint value = 1;
  ...
  // Check the remove functionality of the CBinTree<Tsint>.
  void UT_ASSERT_CHECK_REMOVE(CBinTree<Tsint>& a_rBinTree)
  { CALL
    Tsint step = 0;
    Tsint value = 1;
