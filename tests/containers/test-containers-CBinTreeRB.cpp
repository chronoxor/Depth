/*!
 *  \file    test-containers-CBinTreeRB.cpp Testing of the CBinTreeRB class.
 *  \brief   Testing of the CBinTreeRB class.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Testing of the CBinTreeRB class.
  ...
  public CUnitTest
{
  ...
  // Check the fill functionality of the CBinTreeRB<Tsint>.
  void UT_ASSERT_CHECK_FILL(CBinTreeRB<Tsint>& a_rBinTree)
  { CALL
  ...
  // Check the show functionality of the CBinTreeRB<Tsint>.
  void UT_ASSERT_CHECK_SHOW(const CBinTreeRB<Tsint>& a_crBinTree)
  { CALL
    Tsint step = 0;
    Tsint value = 1;
  ...
  // Check the remove functionality of the CBinTreeRB<Tsint>.
  void UT_ASSERT_CHECK_REMOVE(CBinTreeRB<Tsint>& a_rBinTree)
  { CALL
    Tsint step = 0;
    Tsint value = 1;
