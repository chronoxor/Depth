/*!
 *  \file    test-containers-CHashTableOpenAddress.cpp Testing of the
 *           CHashTableOpenAddress class.
 *  \brief   Testing of the CHashTableOpenAddress class.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Testing of the CHashTableOpenAddress class.
  ...
  public CUnitTest
{
  ...
  { CALL
    CHashTableOpenAddress<CSystemString, Tsint> a;
    ...
    // Copy hash tables.
    CHashTableOpenAddress<CSystemString, Tsint> b(a);
  ...
  // Check the fill functionality of the CHashTableOpenAddress<CSystemString, Tsint>.
  void UT_ASSERT_CHECK_FILL(CHashTableOpenAddress<CSystemString, Tsint>& a_rHashTable)
  { CALL
  ...
  // Check the find functionality of the CHashTableOpenAddress<CSystemString, Tsint>.
  void UT_ASSERT_CHECK_FIND(CHashTableOpenAddress<CSystemString, Tsint>& a_rHashTable)
  { CALL
    UT_ASSERT((a_rHashTable[ASC("abc")].getValueRef() == 1) || (a_rHashTable[ASC("abc")].getValueRef() == 10));
    UT_ASSERT((a_rHashTable[ASC("abcd")].getValueRef() == 2) || (a_rHashTable[ASC("abcd")].getValueRef() == 20));
    UT_ASSERT((a_rHashTable[ASC("abcde")].getValueRef() == 3) || (a_rHashTable[ASC("abcde")].getValueRef() == 30));
    UT_ASSERT((a_rHashTable[ASC("abcdef")].getValueRef() == 4) || (a_rHashTable[ASC("abcdef")].getValueRef() == 40));
    UT_ASSERT((a_rHashTable[ASC("abcdefg")].getValueRef() == 5) || (a_rHashTable[ASC("abcdefg")].getValueRef() == 50));
    UT_ASSERT((a_rHashTable[ASC("abcdefgh")].getValueRef() == 6) || (a_rHashTable[ASC("abcdefgh")].getValueRef() == 60));
    UT_ASSERT((a_rHashTable[ASC("abcdefghj")].getValueRef() == 7) || (a_rHashTable[ASC("abcdefghj")].getValueRef() == 70));
    UT_ASSERT((a_rHashTable[ASC("abcdefghjk")].getValueRef() == 8) || (a_rHashTable[ASC("abcdefghjk")].getValueRef() == 80));
    UT_ASSERT((a_rHashTable[ASC("abcdefghjkl")].getValueRef() == 9) || (a_rHashTable[ASC("abcdefghjkl")].getValueRef() == 90));
    UT_ASSERT((a_rHashTable[ASC("abcdefghjklm")].getValueRef() == 10) || (a_rHashTable[ASC("abcdefghjklm")].getValueRef() == 10));
  }

  // Check the show functionality of the CHashTableOpenAddress<CSystemString, Tsint>.
  void UT_ASSERT_CHECK_SHOW(const CHashTableOpenAddress<CSystemString, Tsint>& a_crHashTable, const Tbool a_cDirectOrder, const Tuint a_cCount)
  { CALL
    Tuint count = 0;
    CHashTableOpenAddress<CSystemString, Tsint>::TIteratorConst it = a_cDirectOrder ? a_crHashTable.getItFirst() : a_crHashTable.getItLast();
    if (it.isValid())
    {
      do
      {
  ...
  // Check the remove functionality of the CHashTableOpenAddress<CSystemString, Tsint>.
  void UT_ASSERT_CHECK_REMOVE(CHashTableOpenAddress<CSystemString, Tsint>& a_rHashTable)
  { CALL
    CHashTableOpenAddress<CSystemString, Tsint>::TIterator it = a_rHashTable.getItFirst();
    while (it.isValid())
      UT_ASSERT(it.remove());
  }
  ...
  { CALL
    CHashTableOpenAddress<CSystemString, Tsint> instance;
