/*!
 *  \file    test-statistic-CDistributionNormal.cpp Testing of the
 *           CDistributionNormal class.
 *  \brief   Testing of the CDistributionNormal class.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Testing of the CDistributionNormal class.
  ...
  public CUnitTest
{
  ...
  { CALL
    ...
    UT_ASSERT(normal_distribution.isValidGenerator());

    // Check normal distributed values.
    for (Tuint i = 0; i < 1000; ++i)
      UT_ASSERT(CMath::isNormal(normal_distribution.randomReal()));
