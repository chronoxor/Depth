/*!
 *  \file    test-statistic-CDistributionFisher.cpp Testing of the
 *           CDistributionFisher class.
 *  \brief   Testing of the CDistributionFisher class.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Testing of the CDistributionFisher class.
  ...
  public CUnitTest
{
  ...
  { CALL
    ...
    UT_ASSERT(fisher_distribution.isValidGenerator());

    // Check fisher distributed values.
    for (Tuint i = 0; i < 1000; ++i)
      UT_ASSERT(CMath::isNormal(fisher_distribution.randomReal()));
