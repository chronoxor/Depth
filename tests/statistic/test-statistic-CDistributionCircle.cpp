/*!
 *  \file    test-statistic-CDistributionCircle.cpp Testing of the
 *           CDistributionCircle class.
 *  \brief   Testing of the CDistributionCircle class.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Testing of the CDistributionCircle class.
