/*!
 *  \file    test-stream-CFilterBase2.cpp Testing of the CFilterBase2 class.
 *  \brief   Testing of the CFilterBase2 class.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Testing of the CFilterBase2 class.
  ...
  public CUnitTest
{
  ...
  { CALL
    ...
    // Link buffer stream with Base2 filter.
    CFilterBase2 filter(&stream, stream.isTextMode(), stream.getByteOrder(), stream.getLineEnding());
