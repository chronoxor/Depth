/*!
 *  \file    test-stream-CFilterBase16.cpp Testing of the CFilterBase16 
 *           class.
 *  \brief   Testing of the CFilterBase16 class.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Testing of the CFilterBase16 class.
  ...
  public CUnitTest
{
  ...
  { CALL
    ...
    // Link buffer stream with Base16 filter.
    CFilterBase16 filter(&stream, stream.isTextMode(), stream.getByteOrder(), stream.getLineEnding());
