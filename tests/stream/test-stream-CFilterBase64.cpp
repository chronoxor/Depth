/*!
 *  \file    test-stream-CFilterBase64.cpp Testing of the CFilterBase64 
 *           class.
 *  \brief   Testing of the CFilterBase64 class.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Testing of the CFilterBase64 class.
  ...
  public CUnitTest
{
  ...
  { CALL
    ...
    // Link buffer stream with Base64 filter.
    CFilterBase64 filter(&stream, stream.isTextMode(), stream.getByteOrder(), stream.getLineEnding());
