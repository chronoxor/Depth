/*!
 *  \file    test-stream-CStreamStringASCII.cpp Testing of the
 *           CStreamStringASCII class.
 *  \brief   Testing of the CStreamStringASCII class.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Testing of the CStreamStringASCII class.
  ...
  public CUnitTest
{
  ...
  { CALL
    ...
    // Check ASCII string content.
    UT_ASSERT_EQUAL(stream[CONSTU(5)], ASC('a'));
    UT_ASSERT_EQUAL(stream[CONSTU(6)], ASC('b'));
    UT_ASSERT_EQUAL(stream[CONSTU(7)], ASC('c'));
    UT_ASSERT_EQUAL(stream[CONSTU(8)], ASC('d'));
    UT_ASSERT_EQUAL(stream[CONSTU(9)], ASC('e'));
