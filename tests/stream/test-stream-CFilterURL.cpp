/*!
 *  \file    test-stream-CFilterURL.cpp Testing of the CFilterURL class.
 *  \brief   Testing of the CFilterURL class.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Testing of the CFilterURL class.
  ...
  public CUnitTest
{
  ...
  { CALL
    ...
    // Link buffer stream with URL filter.
    CFilterURL filter(&stream, stream.isTextMode(), stream.getByteOrder(), stream.getLineEnding());
