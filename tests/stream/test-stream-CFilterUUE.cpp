/*!
 *  \file    test-stream-CFilterUUE.cpp Testing of the CFilterUUE class.
 *  \brief   Testing of the CFilterUUE class.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Testing of the CFilterUUE class.
  ...
  public CUnitTest
{
  ...
  { CALL
    ...
    // Link buffer stream with UUE filter.
    CFilterUUE filter(&stream, true, stream.isTextMode(), stream.getByteOrder(), stream.getLineEnding());
