/*!
 *  \file    test-stream-CFilterLineEnd.cpp Testing of the CFilterLineEnd 
 *           class.
 *  \brief   Testing of the CFilterLineEnd class.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Testing of the CFilterLineEnd class.
  ...
  public CUnitTest
{
  ...
  { CALL
    ...
    // Link buffer stream with LineEnd filter.
    CFilterLineEnd filter(&stream, 1, 1, stream.isTextMode(), stream.getByteOrder(), stream.getLineEnding());
