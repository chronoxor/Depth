/*!
 *  \file    test-unit-CUnitTestLauncher.cpp Testing of the CUnitTestLauncher
 *           class.
 *  \brief   Testing of the CUnitTestLauncher class.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Testing of the CUnitTestLauncher class.
