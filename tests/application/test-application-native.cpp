/*!
 *  \file    test-application-native.cpp Testing of the native system entry
 *           point with the IApplication interface.
 *  \brief   Testing of the native system entry point with the IApplication interface.
...
/*==========================================================================*/
/*
    FILE DESCRIPTION: Testing of the native system entry point with the IApplication interface.
